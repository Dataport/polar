import { c as Ke, _ as za, g as _o } from "./polar-client-WnCtiy9J.js";
var ft = function(a) {
...
}, Gl = L, br = Gl({}.isPrototypeOf), zl = V, dn = zl.navigator, pn = dn && dn.userAgent, Ct = pn ? String(pn) : "", Uo = V, Jr = Ct, yn = Uo.process, mn = Uo.Deno, bn = yn && yn.versions || mn && mn.version, xn = bn && bn.v8, ue, vr;
xn && (ue = xn.split("."), vr = ue[0] > 0 && ue[0] < 4 ? 1 : +(ue[0] + ue[1]));
!vr && Jr && (ue = Jr.match(/Edge\/(\d+)/), (!ue || ue[1] >= 74) && (ue = Jr.match(/Chrome\/(\d+)/), ue && (vr = +ue[1])));
var Oi = vr, Tn = Oi, Hl = k, Yl = V, Xl = Yl.String, Go = !!Object.getOwnPropertySymbols && !Hl(function() {
...
}, ea = Y, ta = B, ra = fe, sh = TypeError, oh = function(a, e) {
  var t, r;
...
var Ei = Yo.exports, $n = Ei, $i = function(a, e) {
  return $n[a] || ($n[a] = e || {});
}, fh = he, vh = Object, Tr = function(a) {
  return vh(fh(a));
}, ch = L, gh = Tr, dh = ch({}.hasOwnProperty), ve = Object.hasOwn || function(e, t) {
  return dh(gh(e), t);
}, ph = L, yh = 0, mh = Math.random(), bh = ph(1 .toString), Xo = function(a) {
  return "Symbol(" + (a === void 0 ? "" : a) + ")_" + bh(++yh + mh, 36);
}, xh = V, Th = $i, wn = ve, Oh = Xo, Sh = Go, Eh = zo, Ze = xh.Symbol, aa = Th("wks"), $h = Eh ? Ze.for || Ze : Ze && Ze.withoutSetter || Oh, z = function(a) {
  return wn(aa, a) || (aa[a] = Sh && wn(Ze, a) ? Ze[a] : $h("Symbol." + a)), aa[a];
}, wh = Y, Cn = fe, An = Ho, Ch = ot, Ah = oh, Ph = z, Rh = TypeError, Nh = Ph("toPrimitive"), Ih = function(a, e) {
  ...
  var e = Mh(a, "string");
  return _h(e) ? e : e + "";
}, Vh = V, Pn = fe, Ya = Vh.document, Dh = Pn(Ya) && Pn(Ya.createElement), Or = function(a) {
...
}), jh = le, Fh = Y, Uh = Vo, Gh = Ti, zh = wt, Hh = Wo, Yh = ve, Xh = qo, Rn = Object.getOwnPropertyDescriptor;
...
}), Qh = fe, Kh = String, Zh = TypeError, J = function(a) {
  if (Qh(a)) return a;
  throw new Zh(Kh(a) + " is not an object");
}, Jh = le, ef = qo, tf = Qo, Gt = J, Nn = Wo, rf = TypeError, ia = Object.defineProperty, af = Object.getOwnPropertyDescriptor, na = "enumerable", sa = "configurable", oa = "writable";
Oe.f = Jh ? tf ? function(e, t, r) {
  ...
  if (Gt(e), t = Nn(t), Gt(r), ef) try {
    return ia(e, t, r);
  } catch {
  }
  if ("get" in r || "set" in r) throw new rf("Accessors not supported");
  return "value" in r && (e[t] = r.value), e;
};
var nf = le, sf = Oe, of = Ti, At = nf ? function(a, e, t) {
  return sf.f(a, e, of(1, t));
} : function(a, e, t) {
  return a[e] = t, a;
}, Ko = { exports: {} }, Xa = le, uf = ve, Zo = Function.prototype, lf = Xa && Object.getOwnPropertyDescriptor, wi = uf(Zo, "name"), hf = wi && (function() {
}).name === "something", ff = wi && (!Xa || Xa && lf(Zo, "name").configurable), Sr = {
  EXISTS: wi,
  PROPER: hf,
  CONFIGURABLE: ff
}, vf = L, cf = B, Wa = Ei, gf = vf(Function.toString);
cf(Wa.inspectSource) || (Wa.inspectSource = function(a) {
  return gf(a);
});
var Ci = Wa.inspectSource, df = V, pf = B, In = df.WeakMap, yf = pf(In) && /native code/.test(String(In)), mf = $i, bf = Xo, Mn = mf("keys"), Ai = function(a) {
  return Mn[a] || (Mn[a] = bf(a));
}, Pi = {}, xf = yf, Jo = V, Tf = fe, Of = At, ua = ve, la = Ei, Sf = Ai, Ef = Pi, _n = "Object already initialized", qa = Jo.TypeError, $f = Jo.WeakMap, cr, Ot, gr, wf = function(a) {
  return gr(a) ? Ot(a) : cr(a, {});
}, Cf = function(a) {
  return function(e) {
    var t;
    if (!Tf(e) || (t = Ot(e)).type !== a)
      throw new qa("Incompatible receiver, " + a + " required");
    return t;
  };
};
if (xf || la.state) {
  var de = la.state || (la.state = new $f());
  ...
  var Ye = Sf("state");
  Ef[Ye] = !0, cr = function(a, e) {
    if (ua(a, Ye)) throw new qa(_n);
    return e.facade = a, Of(a, Ye, e), e;
  }, Ot = function(a) {
    return ua(a, Ye) ? a[Ye] : {};
  }, gr = function(a) {
    return ua(a, Ye);
...
var Er = {
  ...
  enforce: wf,
  getterFor: Cf
}, Ri = L, Af = k, Pf = B, zt = ve, Qa = le, Rf = Sr.CONFIGURABLE, Nf = Ci, eu = Er, If = eu.enforce, Mf = eu.get, Vn = String, sr = Object.defineProperty, _f = Ri("".slice), Vf = Ri("".replace), Df = Ri([].join), kf = Qa && !Af(function() {
  return sr(function() {
  }, "length", { value: 8 }).length !== 8;
}), Lf = String(String).split("String"), Bf = Ko.exports = function(a, e, t) {
  _f(Vn(e), 0, 7) === "Symbol(" && (e = "[" + Vf(Vn(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), t && t.getter && (e = "get " + e), t && t.setter && (e = "set " + e), (!zt(a, "name") || Rf && a.name !== e) && (Qa ? sr(a, "name", { value: e, configurable: !0 }) : a.name = e), kf && t && zt(t, "arity") && a.length !== t.arity && sr(a, "length", { value: t.arity });
  try {
    t && zt(t, "constructor") && t.constructor ? Qa && sr(a, "prototype", { writable: !1 }) : a.prototype && (a.prototype = void 0);
  } catch {
  }
  var r = If(a);
  return zt(r, "source") || (r.source = Df(Lf, typeof e == "string" ? e : "")), a;
};
Function.prototype.toString = Bf(function() {
  return Pf(this) && Mf(this).source || Nf(this);
}, "toString");
var tu = Ko.exports, jf = B, Ff = Oe, Uf = tu, Gf = Si, Ue = function(a, e, t, r) {
  r || (r = {});
  var i = r.enumerable, n = r.name !== void 0 ? r.name : e;
  if (jf(t) && Uf(t, n, r), r.global)
    i ? a[e] = t : Gf(e, t);
  else {
    try {
  ...
  return a;
}, ru = {}, zf = Math.ceil, Hf = Math.floor, Yf = Math.trunc || function(e) {
  var t = +e;
  return (t > 0 ? Hf : zf)(t);
}, Xf = Yf, $r = function(a) {
  var e = +a;
  return e !== e || e === 0 ? 0 : Xf(e);
}, Wf = $r, qf = Math.max, Qf = Math.min, Kf = function(a, e) {
  var t = Wf(a);
  return t < 0 ? qf(t + e, 0) : Qf(t, e);
}, Zf = $r, Jf = Math.min, ut = function(a) {
  var e = Zf(a);
  return e > 0 ? Jf(e, 9007199254740991) : 0;
}, ev = ut, Ni = function(a) {
  return ev(a.length);
}, tv = wt, rv = Kf, av = Ni, Dn = function(a) {
  ...
  indexOf: Dn(!1)
}, iv = L, ha = ve, nv = wt, sv = au.indexOf, ov = Pi, kn = iv([].push), iu = function(a, e) {
  var t = nv(a), r = 0, i = [], n;
  for (n in t) !ha(ov, n) && ha(t, n) && kn(i, n);
  for (; e.length > r; ) ha(t, n = e[r++]) && (~sv(i, n) || kn(i, n));
  return i;
}, Ii = [
  "constructor",
  "hasOwnProperty",
  ...
  "toString",
  "valueOf"
], uv = iu, lv = Ii, hv = lv.concat("length", "prototype");
ru.f = Object.getOwnPropertyNames || function(e) {
  return uv(e, hv);
};
var nu = {};
nu.f = Object.getOwnPropertySymbols;
var fv = Fe, vv = L, cv = ru, gv = nu, dv = J, pv = vv([].concat), yv = fv("Reflect", "ownKeys") || function(e) {
  var t = cv.f(dv(e)), r = gv.f;
  return r ? pv(t, r(e)) : t;
}, Ln = ve, mv = yv, bv = $t, xv = Oe, Tv = function(a, e, t) {
  for (var r = mv(e), i = xv.f, n = bv.f, o = 0; o < r.length; o++) {
    var s = r[o];
    !Ln(a, s) && !(t && Ln(t, s)) && i(a, s, n(e, s));
  }
}, Ov = k, Sv = B, Ev = /#|\.prototype\./, Pt = function(a, e) {
  var t = wv[$v(a)];
  return t === Av ? !0 : t === Cv ? !1 : Sv(e) ? Ov(e) : !!e;
}, $v = Pt.normalize = function(a) {
  return String(a).replace(Ev, ".").toLowerCase();
}, wv = Pt.data = {}, Cv = Pt.NATIVE = "N", Av = Pt.POLYFILL = "P", su = Pt, Ht = V, Pv = $t.f, Rv = At, Nv = Ue, Iv = Si, Mv = Tv, _v = su, ee = function(a, e) {
  var t = a.target, r = a.global, i = a.stat, n, o, s, u, l, h;
  if (r ? o = Ht : i ? o = Ht[t] || Iv(t, {}) : o = Ht[t] && Ht[t].prototype, o) for (s in e) {
    if (l = e[s], a.dontCallGetSet ? (h = Pv(o, s), u = h && h.value) : u = o[s], n = _v(r ? s : t + (i ? "." : "#") + s, a.forced), !n && u !== void 0) {
      if (typeof l == typeof u) continue;
      Mv(l, u);
    }
    (a.sham || u && u.sham) && Rv(l, "sham", !0), Nv(o, s, l, a);
  }
}, vt = V, Vv = Ct, Dv = Be, Yt = function(a) {
  return Vv.slice(0, a.length) === a;
}, ou = function() {
  return Yt("Bun/") ? "BUN" : Yt("Cloudflare-Workers") ? "CLOUDFLARE" : Yt("Deno/") ? "DENO" : Yt("Node.js/") ? "NODE" : vt.Bun && typeof Bun.version == "string" ? "BUN" : vt.Deno && typeof Deno.version == "object" ? "DENO" : Dv(vt.process) === "process" ? "NODE" : vt.window && vt.document ? "BROWSER" : "REST";
}(), kv = ou, wr = kv === "NODE", Lv = L, Bv = Te, jv = function(a, e, t) {
  try {
    return Lv(Bv(Object.getOwnPropertyDescriptor(a, e)[t]));
  } catch {
  }
}, Fv = fe, Uv = function(a) {
  return Fv(a) || a === null;
}, Gv = Uv, zv = String, Hv = TypeError, Yv = function(a) {
  if (Gv(a)) return a;
  throw new Hv("Can't set " + zv(a) + " as a prototype");
}, Xv = jv, Wv = fe, qv = he, Qv = Yv, uu = Object.setPrototypeOf || ("__proto__" in {} ? function() {
  var a = !1, e = {}, t;
  try {
...
}() : void 0), Kv = Oe.f, Zv = ve, Jv = z, Bn = Jv("toStringTag"), Cr = function(a, e, t) {
  a && !t && (a = a.prototype), a && !Zv(a, Bn) && Kv(a, Bn, { configurable: !0, value: e });
...
}, hc = z, fc = hc("toStringTag"), lu = {};
lu[fc] = "z";
var vc = String(lu) === "[object z]", cc = vc, gc = B, or = Be, dc = z, pc = dc("toStringTag"), yc = Object, mc = or(/* @__PURE__ */ function() {
  return arguments;
...
}, xc = L, Tc = k, hu = B, Oc = Mi, Sc = Fe, Ec = Ci, fu = function() {
}, vu = Sc("Reflect", "construct"), _i = /^\s*(?:class|function)\b/, $c = xc(_i.exec), wc = !_i.test(fu), ct = function(e) {
  if (!hu(e)) return !1;
  try {
    return vu(fu, [], e), !0;
  } catch {
...
var Cc = !vu || Tc(function() {
  ...
  return a;
}, Xc = Ct, mu = /(?:ipad|iphone|ipod).*applewebkit/i.test(Xc), ae = V, Wc = pu, qc = Vi, Yn = B, Qc = ve, bu = k, Xn = yu, Kc = zc, Wn = Or, Zc = Yc, Jc = mu, eg = wr, Ka = ae.setImmediate, Za = ae.clearImmediate, tg = ae.process, fa = ae.Dispatch, rg = ae.Function, qn = ae.MessageChannel, ag = ae.String, va = 0, xt = {}, Qn = "onreadystatechange", St, Ie, ca, ga;
bu(function() {
  St = ae.location;
});
var Di = function(a) {
...
var Ou = Tu, og = Ct, ug = /ipad|iphone|ipod/i.test(og) && typeof Pebble < "u", lg = Ct, hg = /web0s(?!.*chrome)/i.test(lg), it = V, fg = sg, es = Vi, pa = xu.set, vg = Ou, cg = mu, gg = ug, dg = hg, ya = wr, ts = it.MutationObserver || it.WebKitMutationObserver, rs = it.document, as = it.process, Xt = it.Promise, Ja = fg("queueMicrotask"), Xe, ma, ba, Wt, is;
if (!Ja) {
...
var Ag = ee, dr = wr, we = V, nt = Y, os = Ue, us = uu, Pg = Cr, Rg = sc, Ng = Te, ur = B, Ig = fe, Mg = lc, _g = gu, Eu = xu.set, Li = pg, Vg = yg, Dg = ki, kg = Ou, $u = Er, pr = Pr, Bi = Rt, wu = lt, Rr = "Promise", Cu = Bi.CONSTRUCTOR, Lg = Bi.REJECTION_EVENT, Bg = Bi.SUBCLASSING, Ta = $u.getterFor(Rr), jg = $u.set, Qe = pr && pr.prototype, De = pr, Kt = Qe, Au = we.TypeError, ti = we.document, ji = we.process, ri = wu.f, Fg = ri, Ug = !!(ti && ti.createEvent && we.dispatchEvent), Pu = "unhandledrejection", Gg = "rejectionhandled", ls = 0, Ru = 1, zg = 2, Fi = 1, Nu = 2, Zt, hs, Hg, fs, Iu = function(a) {
  ...
  nt(Eu, we, function() {
    ...
    }), a.rejection = dr || vs(a) ? Nu : Fi, i.error))
      throw i.value;
  });
}, vs = function(a) {
...
if (Cu && (De = function(e) {
  ...
  fs = Qe.then, Bg || os(Qe, "then", function(e, t) {
    var r = this;
...
var Nt = {}, Wg = z, qg = Nt, Qg = Wg("iterator"), Kg = Array.prototype, Zg = function(a) {
...
}, fd = Y, gs = J, vd = ot, cd = function(a, e, t) {
  var r, i;
  gs(a);
  try {
    if (r = vd(a, "return"), !r) {
  ...
  var r = t && t.that, i = !!(t && t.AS_ENTRIES), n = !!(t && t.IS_RECORD), o = !!(t && t.IS_ITERATOR), s = !!(t && t.INTERRUPTED), u = gd(e, r), l, h, v, c, f, d, g, p = function(x) {
  ...
  if (n)
    ...
    if (md(h)) {
      for (v = 0, c = bd(a); c > v; v++)
        if (f = y(a[v]), f && ds(ys, f)) return f;
      return new lr(!1);
    }
    l = xd(a, h);
  }
  for (d = n ? a.next : l.next; !(g = dd(d, l)).done; ) {
    ...
    if (typeof f == "object" && f && ds(ys, f)) return f;
  }
  return new lr(!1);
...
var Kd = J, Zd = fe, Jd = lt, ep = function(a, e) {
...
var np = Mi, sp = String, pe = function(a) {
  ...
  MISSED_STICKY: lp,
  UNSUPPORTED_Y: zi
}, Gu = {}, fp = iu, vp = Ii, cp = Object.keys || function(e) {
  return fp(e, vp);
...
Xp && (oi = function(e) {
  var t = this, r = jp(t), i = Vp(e), n = r.raw, o, s, u, l, h, v, c;
  if (n)
    return n.lastIndex = t.lastIndex, o = et(oi, n, i), t.lastIndex = n.lastIndex, o;
  var f = r.groups, d = Yu && t.sticky, g = et(Dp, t), p = t.source, y = 0, x = i;
...
`) && (p = "(?: " + p + ")", x = " " + x, y++), s = new RegExp("^(?:" + p + ")", g)), li && (s = new RegExp("^" + p + "$(?!\\s)", g)), ui && (u = t.lastIndex), l = et(yr, d ? s : t, x), d ? l ? (l.input = Sa(l.input, y), l[0] = Sa(l[0], y), l.index = t.lastIndex, t.lastIndex += l[0].length) : t.lastIndex = 0 : ui && l && (t.lastIndex = t.global ? l.index + l[0].length : u), li && l && l.length > 1 && et(Gp, l[0], s, function() {
    ...
    for (l.groups = v = Bp(null), h = 0; h < f.length; h++)
      c = f[h], v[c[0]] = l[c[1]];
  return l;
});
...
var Cs = Y, As = Ue, qp = Yi, Ps = k, Xu = z, Qp = At, Kp = Xu("species"), Ea = RegExp.prototype, Xi = function(a, e, t, r) {
  ...
  if (!n || !o || t) {
    var s = /./[i], u = e(i, ""[a], function(l, h, v, c, f) {
      var d = h.exec;
      return d === qp || d === Ea.exec ? n && !f ? { done: !0, value: Cs(s, h, v, c) } : { done: !0, value: Cs(l, v, h, c) } : { done: !1 };
    });
...
}, hy = Y, fy = Xi, vy = J, cy = je, gy = ut, $a = pe, dy = he, py = ot, yy = qi, Ms = Qi;
fy("match", function(a, e, t) {
  return [
    ...
    function(r) {
      ...
      for (var u = [], l = 0, h; (h = Ms(i, n)) !== null; ) {
        var v = $a(h[0]);
        u[l] = v, v === "" && (i.lastIndex = yy(n, gy(i.lastIndex), s)), l++;
      }
      return l === 0 ? null : u;
    }
  ];
...
$y("replace", function(a, e, t) {
  ...
  return [
    ...
    function(i, n) {
      ...
      for (var c = [], f; f = Dy(o, s), !(f === null || (Aa(c, f), !h)); ) {
        var d = We(f[0]);
        d === "" && (o.lastIndex = My(s, Ny(o.lastIndex), v));
      }
      for (var g = "", p = 0, y = 0; y < c.length; y++) {
        f = c[y];
        for (var x = We(f[0]), b = Ly(By(Ry(f.index), s.length), 0), T = [], $, E = 1; E < f.length; E++) Aa(T, Fy(f[E]));
        var O = f.groups;
        if (l) {
          var C = jy([x], T, b, s);
...
var zy = fe, Hy = Be, Yy = z, Xy = Yy("match"), Wy = function(a) {
  var e;
...
var lm = z, hm = Hi, fm = Oe.f, fi = lm("unscopables"), vi = Array.prototype;
vi[fi] === void 0 && fm(vi, fi, {
  configurable: !0,
  value: hm(null)
});
var vm = function(a) {
...
}), dm = ve, pm = B, ym = Tr, mm = Ai, bm = gm, Bs = mm("IE_PROTO"), ci = Object, xm = ci.prototype, qu = bm ? ci.getPrototypeOf : function(a) {
  var e = ym(a);
  if (dm(e, Bs)) return e[Bs];
  var t = e.constructor;
  return pm(t) && e instanceof t ? t.prototype : e instanceof ci ? xm : null;
}, Tm = k, Om = B, Sm = fe, js = qu, Em = Ue, $m = z, gi = $m("iterator"), Qu = !1, ke, Pa, Ra;
...
var Ku = {
  ...
  if (f && (d = Fs(f.call(new a())), d !== Object.prototype && d.next && (Fs(d) !== Gs && (Us ? Us(d, Gs) : Dm(d[gt]) || Na(d, gt, zm)), Lm(d, u, !0))), Um && i === dt && v && v.name !== dt && (Gm ? Bm(h, "name", dt) : (l = !0, c = function() {
    return Vm(v, this);
  })), i)
    if (g = {
      values: s(dt),
...
}, Xm = wt, en = vm, Ys = Nt, el = Er, Wm = Oe.f, qm = Hm, tr = Ym, Qm = le, tl = "Array Iterator", Km = el.set, Zm = el.getterFor(tl), Jm = qm(Array, "Array", function(a, e) {
  Km(this, {
    type: tl,
    target: Xm(a),
    // target
...
var u0 = Te, l0 = Tr, h0 = Fo, f0 = Ni, Ks = TypeError, Zs = "Reduce of empty array with no initial value", Js = function(a) {
  return function(e, t, r, i) {
    var n = l0(e), o = h0(n), s = f0(n);
...
}, g0 = ee, d0 = v0.left, p0 = il, eo = Oi, y0 = wr, m0 = !y0 && eo > 79 && eo < 83, b0 = m0 || !p0("reduce");
...
R0("split", function(a, e, t) {
  ...
  return [
    ...
    function(i, n) {
      ...
      var l = _0(o, RegExp), h = o.unicode, v = (o.ignoreCase ? "i" : "") + (o.multiline ? "m" : "") + (o.unicode ? "u" : "") + (qe ? "g" : "y"), c = new l(qe ? "^(?:" + o.source + ")" : o, v), f = n === void 0 ? j0 : n >>> 0;
      if (f === 0) return [];
...
var fb = ee, vb = L, cb = Zi, gb = he, lo = pe, db = Ji, pb = vb("".indexOf);
fb({ target: "String", proto: !0, forced: !db("includes") }, {
  includes: function(e) {
    return !!~pb(
      lo(gb(this)),
      lo(cb(e)),
...
function Ua(a, e, t) {
  ...
  var v = Math.pow(r, 2) * Math.pow(l, 2) + Math.pow(i, 2) * Math.pow(u, 2), c = (a.lArcFlag !== a.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(r, 2) * Math.pow(i, 2) - v) / v)), f = r * l / i * c, d = -i * u / r * c, g = mi([f, d], a.xRot / 180 * Ee);
  ...
  a.ROUND = function(s) {
    ...
    return i(function(s, u, l) {
      return m.ARC === s.type ? function(h, v, c) {
        ...
        for (var y = Math.min(h.phi1, h.phi2), x = Math.max(h.phi1, h.phi2) - y, b = Math.ceil(x / 90), T = new Array(b), $ = v, E = c, O = 0; O < b; O++) {
          var C = vo(h.phi1, h.phi2, O / b), I = vo(h.phi1, h.phi2, (O + 1) / b), _ = I - C, j = 4 / 3 * Math.tan(_ * ye / 4), P = [Math.cos(C * ye) - j * Math.sin(C * ye), Math.sin(C * ye) + j * Math.cos(C * ye)], X = P[0], W = P[1], G = [Math.cos(I * ye), Math.sin(I * ye)], q = G[0], H = G[1], Q = [q + j * Math.sin(I * ye), H - j * Math.cos(I * ye)], R = Q[0], M = Q[1];
    ...
    var s = function(c) {
      ...
      if (g.type & m.DRAWING_COMMANDS && (p(f), y(d)), g.type & m.HORIZ_LINE_TO && p(g.x), g.type & m.VERT_LINE_TO && y(g.y), g.type & m.LINE_TO && (p(g.x), y(g.y)), g.type & m.CURVE_TO) {
        p(g.x), y(g.y);
        for (var x = 0, b = go(f, g.x1, g.x2, g.x); x < b.length; x++)
          0 < (R = b[x]) && 1 > R && p(po(f, g.x1, g.x2, g.x, R));
        for (var T = 0, $ = go(d, g.y1, g.y2, g.y); T < $.length; T++)
          0 < (R = $[T]) && 1 > R && y(po(d, g.y1, g.y2, g.y, R));
      }
      if (g.type & m.ARC) {
        p(g.x), y(g.y), Ua(g, f, d);
        ...
        }, G = 0, q = fo(I, -O, 0).map(W); G < q.length; G++)
...
}(fl), wb = ((se = {})[m.MOVE_TO] = 2, se[m.LINE_TO] = 2, se[m.HORIZ_LINE_TO] = 1, se[m.VERT_LINE_TO] = 1, se[m.CLOSE_PATH] = 0, se[m.QUAD_TO] = 4, se[m.SMOOTH_QUAD_TO] = 2, se[m.CURVE_TO] = 6, se[m.SMOOTH_CURVE_TO] = 4, se[m.ARC] = 7, se), Cb = Y, Ab = ve, Pb = br, Rb = Fu, mo = RegExp.prototype, Nb = function(a) {
  var e = a.flags;
  return e === void 0 && !("flags" in mo) && !Ab(a, "flags") && Pb(mo, a) ? Cb(Rb, a) : e;
}, Ib = Sr.PROPER, Mb = Ue, _b = J, bo = pe, Vb = k, Db = Nb, rn = "toString", vl = RegExp.prototype, cl = vl[rn], kb = Vb(function() {
  return cl.call({ source: "a", flags: "b" }) !== "/a/b";
}), Lb = Ib && cl.name !== rn;
(kb || Lb) && Mb(vl, rn, function() {
...
function zb(a, e, t, r, i, n) {
  for (var o = a.data, s = 2 * n + 1, u = r - 1, l = i - 1, h = n + 1, v = h * (h + 1) / 2, c = new xo(), f = c, d, g = 1; g < s; g++)
    f = f.next = new xo(), g === h && (d = f);
  f.next = c;
  for (var p = null, y = null, x = 0, b = 0, T = jb[n], $ = Fb[n], E = 0; E < i; E++) {
    ...
    for (var P = 0, X = 0, W = 0, G = 0, q = h * O, H = h * C, Q = h * I, R = h * _, M = v * O, K = v * C, ne = v * I, ge = v * _, Se = 1; Se < h; Se++) {
      ...
      M += (f.r = Mt) * _t, K += (f.g = sn) * _t, ne += (f.b = on) * _t, ge += (f.a = un) * _t, P += Mt, X += sn, W += on, G += un, f = f.next;
    }
    p = c, y = d;
    for (var Lr = 0; Lr < r; Lr++) {
      ...
      var Vt = y, ln = Vt.r, hn = Vt.g, fn = Vt.b, vn = Vt.a;
      q += ln, H += hn, Q += fn, R += vn, P -= ln, X -= hn, W -= fn, G -= vn, y = y.next, b += 4;
    }
    x += r;
  }
  for (var He = 0; He < r; He++) {
    ...
    for (var gn = r, Hr = 0, Yr = 0, Xr = 0, Wr = 0, jt = 1; jt <= n; jt++) {
      b = gn + He << 2;
      var Ft = h - jt;
      Dt += (f.r = Pe = o[b]) * Ft, kt += (f.g = Re = o[b + 1]) * Ft, Lt += (f.b = Ne = o[b + 2]) * Ft, Bt += (f.a = te = o[b + 3]) * Ft, Wr += Pe, Hr += Re, Yr += Ne, Xr += te, f = f.next, jt < l && (gn += r);
    }
    b = He, p = c, y = d;
...
class A extends Ge {
  ...
  static pathA(e) {
    ...
    isNaN(f) && (f = 0);
    var d = new D(f * i * v.y / n, f * -n * v.x / i), g = new D((t.x + h.x) / 2 + Math.cos(l) * d.x - Math.sin(l) * d.y, (t.y + h.y) / 2 + Math.sin(l) * d.x + Math.cos(l) * d.y), p = Oo([1, 0], [(v.x - d.x) / i, (v.y - d.y) / n]), y = [(v.x - d.x) / i, (v.y - d.y) / n], x = [(-v.x - d.x) / i, (-v.y - d.y) / n], b = Oo(y, x);
...
class j1 extends Ce {
  ...
  getPointOnCubicBezier(e, t, r, i, n, o, s, u, l) {
    var h = u * So(e) + o * Eo(e) + i * $o(e) + t * wo(e), v = l * So(e) + s * Eo(e) + n * $o(e) + r * wo(e);
    return {
      x: h,
      y: v
    };
        ...
        l.forEach((v) => {
          ...
          if (c) {
            ...
            if (h.forEach((p) => {
              ...
              x && b && (f[x] = new S(e, x, b));
            }), e.styles[c] = f, e.stylesSpecificity[c] = n1(c), c === "@font-face") {
...
class Dr extends N {
  ...
  apply(e, t) {
    ...
    r.screen.setDefaults(v), this.renderChildren(v), new El(r, {
      nodeType: 1,
      childNodes: [],
      attributes: [{
        nodeName: "type",
...
//# sourceMappingURL=index.es-Btw3-HTe.js.map
