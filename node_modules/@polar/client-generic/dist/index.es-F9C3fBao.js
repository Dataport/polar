import { c as Ke, _ as bl, g as Ao } from "./polar-client-6NH6SZJr.js";
var vt = function(a) {
...
}), Ol = pr, jt = Function.prototype.call, Y = Ol ? jt.bind(jt) : function() {
...
}, Io = pr, Mo = Function.prototype, Ua = Mo.call, El = Io && Mo.bind.bind(Ua, Ua), k = Io ? El : function(a) {
  return function() {
    return Ua.apply(a, arguments);
  };
}, _o = k, $l = _o({}.toString), wl = _o("".slice), Be = function(a) {
  return wl($l(a), 8, -1);
}, Cl = k, Al = L, Pl = Be, Wr = Object, Rl = Cl("".split), Vo = Al(function() {
  return !Wr("z").propertyIsEnumerable(0);
}) ? function(a) {
  return Pl(a) === "String" ? Rl(a, "") : Wr(a);
} : Wr, Fe = function(a) {
  return a == null;
}, Nl = Fe, Il = TypeError, ge = function(a) {
  if (Nl(a))
    throw new Il("Can't call method on " + a);
  return a;
}, Ml = Vo, _l = ge, $t = function(a) {
  return Ml(_l(a));
...
}, Qr = D, Dl = B, Ll = function(a) {
  return Dl(a) ? a : void 0;
}, je = function(a, e) {
  return arguments.length < 2 ? Ll(Qr[a]) : Qr[a] && Qr[a][e];
}, kl = k, yr = kl({}.isPrototypeOf), mr = typeof navigator < "u" && String(navigator.userAgent) || "", Do = D, Kr = mr, fn = Do.process, cn = Do.Deno, gn = fn && fn.versions || cn && cn.version, dn = gn && gn.v8, ue, hr;
dn && (ue = dn.split("."), hr = ue[0] > 0 && ue[0] < 4 ? 1 : +(ue[0] + ue[1]));
!hr && Kr && (ue = Kr.match(/Edge\/(\d+)/), (!ue || ue[1] >= 74) && (ue = Kr.match(/Chrome\/(\d+)/), ue && (hr = +ue[1])));
var bi = hr, pn = bi, Bl = L, Fl = D, jl = Fl.String, Lo = !!Object.getOwnPropertySymbols && !Bl(function() {
  var a = Symbol("symbol detection");
  return !jl(a) || !(Object(a) instanceof Symbol) || // Chrome 38-40 symbols are not inherited from DOM collections prototypes to instances
  !Symbol.sham && pn && pn < 41;
}), Ul = Lo, ko = Ul && !Symbol.sham && typeof Symbol.iterator == "symbol", Gl = je, zl = B, Hl = yr, Yl = ko, Xl = Object, Bo = Yl ? function(a) {
...
}, Zl = Te, Jl = Fe, ot = function(a, e) {
  var t = a[e];
  return Jl(t) ? void 0 : Zl(t);
}, Zr = Y, Jr = B, ea = de, eh = TypeError, th = function(a, e) {
  var t, r;
...
}, Fo = { exports: {} }, yn = D, rh = Object.defineProperty, xi = function(a, e) {
  try {
    rh(yn, a, { value: e, configurable: !0, writable: !0 });
  } catch {
    yn[a] = e;
  }
  return e;
}, ah = D, ih = xi, mn = "__core-js_shared__", bn = Fo.exports = ah[mn] || ih(mn, {});
(bn.versions || (bn.versions = [])).push({
  version: "3.36.0",
  mode: "global",
...
var Ti = Fo.exports, xn = Ti, Oi = function(a, e) {
  return xn[a] || (xn[a] = e || {});
}, nh = ge, sh = Object, xr = function(a) {
  return sh(nh(a));
}, oh = k, uh = xr, lh = oh({}.hasOwnProperty), he = Object.hasOwn || function(e, t) {
  return lh(uh(e), t);
}, hh = k, vh = 0, fh = Math.random(), ch = hh(1 .toString), jo = function(a) {
  return "Symbol(" + (a === void 0 ? "" : a) + ")_" + ch(++vh + fh, 36);
}, gh = D, dh = Oi, Tn = he, ph = jo, yh = Lo, mh = ko, Ze = gh.Symbol, ta = dh("wks"), bh = mh ? Ze.for || Ze : Ze && Ze.withoutSetter || ph, z = function(a) {
  return Tn(ta, a) || (ta[a] = yh && Tn(Ze, a) ? Ze[a] : bh("Symbol." + a)), ta[a];
}, xh = Y, On = de, Sn = Bo, Th = ot, Oh = th, Sh = z, Eh = TypeError, $h = Sh("toPrimitive"), wh = function(a, e) {
  if (!On(a) || Sn(a))
    return a;
  var t = Th(a, $h), r;
  if (t) {
    if (e === void 0 && (e = "default"), r = xh(t, a, e), !On(r) || Sn(r))
      return r;
    throw new Eh("Can't convert object to primitive value");
  }
  return e === void 0 && (e = "number"), Oh(a, e);
}, Ch = wh, Ah = Bo, Uo = function(a) {
  var e = Ch(a, "string");
  return Ah(e) ? e : e + "";
}, Ph = D, En = de, Ga = Ph.document, Rh = En(Ga) && En(Ga.createElement), Tr = function(a) {
  return Rh ? Ga.createElement(a) : {};
}, Nh = le, Ih = L, Mh = Tr, Go = !Nh && !Ih(function() {
  return Object.defineProperty(Mh("div"), "a", {
    get: function() {
      return 7;
    }
  }).a !== 7;
}), _h = le, Vh = Y, Dh = Po, Lh = mi, kh = $t, Bh = Uo, Fh = he, jh = Go, $n = Object.getOwnPropertyDescriptor;
Et.f = _h ? $n : function(e, t) {
  if (e = kh(e), t = Bh(t), jh)
    try {
      return $n(e, t);
    } catch {
  ...
  if (Fh(e, t))
    return Lh(!Vh(Dh.f, e, t), e[t]);
};
var Oe = {}, Uh = le, Gh = L, zo = Uh && Gh(function() {
  return Object.defineProperty(function() {
  }, "prototype", {
    value: 42,
    writable: !1
  }).prototype !== 42;
}), zh = de, Hh = String, Yh = TypeError, K = function(a) {
  if (zh(a))
    return a;
  throw new Yh(Hh(a) + " is not an object");
}, Xh = le, Wh = Go, qh = zo, Ut = K, wn = Uo, Qh = TypeError, ra = Object.defineProperty, Kh = Object.getOwnPropertyDescriptor, aa = "enumerable", ia = "configurable", na = "writable";
...
var Zh = le, Jh = Oe, ev = mi, wt = Zh ? function(a, e, t) {
  return Jh.f(a, e, ev(1, t));
} : function(a, e, t) {
  return a[e] = t, a;
}, Ho = { exports: {} }, za = le, tv = he, Yo = Function.prototype, rv = za && Object.getOwnPropertyDescriptor, Si = tv(Yo, "name"), av = Si && (function() {
}).name === "something", iv = Si && (!za || za && rv(Yo, "name").configurable), Or = {
  EXISTS: Si,
  PROPER: av,
  CONFIGURABLE: iv
}, nv = k, sv = B, Ha = Ti, ov = nv(Function.toString);
sv(Ha.inspectSource) || (Ha.inspectSource = function(a) {
  return ov(a);
});
var Ei = Ha.inspectSource, uv = D, lv = B, Cn = uv.WeakMap, hv = lv(Cn) && /native code/.test(String(Cn)), vv = Oi, fv = jo, An = vv("keys"), $i = function(a) {
  return An[a] || (An[a] = fv(a));
}, wi = {}, cv = hv, Xo = D, gv = de, dv = wt, sa = he, oa = Ti, pv = $i, yv = wi, Pn = "Object already initialized", Ya = Xo.TypeError, mv = Xo.WeakMap, vr, Tt, fr, bv = function(a) {
...
if (cv || oa.state) {
  var ce = oa.state || (oa.state = new mv());
...
var Sr = {
  ...
  enforce: bv,
  getterFor: xv
}, Ci = k, Tv = L, Ov = B, Gt = he, Xa = le, Sv = Or.CONFIGURABLE, Ev = Ei, Wo = Sr, $v = Wo.enforce, wv = Wo.get, Rn = String, ir = Object.defineProperty, Cv = Ci("".slice), Av = Ci("".replace), Pv = Ci([].join), Rv = Xa && !Tv(function() {
  return ir(function() {
  }, "length", { value: 8 }).length !== 8;
}), Nv = String(String).split("String"), Iv = Ho.exports = function(a, e, t) {
  Cv(Rn(e), 0, 7) === "Symbol(" && (e = "[" + Av(Rn(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), t && t.getter && (e = "get " + e), t && t.setter && (e = "set " + e), (!Gt(a, "name") || Sv && a.name !== e) && (Xa ? ir(a, "name", { value: e, configurable: !0 }) : a.name = e), Rv && t && Gt(t, "arity") && a.length !== t.arity && ir(a, "length", { value: t.arity });
  try {
...
var qo = Ho.exports, Mv = B, _v = Oe, Vv = qo, Dv = xi, Ue = function(a, e, t, r) {
  r || (r = {});
  ...
  return a;
}, Qo = {}, Lv = Math.ceil, kv = Math.floor, Bv = Math.trunc || function(e) {
  var t = +e;
  return (t > 0 ? kv : Lv)(t);
}, Fv = Bv, Er = function(a) {
  var e = +a;
  return e !== e || e === 0 ? 0 : Fv(e);
}, jv = Er, Uv = Math.max, Gv = Math.min, zv = function(a, e) {
  var t = jv(a);
  ...
  return Xv(a.length);
}, Wv = $t, qv = zv, Qv = Ai, Nn = function(a) {
  ...
  indexOf: Nn(!1)
}, Kv = k, ua = he, Zv = $t, Jv = Ko.indexOf, ef = wi, In = Kv([].push), Zo = function(a, e) {
  var t = Zv(a), r = 0, i = [], n;
  for (n in t)
    !ua(ef, n) && ua(t, n) && In(i, n);
  for (; e.length > r; )
    ua(t, n = e[r++]) && (~Jv(i, n) || In(i, n));
  return i;
}, Pi = [
  "constructor",
  "hasOwnProperty",
  ...
  "toString",
  "valueOf"
], tf = Zo, rf = Pi, af = rf.concat("length", "prototype");
Qo.f = Object.getOwnPropertyNames || function(e) {
  return tf(e, af);
};
var Jo = {};
Jo.f = Object.getOwnPropertySymbols;
var nf = je, sf = k, of = Qo, uf = Jo, lf = K, hf = sf([].concat), vf = nf("Reflect", "ownKeys") || function(e) {
  var t = of.f(lf(e)), r = uf.f;
  return r ? hf(t, r(e)) : t;
}, Mn = he, ff = vf, cf = Et, gf = Oe, df = function(a, e, t) {
  for (var r = ff(e), i = gf.f, n = cf.f, o = 0; o < r.length; o++) {
    var s = r[o];
    !Mn(a, s) && !(t && Mn(t, s)) && i(a, s, n(e, s));
  }
}, pf = L, yf = B, mf = /#|\.prototype\./, Ct = function(a, e) {
  var t = xf[bf(a)];
  return t === Of ? !0 : t === Tf ? !1 : yf(e) ? pf(e) : !!e;
}, bf = Ct.normalize = function(a) {
  return String(a).replace(mf, ".").toLowerCase();
}, xf = Ct.data = {}, Tf = Ct.NATIVE = "N", Of = Ct.POLYFILL = "P", eu = Ct, zt = D, Sf = Et.f, Ef = wt, $f = Ue, wf = xi, Cf = df, Af = eu, ee = function(a, e) {
...
}, Pf = D, Rf = Be, At = Rf(Pf.process) === "process", Nf = k, If = Te, Mf = function(a, e, t) {
  try {
  ...
  return _f(a) || a === null;
}, Df = Vf, Lf = String, kf = TypeError, Bf = function(a) {
  if (Df(a))
    return a;
  throw new kf("Can't set " + Lf(a) + " as a prototype");
}, Ff = Mf, jf = K, Uf = Bf, tu = Object.setPrototypeOf || ("__proto__" in {} ? function() {
  var a = !1, e = {}, t;
  try {
    t = Ff(Object.prototype, "__proto__", "set"), t(e, []), a = e instanceof Array;
  } catch {
  }
  return function(i, n) {
    return jf(i), Uf(n), a ? t(i, n) : i.__proto__ = n, i;
  };
}() : void 0), Gf = Oe.f, zf = he, Hf = z, _n = Hf("toStringTag"), $r = function(a, e, t) {
  a && !t && (a = a.prototype), a && !zf(a, _n) && Gf(a, _n, { configurable: !0, value: e });
}, Vn = qo, Yf = Oe, Xf = function(a, e, t) {
  return t.get && Vn(t.get, e, { getter: !0 }), t.set && Vn(t.set, e, { setter: !0 }), Yf.f(a, e, t);
}, Wf = je, qf = Xf, Qf = z, Kf = le, Dn = Qf("species"), Zf = function(a) {
  var e = Wf(a);
  Kf && e && !e[Dn] && qf(e, Dn, {
    configurable: !0,
    get: function() {
...
}, Jf = yr, ec = TypeError, tc = function(a, e) {
  if (Jf(e, a))
    return a;
  throw new ec("Incorrect invocation");
}, rc = z, ac = rc("toStringTag"), ru = {};
ru[ac] = "z";
var ic = String(ru) === "[object z]", nc = ic, sc = B, nr = Be, oc = z, uc = oc("toStringTag"), lc = Object, hc = nr(/* @__PURE__ */ function() {
  return arguments;
}()) === "Arguments", vc = function(a, e) {
  try {
    return a[e];
  } catch {
  }
  ...
  var e, t, r;
  return a === void 0 ? "Undefined" : a === null ? "Null" : typeof (t = vc(e = lc(a), uc)) == "string" ? t : hc ? nr(e) : (r = nr(e)) === "Object" && sc(e.callee) ? "Arguments" : r;
}, fc = k, cc = L, au = B, gc = Ri, dc = je, pc = Ei, iu = function() {
}, nu = dc("Reflect", "construct"), Ni = /^\s*(?:class|function)\b/, yc = fc(Ni.exec), mc = !Ni.test(iu), ft = function(e) {
  if (!au(e))
    return !1;
  try {
    return nu(iu, [], e), !0;
  ...
  try {
    return mc || !!yc(Ni, pc(e));
  } catch {
    return !0;
  }
};
su.sham = !0;
var bc = !nu || cc(function() {
  var a;
  return ft(ft.call) || !ft(Object) || !ft(function() {
    a = !0;
  }) || a;
}) ? su : ft, xc = bc, Tc = br, Oc = TypeError, Sc = function(a) {
  if (xc(a))
    return a;
  throw new Oc(Tc(a) + " is not a constructor");
}, Ln = K, Ec = Sc, $c = Fe, wc = z, Cc = wc("species"), ou = function(a, e) {
  var t = Ln(a).constructor, r;
  return t === void 0 || $c(r = Ln(t)[Cc]) ? e : Ec(r);
}, Ac = pr, uu = Function.prototype, kn = uu.apply, Bn = uu.call, lu = typeof Reflect == "object" && Reflect.apply || (Ac ? Bn.bind(kn) : function() {
  return Bn.apply(kn, arguments);
}), Pc = Be, Rc = k, wr = function(a) {
  if (Pc(a) === "Function")
    return Rc(a);
}, Fn = wr, Nc = Te, Ic = pr, Mc = Fn(Fn.bind), Ii = function(a, e) {
  return Nc(a), e === void 0 ? a : Ic ? Mc(a, e) : function() {
    return a.apply(e, arguments);
  };
}, _c = je, hu = _c("document", "documentElement"), Vc = k, Dc = Vc([].slice), Lc = TypeError, kc = function(a, e) {
  if (a < e)
    throw new Lc("Not enough arguments");
  return a;
}, Bc = mr, vu = /(?:ipad|iphone|ipod).*applewebkit/i.test(Bc), ae = D, Fc = lu, jc = Ii, jn = B, Uc = he, fu = L, Un = hu, Gc = Dc, Gn = Tr, zc = kc, Hc = vu, Yc = At, Wa = ae.setImmediate, qa = ae.clearImmediate, Xc = ae.process, la = ae.Dispatch, Wc = ae.Function, zn = ae.MessageChannel, qc = ae.String, ha = 0, bt = {}, Hn = "onreadystatechange", Ot, Ie, va, fa;
fu(function() {
  Ot = ae.location;
});
var Mi = function(a) {
...
(!Wa || !qa) && (Wa = function(e) {
  ...
  var t = jn(e) ? e : Wc(e), r = Gc(arguments, 1);
  ...
  la.now(ca(a));
} : zn && !Hc ? (va = new zn(), fa = va.port2, va.port1.onmessage = Yn, Ie = jc(fa.postMessage, fa)) : ae.addEventListener && jn(ae.postMessage) && !ae.importScripts && Ot && Ot.protocol !== "file:" && !fu(Xn) ? (Ie = Xn, ae.addEventListener("message", Yn, !1)) : Hn in Gn("script") ? Ie = function(a) {
...
var cu = {
  set: Wa,
  clear: qa
}, Wn = D, Qc = le, Kc = Object.getOwnPropertyDescriptor, Zc = function(a) {
  if (!Qc)
    return Wn[a];
  var e = Kc(Wn, a);
  return e && e.value;
...
var du = gu, Jc = mr, eg = /ipad|iphone|ipod/i.test(Jc) && typeof Pebble < "u", tg = mr, rg = /web0s(?!.*chrome)/i.test(tg), it = D, ag = Zc, qn = Ii, ga = cu.set, ig = du, ng = vu, sg = eg, og = rg, da = At, Qn = it.MutationObserver || it.WebKitMutationObserver, Kn = it.document, Zn = it.process, Ht = it.Promise, Qa = ag("queueMicrotask"), Xe, pa, ya, Yt, Jn;
if (!Qa) {
  var Xt = new ig(), Wt = function() {
    var a, e;
  ...
  !ng && !da && !og && Qn && Kn ? (pa = !0, ya = Kn.createTextNode(""), new Qn(Wt).observe(ya, { characterData: !0 }), Xe = function() {
    ya.data = pa = !pa;
  }) : !sg && Ht && Ht.resolve ? (Yt = Ht.resolve(void 0), Yt.constructor = Ht, Jn = qn(Yt.then, Yt), Xe = function() {
    Jn(Wt);
  }) : da ? Xe = function() {
    Zn.nextTick(Wt);
...
}, hg = D, Cr = hg.Promise, pu = typeof Deno == "object" && Deno && typeof Deno.version == "object", vg = pu, fg = At, cg = !vg && !fg && typeof window == "object" && typeof document == "object", gg = D, xt = Cr, dg = B, pg = eu, yg = Ei, mg = z, bg = cg, xg = pu, ma = bi;
xt && xt.prototype;
var Tg = mg("species"), Ka = !1, yu = dg(gg.PromiseRejectionEvent), Og = pg("Promise", function() {
  var a = yg(xt), e = a !== String(xt);
  if (!e && ma === 66)
    return !0;
  ...
  REJECTION_EVENT: yu,
  SUBCLASSING: Ka
}, lt = {}, es = Te, Sg = TypeError, Eg = function(a) {
  var e, t;
  this.promise = new a(function(r, i) {
    if (e !== void 0 || t !== void 0)
      throw new Sg("Bad Promise constructor");
    e = r, t = i;
  }), this.resolve = es(e), this.reject = es(t);
};
lt.f = function(a) {
  return new Eg(a);
};
var $g = ee, cr = At, we = D, nt = Y, ts = Ue, rs = tu, wg = $r, Cg = Zf, Ag = Te, sr = B, Pg = de, Rg = tc, Ng = ou, mu = cu.set, Vi = ug, Ig = lg, Mg = _i, _g = du, bu = Sr, gr = Cr, Di = Pt, xu = lt, Ar = "Promise", Tu = Di.CONSTRUCTOR, Vg = Di.REJECTION_EVENT, Dg = Di.SUBCLASSING, ba = bu.getterFor(Ar), Lg = bu.set, Qe = gr && gr.prototype, De = gr, qt = Qe, Ou = we.TypeError, Za = we.document, Li = we.process, Ja = xu.f, kg = Ja, Bg = !!(Za && Za.createEvent && we.dispatchEvent), Su = "unhandledrejection", Fg = "rejectionhandled", as = 0, Eu = 1, jg = 2, ki = 1, $u = 2, Qt, is, Ug, ns, wu = function(a) {
  var e;
  return Pg(a) && sr(e = a.then) ? e : !1;
}, Cu = function(a, e) {
  var t = e.value, r = e.state === Eu, i = r ? a.ok : a.fail, n = a.resolve, o = a.reject, s = a.domain, u, l, h;
  try {
    i ? (r || (e.rejection === $u && zg(e), e.rejection = ki), i === !0 ? u = t : (s && s.enter(), u = i(t), s && (s.exit(), h = !0)), u === a.promise ? o(new Ou("Promise-chain cycle")) : (l = wu(u)) ? nt(l, u, n, o) : n(u)) : o(t);
  } catch (f) {
    s && !h && s.exit(), o(f);
  }
}, Au = function(a, e) {
  ...
  var r, i;
  Bg ? (r = Za.createEvent("Event"), r.promise = e, r.reason = t, r.initEvent(a, !1, !0), we.dispatchEvent(r)) : r = { promise: e, reason: t }, !Vg && (i = we["on" + a]) ? i(r) : a === Su && Ig("Unhandled promise rejection", t);
}, Gg = function(a) {
  nt(mu, we, function() {
    var e = a.facade, t = a.value, r = ss(a), i;
    if (r && (i = Mg(function() {
      cr ? Li.emit("unhandledRejection", t, e) : Pu(Su, e, t);
    }), a.rejection = cr || ss(a) ? $u : ki, i.error))
      throw i.value;
  });
}, ss = function(a) {
  ...
  nt(mu, we, function() {
    var e = a.facade;
    cr ? Li.emit("rejectionHandled", e) : Pu(Fg, e, a.value);
  });
}, Je = function(a, e, t) {
  return function(r) {
    a(e, r, t);
  ...
  a.done || (a.done = !0, t && (a = t), a.value = e, a.state = jg, Au(a, !0));
}, ei = function(a, e, t) {
  if (!a.done) {
    a.done = !0, t && (a = t);
    try {
      if (a.facade === e)
        throw new Ou("Promise can't be resolved itself");
      var r = wu(e);
      r ? Vi(function() {
        var i = { done: !1 };
        try {
...
if (Tu && (De = function(e) {
  ...
  var r = ba(this), i = Ja(Ng(this, De));
  return r.parent = !0, i.ok = sr(e) ? e : !0, i.fail = sr(t) && t, i.domain = cr ? Li.domain : void 0, r.state === as ? r.reactions.add(i) : Vi(function() {
    Cu(i, r);
  }), i.promise;
}), is = function() {
  var a = new Qt(), e = ba(a);
  ...
  return a === De || a === Ug ? new is(a) : kg(a);
}, sr(gr) && Qe !== Object.prototype)) {
  ns = Qe.then, Dg || ts(Qe, "then", function(e, t) {
    var r = this;
...
$g({ global: !0, constructor: !0, wrap: !0, forced: Tu }, {
  Promise: De
});
wg(De, Ar, !1);
Cg(Ar);
var Rt = {}, Hg = z, Yg = Rt, Xg = Hg("iterator"), Wg = Array.prototype, qg = function(a) {
...
}, Qg = Ri, os = ot, Kg = Fe, Zg = Rt, Jg = z, ed = Jg("iterator"), Ru = function(a) {
  if (!Kg(a))
    return os(a, ed) || os(a, "@@iterator") || Zg[Qg(a)];
}, td = Y, rd = Te, ad = K, id = br, nd = Ru, sd = TypeError, od = function(a, e) {
  var t = arguments.length < 2 ? nd(a) : e;
  if (rd(t))
    return ad(td(t, a));
  throw new sd(id(a) + " is not iterable");
}, ud = Y, us = K, ld = ot, hd = function(a, e, t) {
  var r, i;
  us(a);
  try {
    if (r = ld(a, "return"), !r) {
  ...
  if (i)
    throw r;
  return us(r), t;
}, vd = Ii, fd = Y, cd = K, gd = br, dd = qg, pd = Ai, ls = yr, yd = od, md = Ru, hs = hd, bd = TypeError, or = function(a, e) {
  this.stopped = a, this.result = e;
}, vs = or.prototype, Nu = function(a, e, t) {
  ...
  if (n)
    ...
    if (h = md(a), !h)
      throw new bd(gd(a) + " is not iterable");
    if (dd(h)) {
      for (f = 0, c = pd(a); c > f; f++)
        if (v = y(a[f]), v && ls(vs, v))
          return v;
      return new or(!1);
    }
    l = yd(a, h);
  ...
  for (d = n ? a.next : l.next; !(g = fd(d, l)).done; ) {
    ...
    if (typeof v == "object" && v && ls(vs, v))
      return v;
  }
  return new or(!1);
}, xd = z, Iu = xd("iterator"), Mu = !1;
try {
  var Td = 0, fs = {
    next: function() {
      return { done: !!Td++ };
...
var Od = function(a, e) {
  ...
  return t;
}, Sd = Cr, Ed = Od, $d = Pt.CONSTRUCTOR, _u = $d || !Ed(function(a) {
  Sd.all(a).then(void 0, function() {
  });
}), wd = ee, Cd = Y, Ad = Te, Pd = lt, Rd = _i, Nd = Nu, Id = _u;
...
var Md = ee, _d = Pt.CONSTRUCTOR, ti = Cr, Vd = je, Dd = B, Ld = Ue, cs = ti && ti.prototype;
...
if (Dd(ti)) {
  var gs = Vd("Promise").prototype.catch;
  cs.catch !== gs && Ld(cs, "catch", gs, { unsafe: !0 });
}
var kd = ee, Bd = Y, Fd = Te, jd = lt, Ud = _i, Gd = Nu, zd = _u;
kd({ target: "Promise", stat: !0, forced: zd }, {
  race: function(e) {
...
var Hd = ee, Yd = lt, Xd = Pt.CONSTRUCTOR;
...
var Wd = K, qd = de, Qd = lt, Kd = function(a, e) {
  if (Wd(a), qd(e) && e.constructor === a)
    return e;
...
var rp = Ri, ap = String, pe = function(a) {
...
}, Bi = L, np = D, Fi = np.RegExp, ji = Bi(function() {
  var a = Fi("a", "y");
  ...
  MISSED_STICKY: sp,
  UNSUPPORTED_Y: ji
}, Lu = {}, up = Zo, lp = Pi, hp = Object.keys || function(e) {
  return up(e, lp);
}, vp = le, fp = zo, cp = Oe, gp = K, dp = $t, pp = hp;
Lu.f = vp && !fp ? Object.defineProperties : function(e, t) {
  gp(e);
  for (var r = dp(t), i = pp(t), n = i.length, o = 0, s; n > o; )
    cp.f(e, s = i[o++], r[s]);
  return e;
};
var yp = K, mp = Lu, ps = Pi, bp = wi, xp = hu, Tp = Tr, Op = $i, ys = ">", ms = "<", ri = "prototype", ai = "script", ku = Op("IE_PROTO"), xa = function() {
}, Bu = function(a) {
  return ms + ai + ys + a + ms + "/" + ai + ys;
}, bs = function(a) {
  a.write(Bu("")), a.close();
  var e = a.parentWindow.Object;
  return a = null, e;
}, Sp = function() {
  var a = Tp("iframe"), e = "java" + ai + ":", t;
  return a.style.display = "none", xp.appendChild(a), a.src = String(e), t = a.contentWindow.document, t.open(), t.write(Bu("document.F=Object")), t.close(), t.F;
}, Kt, ur = function() {
  try {
    Kt = new ActiveXObject("htmlfile");
  } catch {
  }
  ur = typeof document < "u" ? document.domain && Kt ? bs(Kt) : Sp() : bs(Kt);
...
var Ui = Object.create || function(e, t) {
  var r;
  return e !== null ? (xa[ri] = yp(e), r = new xa(), xa[ri] = null, r[ku] = e) : r = ur(), t === void 0 ? r : mp.f(r, t);
}, Ep = L, $p = D, wp = $p.RegExp, Cp = Ep(function() {
  var a = wp(".", "s");
  return !(a.dotAll && a.test(`
`) && a.flags === "s");
}), Ap = L, Pp = D, Rp = Pp.RegExp, Np = Ap(function() {
  var a = Rp("(?<a>b)", "g");
  return a.exec("b").groups.a !== "b" || "b".replace(a, "$<a>c") !== "bc";
}), et = Y, Pr = k, Ip = pe, Mp = Vu, _p = Du, Vp = Oi, Dp = Ui, Lp = Sr.get, kp = Cp, Bp = Np, Fp = Vp("native-string-replace", String.prototype.replace), dr = RegExp.prototype.exec, ii = dr, jp = Pr("".charAt), Up = Pr("".indexOf), Gp = Pr("".replace), Ta = Pr("".slice), ni = function() {
  var a = /a/, e = /b*/g;
  return et(dr, a, "a"), et(dr, e, "a"), a.lastIndex !== 0 || e.lastIndex !== 0;
}(), Fu = _p.BROKEN_CARET, si = /()??/.exec("")[1] !== void 0, zp = ni || si || Fu || kp || Bp;
zp && (ii = function(e) {
  var t = this, r = Lp(t), i = Ip(e), n = r.raw, o, s, u, l, h, f, c;
  if (n)
    return n.lastIndex = t.lastIndex, o = et(ii, n, i), t.lastIndex = n.lastIndex, o;
  var v = r.groups, d = Fu && t.sticky, g = et(Mp, t), p = t.source, y = 0, x = i;
  if (d && (g = Gp(g, "y", ""), Up(g, "g") === -1 && (g += "g"), x = Ta(i, t.lastIndex), t.lastIndex > 0 && (!t.multiline || t.multiline && jp(i, t.lastIndex - 1) !== `
`) && (p = "(?: " + p + ")", x = " " + x, y++), s = new RegExp("^(?:" + p + ")", g)), si && (s = new RegExp("^" + p + "$(?!\\s)", g)), ni && (u = t.lastIndex), l = et(dr, d ? s : t, x), d ? l ? (l.input = Ta(l.input, y), l[0] = Ta(l[0], y), l.index = t.lastIndex, t.lastIndex += l[0].length) : t.lastIndex = 0 : ni && l && (t.lastIndex = t.global ? l.index + l[0].length : u), si && l && l.length > 1 && et(Fp, l[0], s, function() {
...
var Gi = ii, Hp = ee, xs = Gi;
Hp({ target: "RegExp", proto: !0, forced: /./.exec !== xs }, {
  exec: xs
});
var Ts = Y, Os = Ue, Yp = Gi, Ss = L, ju = z, Xp = wt, Wp = ju("species"), Oa = RegExp.prototype, zi = function(a, e, t, r) {
  var i = ju(a), n = !Ss(function() {
    var l = {};
    return l[i] = function() {
      return 7;
    }, ""[a](l) !== 7;
    ...
    var l = !1, h = /a/;
    return a === "split" && (h = {}, h.constructor = {}, h.constructor[Wp] = function() {
      return h;
  ...
  if (!n || !o || t) {
    var s = /./[i], u = e(i, ""[a], function(l, h, f, c, v) {
      var d = h.exec;
      return d === Yp || d === Oa.exec ? n && !v ? { done: !0, value: Ts(s, h, f, c) } : { done: !0, value: Ts(l, f, h, c) } : { done: !1 };
    });
    Os(String.prototype, a, u[0]), Os(Oa, i, u[1]);
  }
  r && Xp(Oa[i], "sham", !0);
}, Hi = k, qp = Er, Qp = pe, Kp = ge, Zp = Hi("".charAt), Es = Hi("".charCodeAt), Jp = Hi("".slice), $s = function(a) {
  return function(e, t) {
    var r = Qp(Kp(e)), i = qp(t), n = r.length, o, s;
    return i < 0 || i >= n ? a ? "" : void 0 : (o = Es(r, i), o < 55296 || o > 56319 || i + 1 === n || (s = Es(r, i + 1)) < 56320 || s > 57343 ? a ? Zp(r, i) : o : a ? Jp(r, i, i + 2) : (o - 55296 << 10) + (s - 56320) + 65536);
  };
}, ey = {
...
}, ws = Y, ry = K, ay = B, iy = Be, ny = Gi, sy = TypeError, Xi = function(a, e) {
  var t = a.exec;
  if (ay(t)) {
    var r = ws(t, a, e);
...
}, oy = Y, uy = zi, ly = K, hy = Fe, vy = ut, Sa = pe, fy = ge, cy = ot, gy = Yi, Cs = Xi;
uy("match", function(a, e, t) {
  return [
    ...
    function(i) {
      ...
      return o ? oy(o, i, n) : new RegExp(i)[a](Sa(n));
    },
    // `RegExp.prototype[@@match]` method
    // https://tc39.es/ecma262/#sec-regexp.prototype-@@match
    function(r) {
      var i = ly(this), n = Sa(r), o = t(e, i, n);
      if (o.done)
        return o.value;
      if (!i.global)
        return Cs(i, n);
...
var Wi = k, dy = xr, py = Math.floor, Ea = Wi("".charAt), yy = Wi("".replace), $a = Wi("".slice), my = /\$([$&'`]|\d{1,2}|<[^>]*>)/g, by = /\$([$&'`]|\d{1,2})/g, xy = function(a, e, t, r, i, n) {
...
}, Ty = lu, As = Y, Rr = k, Oy = zi, Sy = L, Ey = K, $y = B, wy = Fe, Cy = Er, Ay = ut, We = pe, Py = ge, Ry = Yi, Ny = ot, Iy = xy, My = Xi, _y = z, oi = _y("replace"), Vy = Math.max, Dy = Math.min, Ly = Rr([].concat), wa = Rr([].push), Ps = Rr("".indexOf), Rs = Rr("".slice), ky = function(a) {
...
Oy("replace", function(a, e, t) {
  ...
  return [
    ...
    function(n, o) {
      var s = Py(this), u = wy(n) ? void 0 : Ny(n, oi);
    ...
    function(i, n) {
      ...
      for (var c = [], v; v = My(o, s), !(v === null || (wa(c, v), !h)); ) {
        var d = We(v[0]);
        d === "" && (o.lastIndex = Ry(s, Ay(o.lastIndex), f));
      }
      for (var g = "", p = 0, y = 0; y < c.length; y++) {
        v = c[y];
        for (var x = We(v[0]), b = Vy(Dy(Cy(v.index), s.length), 0), T = [], $, E = 1; E < v.length; E++)
          wa(T, ky(v[E]));
        var O = v.groups;
        if (l) {
          var C = Ly([x], T, b, s);
          O !== void 0 && wa(C, O), $ = We(Ty(n, void 0, C));
        } else
          $ = Iy(x, s, b, T, O, n);
...
var jy = de, Uy = Be, Gy = z, zy = Gy("match"), Hy = function(a) {
  var e;
  return jy(a) && ((e = a[zy]) !== void 0 ? !!e : Uy(a) === "RegExp");
  ...
  return !1;
}, Qy = ee, Ky = wr, Zy = Et.f, Jy = ut, Is = pe, em = qi, tm = ge, rm = Qi, am = Ky("".slice), im = Math.min, Uu = rm("startsWith"), nm = !Uu && !!function() {
  var a = Zy(String.prototype, "startsWith");
  return a && !a.writable;
}();
Qy({ target: "String", proto: !0, forced: !nm && !Uu }, {
  startsWith: function(e) {
    var t = Is(tm(this));
    em(e);
    var r = Jy(im(arguments.length > 1 ? arguments[1] : void 0, t.length)), i = Is(e);
    return am(t, r, r + i.length) === i;
  }
});
var sm = z, om = Ui, um = Oe.f, ui = sm("unscopables"), li = Array.prototype;
li[ui] === void 0 && um(li, ui, {
  configurable: !0,
  value: om(null)
});
var lm = function(a) {
...
}), fm = he, cm = B, gm = xr, dm = $i, pm = vm, Ms = dm("IE_PROTO"), hi = Object, ym = hi.prototype, Gu = pm ? hi.getPrototypeOf : function(a) {
  var e = gm(a);
  if (fm(e, Ms))
    return e[Ms];
  var t = e.constructor;
  return cm(t) && e instanceof t ? t.prototype : e instanceof hi ? ym : null;
}, mm = L, bm = B, xm = de, _s = Gu, Tm = Ue, Om = z, vi = Om("iterator"), zu = !1, Le, Ca, Aa;
[].keys && (Aa = [].keys(), "next" in Aa ? (Ca = _s(_s(Aa)), Ca !== Object.prototype && (Le = Ca)) : zu = !0);
var Sm = !xm(Le) || mm(function() {
  var a = {};
  return Le[vi].call(a) !== a;
});
Sm && (Le = {});
bm(Le[vi]) || Tm(Le, vi, function() {
  return this;
});
var Hu = {
  IteratorPrototype: Le,
  BUGGY_SAFARI_ITERATORS: zu
}, Em = Hu.IteratorPrototype, $m = Ui, wm = mi, Cm = $r, Am = Rt, Pm = function() {
  return this;
}, Rm = function(a, e, t, r) {
  var i = e + " Iterator";
  return a.prototype = $m(Em, { next: wm(+!r, t) }), Cm(a, i, !1), Am[i] = Pm, a;
}, Nm = ee, Im = Y, Yu = Or, Mm = B, _m = Rm, Vs = Gu, Ds = tu, Vm = $r, Dm = wt, Pa = Ue, Lm = z, km = Rt, Xu = Hu, Bm = Yu.PROPER, Fm = Yu.CONFIGURABLE, Ls = Xu.IteratorPrototype, Zt = Xu.BUGGY_SAFARI_ITERATORS, ct = Lm("iterator"), ks = "keys", gt = "values", Bs = "entries", jm = function() {
  return this;
  ...
  if (v && (d = Vs(v.call(new a())), d !== Object.prototype && d.next && (Vs(d) !== Ls && (Ds ? Ds(d, Ls) : Mm(d[ct]) || Pa(d, ct, jm)), Vm(d, u, !0))), Bm && i === gt && f && f.name !== gt && (Fm ? Dm(h, "name", gt) : (l = !0, c = function() {
    return Im(f, this);
  })), i)
    if (g = {
      values: s(gt),
      ...
      Nm({ target: e, proto: !0, forced: Zt || l }, g);
  return h[ct] !== c && Pa(h, ct, c, { name: i }), km[e] = c, g;
}, Gm = function(a, e) {
  return { value: a, done: e };
}, zm = $t, Ki = lm, Fs = Rt, Wu = Sr, Hm = Oe.f, Ym = Um, Jt = Gm, Xm = le, qu = "Array Iterator", Wm = Wu.set, qm = Wu.getterFor(qu), Qm = Ym(Array, "Array", function(a, e) {
  Wm(this, {
    type: qu,
    target: zm(a),
    // target
  ...
  return Jt([t, e[t]], !1);
}, "values"), js = Fs.Arguments = Fs.Array;
Ki("keys");
Ki("values");
Ki("entries");
if (Xm && js.name !== "values")
  try {
    Hm(js, "name", { value: "values" });
  } catch {
  }
var Km = {
  CSSRuleList: 0,
  ...
  TextTrackList: 0,
  TouchList: 0
}, Zm = Tr, Ra = Zm("span").classList, Us = Ra && Ra.constructor && Ra.constructor.prototype, Jm = Us === Object.prototype ? void 0 : Us, Gs = D, Qu = Km, e0 = Jm, pt = Qm, zs = wt, t0 = $r, r0 = z, Na = r0("iterator"), Ia = pt.values, Ku = function(a, e) {
  if (a) {
    if (a[Na] !== Ia)
      try {
        zs(a, Na, Ia);
...
for (var Ma in Qu)
  Ku(Gs[Ma] && Gs[Ma].prototype, Ma);
Ku(e0, "DOMTokenList");
function Zi(a, e, t) {
  return e = bl(e), e in a ? Object.defineProperty(a, e, {
    value: t,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
var a0 = Te, i0 = xr, n0 = Vo, s0 = Ai, Hs = TypeError, Ys = "Reduce of empty array with no initial value", Xs = function(a) {
  return function(e, t, r, i) {
    var n = i0(e), o = n0(n), s = s0(n);
    if (a0(t), s === 0 && r < 2)
      throw new Hs(Ys);
...
}, l0 = ee, h0 = o0.left, v0 = Zu, Ws = bi, f0 = At, c0 = !f0 && Ws > 79 && Ws < 83, g0 = c0 || !v0("reduce");
...
var d0 = ee, p0 = wr, y0 = Et.f, m0 = ut, qs = pe, b0 = qi, x0 = ge, T0 = Qi, O0 = p0("".slice), S0 = Math.min, Ju = T0("endsWith"), E0 = !Ju && !!function() {
  var a = y0(String.prototype, "endsWith");
  return a && !a.writable;
}();
d0({ target: "String", proto: !0, forced: !E0 && !Ju }, {
  endsWith: function(e) {
    var t = qs(x0(this));
    b0(e);
...
var _a = Y, el = k, $0 = zi, w0 = K, C0 = Fe, A0 = ge, P0 = ou, R0 = Yi, N0 = ut, Qs = pe, I0 = ot, Ks = Xi, M0 = Du, _0 = L, qe = M0.UNSUPPORTED_Y, V0 = 4294967295, D0 = Math.min, Va = el([].push), Da = el("".slice), L0 = !_0(function() {
  var a = /(?:)/, e = a.exec;
  a.exec = function() {
...
$0("split", function(a, e, t) {
  ...
  return [
    ...
    function(n, o) {
      ...
      return u ? _a(u, n, s, o) : _a(r, Qs(s), n, o);
    },
    ...
    function(i, n) {
      ...
      if (v === 0)
        return [];
      if (s.length === 0)
        return Ks(c, s) === null ? [s] : [];
      for (var d = 0, g = 0, p = []; g < s.length; ) {
        c.lastIndex = qe ? 0 : g;
        var y = Ks(c, qe ? Da(s, g) : s), x;
...
var k0 = yt.exports, B0 = k0, be = typeof window > "u" ? Ke : window, er = ["moz", "webkit"], rt = "AnimationFrame", st = be["request" + rt], St = be["cancel" + rt] || be["cancelRequest" + rt];
for (var dt = 0; !st && dt < er.length; dt++)
  st = be[er[dt] + "Request" + rt], St = be[er[dt] + "Cancel" + rt] || be[er[dt] + "CancelRequest" + rt];
if (!st || !St) {
  var La = 0, Js = 0, Me = [], F0 = 1e3 / 60;
  st = function(a) {
    if (Me.length === 0) {
      var e = B0(), t = Math.max(0, F0 - (e - La));
...
var j0 = Nr.exports;
const ka = /* @__PURE__ */ Ao(j0);
var tl = `	
\v\f\r                　\u2028\u2029\uFEFF`, U0 = k, G0 = ge, z0 = pe, fi = tl, eo = U0("".replace), H0 = RegExp("^[" + fi + "]+"), Y0 = RegExp("(^|[^" + fi + "])[" + fi + "]+$"), Ba = function(a) {
  return function(e) {
    var t = z0(G0(e));
  ...
  trim: Ba(3)
}, W0 = Or.PROPER, q0 = L, to = tl, ro = "​᠎", Q0 = function(a) {
  return q0(function() {
    return !!to[a]() || ro[a]() !== ro || W0 && to[a].name !== a;
  });
}, K0 = ee, Z0 = X0.trim, J0 = Q0;
K0({ target: "String", proto: !0, forced: J0("trim") }, {
  trim: function() {
    return Z0(this);
  }
});
...
const ci = /* @__PURE__ */ Ao(eb);
var tb = ee, rb = wr, ab = Ko.indexOf, ib = Zu, gi = rb([].indexOf), rl = !!gi && 1 / gi([1], 1, -0) < 0, nb = rl || !ib("indexOf");
tb({ target: "Array", proto: !0, forced: nb }, {
  indexOf: function(e) {
    var t = arguments.length > 1 ? arguments[1] : void 0;
    return rl ? gi(this, e, t) || 0 : ab(this, e, t);
  }
});
var sb = ee, ob = k, ub = qi, lb = ge, ao = pe, hb = Qi, vb = ob("".indexOf);
sb({ target: "String", proto: !0, forced: !hb("includes") }, {
  includes: function(e) {
    return !!~vb(
      ao(lb(this)),
      ao(ub(e)),
...
var fb = Be, cb = Array.isArray || function(e) {
  return fb(e) === "Array";
}, gb = ee, db = k, pb = cb, yb = db([].reverse), io = [1, 2];
gb({ target: "Array", proto: !0, forced: String(io) === String(io.reverse()) }, {
  reverse: function() {
    return pb(this) && (this.length = this.length), yb(this);
  }
});
/*! *****************************************************************************
...
***************************************************************************** */
var al = function(a, e) {
  return (al = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t, r) {
    t.__proto__ = r;
  } || function(t, r) {
    for (var i in r)
...
function il(a, e) {
  ...
  al(a, e), a.prototype = e === null ? Object.create(e) : (t.prototype = e.prototype, new t());
}
function mb(a) {
  var e = "";
  Array.isArray(a) || (a = [a]);
    ...
    return oe(s, u, l, h, f, c), i(function(v, d, g, p) {
      ...
      if (v.xRot !== void 0 && (s !== 1 || u !== 0 || l !== 0 || h !== 1))
        if (O === 0)
          ...
          v.rX = Math.abs(O) / Math.sqrt(q * E(Z) + H * M * Z + Q * E(M)), v.rY = Math.abs(O) / Math.sqrt(q * E(M) - H * M * Z + Q * E(Z)), v.xRot = 180 * R / Math.PI;
        }
...
`;
  ...
  return il(e, a), e.prototype.finish = function(t) {
  ...
  return il(e, a), e.prototype.encode = function() {
...
}(nl), Tb = ((se = {})[m.MOVE_TO] = 2, se[m.LINE_TO] = 2, se[m.HORIZ_LINE_TO] = 1, se[m.VERT_LINE_TO] = 1, se[m.CLOSE_PATH] = 0, se[m.QUAD_TO] = 4, se[m.SMOOTH_QUAD_TO] = 2, se[m.CURVE_TO] = 6, se[m.SMOOTH_CURVE_TO] = 4, se[m.ARC] = 7, se), Ob = Y, Sb = he, Eb = yr, $b = Vu, vo = RegExp.prototype, wb = function(a) {
  var e = a.flags;
  return e === void 0 && !("flags" in vo) && !Sb(a, "flags") && Eb(vo, a) ? Ob($b, a) : e;
}, Cb = Or.PROPER, Ab = Ue, Pb = K, fo = pe, Rb = L, Nb = wb, Ji = "toString", sl = RegExp.prototype, ol = sl[Ji], Ib = Rb(function() {
  return ol.call({ source: "a", flags: "b" }) !== "/a/b";
}), Mb = Cb && ol.name !== Ji;
(Ib || Mb) && Ab(sl, Ji, function() {
  var e = Pb(this), t = fo(e.source), r = fo(Nb(e));
  return "/" + t + "/" + r;
}, { unsafe: !0 });
function lr(a) {
...
var Vb = [512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437, 420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405, 394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298, 291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456, 446, 437, 428, 420, 412, 404, 396, 388, 381, 374, 367, 360, 354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292, 287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482, 475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405, 399, 394, 389, 383, 378, 373, 368, 364, 359, 354, 350, 345, 341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298, 294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259, 257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456, 451, 446, 442, 437, 433, 428, 424, 420, 416, 412, 408, 404, 400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360, 357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323, 320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292, 289, 287, 285, 282, 280, 278, 275, 273, 271, 269, 267, 265, 263, 261, 259], Db = [9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24];
...
function kb(a, e, t, r, i, n) {
  if (!(isNaN(n) || n < 1)) {
    n |= 0;
    var o = Lb(a, e, t, r, i);
    o = Bb(o, e, t, r, i, n), a.getContext("2d").putImageData(o, e, t);
  }
}
function Bb(a, e, t, r, i, n) {
  ...
  v.next = c;
  for (var p = null, y = null, x = 0, b = 0, T = Vb[n], $ = Db[n], E = 0; E < i; E++) {
    v = c;
    for (var O = o[b], C = o[b + 1], I = o[b + 2], _ = o[b + 3], F = 0; F < h; F++)
      v.r = O, v.g = C, v.b = I, v.a = _, v = v.next;
    for (var P = 0, X = 0, W = 0, G = 0, q = h * O, H = h * C, Q = h * I, R = h * _, M = f * O, Z = f * C, ne = f * I, fe = f * _, Se = 1; Se < h; Se++) {
    ...
    for (var Dr = 0; Dr < r; Dr++) {
      ...
      if (o[b + 3] = Lr, Lr !== 0) {
        var kr = 255 / Lr;
        o[b] = (M * T >>> $) * kr, o[b + 1] = (Z * T >>> $) * kr, o[b + 2] = (ne * T >>> $) * kr;
      } else
        o[b] = o[b + 1] = o[b + 2] = 0;
...
var co = (
   ...
   */
  function a() {
    _b(this, a), this.r = 0, this.g = 0, this.b = 0, this.a = 0, this.next = null;
  }
);
function Fb() {
  var {
...
var zb = /^[A-Z-]+$/;
function Hb(a) {
  return zb.test(a) ? a.toLowerCase() : a;
}
function ul(a) {
  var e = /url\(('([^']+)'|"([^"]+)"|([^'")]+))\)/.exec(a) || [];
  return e[2] || e[3] || e[4];
...
var Xb = /(\[[^\]]+\])/g, Wb = /(#[^\s+>~.[:]+)/g, qb = /(\.[^\s+>~.[:]+)/g, Qb = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi, Kb = /(:[\w-]+\([^)]*\))/gi, Zb = /(:[^\s+>~.[:]+)/g, Jb = /([^\s+>~.[:]+)/g;
function _e(a, e) {
  var t = e.exec(a);
...
function e1(a) {
  ...
  return [t, r] = _e(t, Xb), e[1] += r, [t, r] = _e(t, Wb), e[0] += r, [t, r] = _e(t, qb), e[1] += r, [t, r] = _e(t, Qb), e[2] += r, [t, r] = _e(t, Kb), e[1] += r, [t, r] = _e(t, Zb), e[1] += r, t = t.replace(/[*\s+>~]/g, " ").replace(/[#.]/g, " "), [t, r] = _e(t, Jb), e[2] += r, e.join("");
}
var at = 1e-8;
function go(a) {
...
class S {
  ...
  getColor(e) {
    ...
    return this.isNormalizedColor || (this.isNormalizedColor = !0, t = Yb(t), this.value = t), t;
  }
  getDpi() {
    return 96;
  }
...
var ll = typeof window < "u" ? window : null, hl = typeof fetch < "u" ? fetch.bind(void 0) : null;
class Ir {
  constructor(e) {
    var {
      fetch: t = hl,
    ...
    this.ctx = e, this.FRAMERATE = 30, this.MAX_VIRTUAL_PIXELS = 3e4, this.CLIENT_WIDTH = 800, this.CLIENT_HEIGHT = 600, this.viewPort = new t1(), this.mouse = new r1(this), this.animations = [], this.waits = [], this.frameDuration = 0, this.isReadyLock = !1, this.isFirstRender = !0, this.intervalId = null, this.window = r, this.fetch = t;
  }
  wait(e) {
    this.waits.push(e);
  }
...
var {
  defaultFetch: a1
} = Ir, i1 = typeof DOMParser < "u" ? DOMParser : null;
class ja {
  constructor() {
    var {
      fetch: e = a1,
...
class ke {
  constructor(e, t, r) {
    ...
    i.forEach((n) => {
      if (n !== "none") {
        var [o, s] = v1(n), u = ke.transformTypes[o];
...
function g1(a) {
  return typeof process > "u" ? a : a.trim().split(",").map(c1).join(",");
}
function d1(a) {
  if (!a)
    return "";
...
class Ge extends N {
  ...
  setContext(e) {
    ...
    if (this.modifiedEmSizeStack = !1, typeof e.font < "u") {
      var E = this.getStyle("font"), O = this.getStyle("font-style"), C = this.getStyle("font-variant"), I = this.getStyle("font-weight"), _ = this.getStyle("font-size"), F = this.getStyle("font-family"), P = new J(O.getString(), C.getString(), I.getString(), _.hasValue() ? "".concat(_.getPixels(!0), "px") : "", F.getString(), J.parse(E.getString(), e.font));
...
class A extends Ge {
  ...
  static pathA(e) {
    ...
    isNaN(v) && (v = 0);
    var d = new V(v * i * f.y / n, v * -n * f.x / i), g = new V((t.x + h.x) / 2 + Math.cos(l) * d.x - Math.sin(l) * d.y, (t.y + h.y) / 2 + Math.sin(l) * d.x + Math.cos(l) * d.y), p = po([1, 0], [(f.x - d.x) / i, (f.y - d.y) / n]), y = [(f.x - d.x) / i, (f.y - d.y) / n], x = [(-f.x - d.x) / i, (-f.y - d.y) / n], b = po(y, x);
...
class Ce extends Ge {
  ...
  getTextFromNode(e) {
    ...
    return i === 0 && (o = Ub(o)), i === n && (o = Gb(o)), o;
  }
  renderChildren(e) {
    if (this.type !== "text") {
  ...
  createGradient(e, t, r) {
    ...
    if (n.forEach((p) => {
      ...
      var {
        ...
        viewPort: l
      } = s.screen, [h] = l.viewPorts, f = new gl(s, null);
        ...
        l.forEach((f) => {
          ...
          if (c) {
            ...
            if (h.forEach((p) => {
              ...
              x && b && (v[x] = new S(e, x, b));
            }), e.styles[c] = v, e.stylesSpecificity[c] = e1(c), c === "@font-face") {
...
class _r extends N {
  ...
  apply(e, t) {
    ...
    r.screen.setDefaults(f), this.renderChildren(f), new ml(r, {
      nodeType: 1,
      childNodes: [],
      attributes: [{
        nodeName: "type",
...
class H1 extends N {
  ...
  apply(e, t, r, i, n) {
    ...
    l.id = o.getUniqueId(), u && (l.style.display = "none", u.appendChild(l)), kb(l, t, r, i, n, s), u && u.removeChild(l);
  }
}
class Y1 extends N {
  constructor() {
...
class $e {
  ...
  createElement(e) {
    ...
    return typeof r < "u" ? new r(this, e) : new f1(this, e);
  }
  createTextNode(e) {
...
export {
  _1 as AElement,
  A1 as AnimateColorElement,
  tn as AnimateElement,
  P1 as AnimateTransformElement,
  ve as BoundingBox,
  yo as CB1,
  mo as CB2,
  bo as CB3,
  ...
  mt as Canvg,
  m1 as CircleElement,
  j1 as ClipPathElement,
  E1 as DefsElement,
  X1 as DescElement,
  $e as Document,
  N as Element,
  b1 as EllipseElement,
  ml as FeColorMatrixElement,
  z1 as FeCompositeElement,
  U1 as FeDropShadowElement,
  H1 as FeGaussianBlurElement,
  G1 as FeMorphologyElement,
  Vr as FilterElement,
  J as Font,
  R1 as FontElement,
  N1 as FontFaceElement,
  en as GElement,
  cl as GlyphElement,
  pl as GradientElement,
  L1 as ImageElement,
  x1 as LineElement,
  $1 as LinearGradientElement,
  S1 as MarkerElement,
  _r as MaskElement,
  vl as Matrix,
  ...
  Mr as TSpanElement,
  Ce as TextElement,
  V1 as TextPathElement,
  Y1 as TitleElement,
  ke as Transform,
  n1 as Translate,
  f1 as UnknownElement,
  F1 as UseElement,
  t1 as ViewPort,
  ht as compressSpaces,
  mt as default,
  e1 as getSelectorSpecificity,
  Hb as normalizeAttributeName,
  Yb as normalizeColor,
  ul as parseExternalUrl,
  J1 as presets,
  ie as toNumbers,
  Ub as trimLeft,
  Gb as trimRight,
...
//# sourceMappingURL=index.es-F9C3fBao.js.map
