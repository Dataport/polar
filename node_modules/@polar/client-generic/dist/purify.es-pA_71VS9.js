...
function oe(r, n, o) {
  return Ht() ? oe = Reflect.construct : oe = function(c, g, y) {
    var N = [null];
    N.push.apply(N, g);
    var F = Function.bind.apply(c, N), $ = new F();
...
var $t = Object.hasOwnProperty, lt = Object.setPrototypeOf, jt = Object.isFrozen, Yt = Object.getPrototypeOf, Vt = Object.getOwnPropertyDescriptor, E = Object.freeze, S = Object.seal, Xt = Object.create, dt = typeof Reflect < "u" && Reflect, se = dt.apply, Fe = dt.construct;
...
var qt = b(Array.prototype.forEach), st = b(Array.prototype.pop), X = b(Array.prototype.push), le = b(String.prototype.toLowerCase), Me = b(String.prototype.toString), ut = b(String.prototype.match), R = b(String.prototype.replace), Kt = b(String.prototype.indexOf), Zt = b(String.prototype.trim), h = b(RegExp.prototype.test), De = Jt(TypeError);
function b(r) {
  return function(n) {
...
function Tt() {
  ...
  if (n.version = "2.4.8", n.removed = [], !r || !r.document || r.document.nodeType !== 9)
    return n.isSupported = !1, n;
  var o = r.document, s = r.document, c = r.DocumentFragment, g = r.HTMLTemplateElement, y = r.Node, N = r.Element, F = r.NodeFilter, $ = r.NamedNodeMap, vt = $ === void 0 ? r.NamedNodeMap || r.MozNamedAttrMap : $, _t = r.HTMLFormElement, ht = r.DOMParser, q = r.trustedTypes, K = N.prototype, Et = ne(K, "cloneNode"), At = ne(K, "nextSibling"), yt = ne(K, "childNodes"), ue = ne(K, "parentNode");
  ...
  })), j = null, _e = null, We = !0, he = !0, Be = !1, $e = !0, U = !1, x = !1, Ee = !1, Ae = !1, H = !1, J = !1, Q = !1, je = !0, Ye = !1, Dt = "user-content-", ye = !0, Y = !1, z = {}, G = null, Ve = l({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]), Xe = null, qe = l({}, ["audio", "video", "img", "source", "image", "track"]), ge = null, Ke = l({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), ee = "http://www.w3.org/1998/Math/MathML", te = "http://www.w3.org/2000/svg", D = "http://www.w3.org/1999/xhtml", W = D, Se = !1, be = null, wt = l({}, [ee, te, D], Me), k, Ct = ["application/xhtml+xml", "text/html"], It = "text/html", d, B = null, xt = s.createElement("form"), Ze = function(e) {
    return e instanceof RegExp || e instanceof Function;
  }, Oe = function(e) {
    B && B === e || ((!e || I(e) !== "object") && (e = {}), e = P(e), k = // eslint-disable-next-line unicorn/prefer-includes
    Ct.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? k = It : k = e.PARSER_MEDIA_TYPE, d = k === "application/xhtml+xml" ? Me : le, m = "ALLOWED_TAGS" in e ? l({}, e.ALLOWED_TAGS, d) : ze, p = "ALLOWED_ATTR" in e ? l({}, e.ALLOWED_ATTR, d) : Ge, be = "ALLOWED_NAMESPACES" in e ? l({}, e.ALLOWED_NAMESPACES, Me) : wt, ge = "ADD_URI_SAFE_ATTR" in e ? l(
      P(Ke),
      ...
      d
      // eslint-disable-line indent
    ) : qe, G = "FORBID_CONTENTS" in e ? l({}, e.FORBID_CONTENTS, d) : Ve, j = "FORBID_TAGS" in e ? l({}, e.FORBID_TAGS, d) : {}, _e = "FORBID_ATTR" in e ? l({}, e.FORBID_ATTR, d) : {}, z = "USE_PROFILES" in e ? e.USE_PROFILES : !1, We = e.ALLOW_ARIA_ATTR !== !1, he = e.ALLOW_DATA_ATTR !== !1, Be = e.ALLOW_UNKNOWN_PROTOCOLS || !1, $e = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1, U = e.SAFE_FOR_TEMPLATES || !1, x = e.WHOLE_DOCUMENT || !1, H = e.RETURN_DOM || !1, J = e.RETURN_DOM_FRAGMENT || !1, Q = e.RETURN_TRUSTED_TYPE || !1, Ae = e.FORCE_BODY || !1, je = e.SANITIZE_DOM !== !1, Ye = e.SANITIZE_NAMED_PROPS || !1, ye = e.KEEP_CONTENT !== !1, Y = e.IN_PLACE || !1, ve = e.ALLOWED_URI_REGEXP || ve, W = e.NAMESPACE || D, f = e.CUSTOM_ELEMENT_HANDLING || {}, e.CUSTOM_ELEMENT_HANDLING && Ze(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (f.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck), e.CUSTOM_ELEMENT_HANDLING && Ze(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (f.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), e.CUSTOM_ELEMENT_HANDLING && typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (f.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), U && (he = !1), J && (H = !0), z && (m = l({}, L(ct)), p = [], z.html === !0 && (l(m, ft), l(p, mt)), z.svg === !0 && (l(m, we), l(p, xe), l(p, ie)), z.svgFilters === !0 && (l(m, Ce), l(p, xe), l(p, ie)), z.mathMl === !0 && (l(m, Ie), l(p, pt), l(p, ie))), e.ADD_TAGS && (m === ze && (m = P(m)), l(m, e.ADD_TAGS, d)), e.ADD_ATTR && (p === Ge && (p = P(p)), l(p, e.ADD_ATTR, d)), e.ADD_URI_SAFE_ATTR && l(ge, e.ADD_URI_SAFE_ATTR, d), e.FORBID_CONTENTS && (G === Ve && (G = P(G)), l(G, e.FORBID_CONTENTS, d)), ye && (m["#text"] = !0), x && l(m, ["html", "head", "body"]), m.table && (l(m, ["tbody"]), delete j.tbody), E && E(e), B = e);
  ...
  var Pt = function(e) {
    ...
    return be[e.namespaceURI] ? e.namespaceURI === te ? t.namespaceURI === D ? a === "svg" : t.namespaceURI === ee ? a === "svg" && (u === "annotation-xml" || Je[u]) : !!re[a] : e.namespaceURI === ee ? t.namespaceURI === D ? a === "math" : t.namespaceURI === te ? a === "math" && Qe[u] : !!Re[a] : e.namespaceURI === D ? t.namespaceURI === te && !Qe[u] || t.namespaceURI === ee && !Je[u] ? !1 : !Re[a] && (kt[a] || !re[a]) : !!(k === "application/xhtml+xml" && be[e.namespaceURI]) : !1;
  }, w = function(e) {
    X(n.removed, {
      element: e
    });
    ...
    k === "application/xhtml+xml" && W === D && (e = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + e + "</body></html>");
    var A = O ? O.createHTML(e) : e;
    if (W === D)
      try {
        t = new ht().parseFromString(A, k);
      } catch {
      }
    ...
    return e && a && _.insertBefore(s.createTextNode(a), _.childNodes[0] || null), W === D ? bt.call(t, x ? "html" : "body")[0] : x ? t.documentElement : _;
  }, tt = function(e) {
    return gt.call(
      e.ownerDocument || e,
      e,
      // eslint-disable-next-line no-bitwise
      F.SHOW_ELEMENT | F.SHOW_COMMENT | F.SHOW_TEXT | F.SHOW_PROCESSING_INSTRUCTION,
      null,
      !1
    );
  }, Ft = function(e) {
    ...
    if (C("uponSanitizeElement", e, {
      tagName: a,
      allowedTags: m
    }), e.hasChildNodes() && !V(e.firstElementChild) && (!V(e.content) || !V(e.content.firstElementChild)) && h(/<[/\w]/g, e.innerHTML) && h(/<[/\w]/g, e.textContent) || a === "select" && h(/<template/i, e.innerHTML))
      return w(e), !0;
    if (!m[a] || j[a]) {
    ...
    return e instanceof N && !Pt(e) || (a === "noscript" || a === "noembed" || a === "noframes") && h(/<\/no(script|embed|frames)/i, e.innerHTML) ? (w(e), !0) : (U && e.nodeType === 3 && (t = e.textContent, t = R(t, pe, " "), t = R(t, de, " "), t = R(t, Te, " "), e.textContent !== t && (X(n.removed, {
      element: e.cloneNode()
  ...
  return n.sanitize = function(i) {
    ...
    if (Ee || Oe(e), n.removed = [], typeof i == "string" && (Y = !1), Y) {
      ...
      if (!H && !U && !x && // eslint-disable-next-line unicorn/prefer-includes
      i.indexOf("<") === -1)
    ...
    return x && m["!doctype"] && t.ownerDocument && t.ownerDocument.doctype && t.ownerDocument.doctype.name && h(ur, t.ownerDocument.doctype.name) && (T = "<!DOCTYPE " + t.ownerDocument.doctype.name + `>
...
//# sourceMappingURL=purify.es-pA_71VS9.js.map
