import { c as Ke, _ as pl, g as $o } from "./polar-client-hmrSMhF9.js";
var vt = function(a) {
...
}), bl = pr, jt = Function.prototype.call, Y = bl ? jt.bind(jt) : function() {
  return jt.apply(jt, arguments);
}, wo = {}, Co = {}.propertyIsEnumerable, Ao = Object.getOwnPropertyDescriptor, xl = Ao && !Co.call({ 1: 2 }, 1);
wo.f = xl ? function(e) {
  var t = Ao(this, e);
...
}, Po = pr, Ro = Function.prototype, Ua = Ro.call, Ol = Po && Ro.bind.bind(Ua, Ua), k = Po ? Ol : function(a) {
  return function() {
    return Ua.apply(a, arguments);
  };
}, No = k, Tl = No({}.toString), Sl = No("".slice), Be = function(a) {
  return Sl(Tl(a), 8, -1);
}, El = k, $l = L, wl = Be, Wr = Object, Cl = El("".split), Io = $l(function() {
  return !Wr("z").propertyIsEnumerable(0);
}) ? function(a) {
  return wl(a) === "String" ? Cl(a, "") : Wr(a);
} : Wr, Fe = function(a) {
  return a == null;
}, Al = Fe, Pl = TypeError, ge = function(a) {
  if (Al(a))
    throw new Pl("Can't call method on " + a);
  return a;
}, Rl = Io, Nl = ge, $t = function(a) {
  return Rl(Nl(a));
...
}, Qr = D, Ml = B, _l = function(a) {
  return Ml(a) ? a : void 0;
}, je = function(a, e) {
  return arguments.length < 2 ? _l(Qr[a]) : Qr[a] && Qr[a][e];
}, Vl = k, yr = Vl({}.isPrototypeOf), mr = typeof navigator < "u" && String(navigator.userAgent) || "", Mo = D, Kr = mr, fn = Mo.process, cn = Mo.Deno, gn = fn && fn.versions || cn && cn.version, dn = gn && gn.v8, ue, hr;
dn && (ue = dn.split("."), hr = ue[0] > 0 && ue[0] < 4 ? 1 : +(ue[0] + ue[1]));
!hr && Kr && (ue = Kr.match(/Edge\/(\d+)/), (!ue || ue[1] >= 74) && (ue = Kr.match(/Chrome\/(\d+)/), ue && (hr = +ue[1])));
var bi = hr, pn = bi, Dl = L, Ll = D, kl = Ll.String, _o = !!Object.getOwnPropertySymbols && !Dl(function() {
  ...
  !Symbol.sham && pn && pn < 41;
}), Bl = _o, Vo = Bl && !Symbol.sham && typeof Symbol.iterator == "symbol", Fl = je, jl = B, Ul = yr, Gl = Vo, zl = Object, Do = Gl ? function(a) {
  return typeof a == "symbol";
} : function(a) {
  var e = Fl("Symbol");
  return jl(e) && Ul(e.prototype, zl(a));
}, Hl = String, br = function(a) {
  try {
    return Hl(a);
  } catch {
    return "Object";
  }
}, Yl = B, Xl = br, Wl = TypeError, Oe = function(a) {
  if (Yl(a))
    return a;
  throw new Wl(Xl(a) + " is not a function");
}, ql = Oe, Ql = Fe, ot = function(a, e) {
  var t = a[e];
  return Ql(t) ? void 0 : ql(t);
}, Zr = Y, Jr = B, ea = de, Kl = TypeError, Zl = function(a, e) {
  var t, r;
...
}, Lo = { exports: {} }, yn = D, Jl = Object.defineProperty, xi = function(a, e) {
  try {
    Jl(yn, a, { value: e, configurable: !0, writable: !0 });
  } catch {
    yn[a] = e;
  }
  return e;
}, eh = D, th = xi, mn = "__core-js_shared__", rh = eh[mn] || th(mn, {}), Oi = rh, bn = Oi;
(Lo.exports = function(a, e) {
  return bn[a] || (bn[a] = e !== void 0 ? e : {});
})("versions", []).push({
  version: "3.35.1",
  mode: "global",
...
var Ti = Lo.exports, ah = ge, ih = Object, xr = function(a) {
  return ih(ah(a));
}, nh = k, sh = xr, oh = nh({}.hasOwnProperty), he = Object.hasOwn || function(e, t) {
  return oh(sh(e), t);
}, uh = k, lh = 0, hh = Math.random(), vh = uh(1 .toString), ko = function(a) {
  return "Symbol(" + (a === void 0 ? "" : a) + ")_" + vh(++lh + hh, 36);
}, fh = D, ch = Ti, xn = he, gh = ko, dh = _o, ph = Vo, Ze = fh.Symbol, ta = ch("wks"), yh = ph ? Ze.for || Ze : Ze && Ze.withoutSetter || gh, z = function(a) {
  return xn(ta, a) || (ta[a] = dh && xn(Ze, a) ? Ze[a] : yh("Symbol." + a)), ta[a];
}, mh = Y, On = de, Tn = Do, bh = ot, xh = Zl, Oh = z, Th = TypeError, Sh = Oh("toPrimitive"), Eh = function(a, e) {
  if (!On(a) || Tn(a))
    return a;
  var t = bh(a, Sh), r;
  if (t) {
    if (e === void 0 && (e = "default"), r = mh(t, a, e), !On(r) || Tn(r))
      return r;
    throw new Th("Can't convert object to primitive value");
  }
  return e === void 0 && (e = "number"), xh(a, e);
}, $h = Eh, wh = Do, Bo = function(a) {
  var e = $h(a, "string");
  return wh(e) ? e : e + "";
}, Ch = D, Sn = de, Ga = Ch.document, Ah = Sn(Ga) && Sn(Ga.createElement), Or = function(a) {
  return Ah ? Ga.createElement(a) : {};
}, Ph = le, Rh = L, Nh = Or, Fo = !Ph && !Rh(function() {
  return Object.defineProperty(Nh("div"), "a", {
    get: function() {
      return 7;
    }
  }).a !== 7;
}), Ih = le, Mh = Y, _h = wo, Vh = mi, Dh = $t, Lh = Bo, kh = he, Bh = Fo, En = Object.getOwnPropertyDescriptor;
Et.f = Ih ? En : function(e, t) {
  if (e = Dh(e), t = Lh(t), Bh)
    try {
      return En(e, t);
    } catch {
  ...
  if (kh(e, t))
    return Vh(!Mh(_h.f, e, t), e[t]);
};
var Te = {}, Fh = le, jh = L, jo = Fh && jh(function() {
  return Object.defineProperty(function() {
  }, "prototype", {
    value: 42,
    writable: !1
  }).prototype !== 42;
}), Uh = de, Gh = String, zh = TypeError, K = function(a) {
  if (Uh(a))
    return a;
  throw new zh(Gh(a) + " is not an object");
}, Hh = le, Yh = Fo, Xh = jo, Ut = K, $n = Bo, Wh = TypeError, ra = Object.defineProperty, qh = Object.getOwnPropertyDescriptor, aa = "enumerable", ia = "configurable", na = "writable";
Te.f = Hh ? Xh ? function(e, t, r) {
  if (Ut(e), t = $n(t), Ut(r), typeof e == "function" && t === "prototype" && "value" in r && na in r && !r[na]) {
    var i = qh(e, t);
  ...
  if (Ut(e), t = $n(t), Ut(r), Yh)
    try {
      return ra(e, t, r);
    } catch {
    }
  if ("get" in r || "set" in r)
    throw new Wh("Accessors not supported");
  return "value" in r && (e[t] = r.value), e;
};
var Qh = le, Kh = Te, Zh = mi, wt = Qh ? function(a, e, t) {
  return Kh.f(a, e, Zh(1, t));
} : function(a, e, t) {
  return a[e] = t, a;
}, Uo = { exports: {} }, za = le, Jh = he, Go = Function.prototype, ev = za && Object.getOwnPropertyDescriptor, Si = Jh(Go, "name"), tv = Si && (function() {
}).name === "something", rv = Si && (!za || za && ev(Go, "name").configurable), Tr = {
  EXISTS: Si,
  PROPER: tv,
  CONFIGURABLE: rv
}, av = k, iv = B, Ha = Oi, nv = av(Function.toString);
iv(Ha.inspectSource) || (Ha.inspectSource = function(a) {
  return nv(a);
});
var Ei = Ha.inspectSource, sv = D, ov = B, wn = sv.WeakMap, uv = ov(wn) && /native code/.test(String(wn)), lv = Ti, hv = ko, Cn = lv("keys"), $i = function(a) {
  return Cn[a] || (Cn[a] = hv(a));
}, wi = {}, vv = uv, zo = D, fv = de, cv = wt, sa = he, oa = Oi, gv = $i, dv = wi, An = "Object already initialized", Ya = zo.TypeError, pv = zo.WeakMap, vr, Ot, fr, yv = function(a) {
  return fr(a) ? Ot(a) : vr(a, {});
}, mv = function(a) {
  return function(e) {
    var t;
    if (!fv(e) || (t = Ot(e)).type !== a)
      throw new Ya("Incompatible receiver, " + a + " required");
    return t;
  };
};
if (vv || oa.state) {
  var ce = oa.state || (oa.state = new pv());
  ce.get = ce.get, ce.has = ce.has, ce.set = ce.set, vr = function(a, e) {
    if (ce.has(a))
      throw new Ya(An);
...
var Sr = {
  ...
  enforce: yv,
  getterFor: mv
}, Ci = k, bv = L, xv = B, Gt = he, Xa = le, Ov = Tr.CONFIGURABLE, Tv = Ei, Ho = Sr, Sv = Ho.enforce, Ev = Ho.get, Pn = String, ir = Object.defineProperty, $v = Ci("".slice), wv = Ci("".replace), Cv = Ci([].join), Av = Xa && !bv(function() {
  return ir(function() {
  }, "length", { value: 8 }).length !== 8;
}), Pv = String(String).split("String"), Rv = Uo.exports = function(a, e, t) {
  $v(Pn(e), 0, 7) === "Symbol(" && (e = "[" + wv(Pn(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), t && t.getter && (e = "get " + e), t && t.setter && (e = "set " + e), (!Gt(a, "name") || Ov && a.name !== e) && (Xa ? ir(a, "name", { value: e, configurable: !0 }) : a.name = e), Av && t && Gt(t, "arity") && a.length !== t.arity && ir(a, "length", { value: t.arity });
  try {
    t && Gt(t, "constructor") && t.constructor ? Xa && ir(a, "prototype", { writable: !1 }) : a.prototype && (a.prototype = void 0);
  } catch {
  }
  var r = Sv(a);
...
var Yo = Uo.exports, Nv = B, Iv = Te, Mv = Yo, _v = xi, Ue = function(a, e, t, r) {
  r || (r = {});
  var i = r.enumerable, n = r.name !== void 0 ? r.name : e;
  if (Nv(t) && Mv(t, n, r), r.global)
    i ? a[e] = t : _v(e, t);
  else {
    try {
  ...
  return a;
}, Xo = {}, Vv = Math.ceil, Dv = Math.floor, Lv = Math.trunc || function(e) {
  var t = +e;
  return (t > 0 ? Dv : Vv)(t);
}, kv = Lv, Er = function(a) {
  var e = +a;
  return e !== e || e === 0 ? 0 : kv(e);
}, Bv = Er, Fv = Math.max, jv = Math.min, Uv = function(a, e) {
  var t = Bv(a);
  return t < 0 ? Fv(t + e, 0) : jv(t, e);
}, Gv = Er, zv = Math.min, ut = function(a) {
  var e = Gv(a);
  return e > 0 ? zv(e, 9007199254740991) : 0;
}, Hv = ut, Ai = function(a) {
  return Hv(a.length);
}, Yv = $t, Xv = Uv, Wv = Ai, Rn = function(a) {
  return function(e, t, r) {
    var i = Yv(e), n = Wv(i), o = Xv(r, n), s;
    if (a && t !== t) {
      for (; n > o; )
        if (s = i[o++], s !== s)
          return !0;
  ...
  indexOf: Rn(!1)
}, qv = k, ua = he, Qv = $t, Kv = Wo.indexOf, Zv = wi, Nn = qv([].push), qo = function(a, e) {
  var t = Qv(a), r = 0, i = [], n;
  for (n in t)
    !ua(Zv, n) && ua(t, n) && Nn(i, n);
  for (; e.length > r; )
    ua(t, n = e[r++]) && (~Kv(i, n) || Nn(i, n));
  return i;
}, Pi = [
  "constructor",
  "hasOwnProperty",
  ...
  "toString",
  "valueOf"
], Jv = qo, ef = Pi, tf = ef.concat("length", "prototype");
Xo.f = Object.getOwnPropertyNames || function(e) {
  return Jv(e, tf);
};
var Qo = {};
Qo.f = Object.getOwnPropertySymbols;
var rf = je, af = k, nf = Xo, sf = Qo, of = K, uf = af([].concat), lf = rf("Reflect", "ownKeys") || function(e) {
  var t = nf.f(of(e)), r = sf.f;
  return r ? uf(t, r(e)) : t;
}, In = he, hf = lf, vf = Et, ff = Te, cf = function(a, e, t) {
  for (var r = hf(e), i = ff.f, n = vf.f, o = 0; o < r.length; o++) {
    var s = r[o];
    !In(a, s) && !(t && In(t, s)) && i(a, s, n(e, s));
  }
}, gf = L, df = B, pf = /#|\.prototype\./, Ct = function(a, e) {
  var t = mf[yf(a)];
  return t === xf ? !0 : t === bf ? !1 : df(e) ? gf(e) : !!e;
}, yf = Ct.normalize = function(a) {
  return String(a).replace(pf, ".").toLowerCase();
}, mf = Ct.data = {}, bf = Ct.NATIVE = "N", xf = Ct.POLYFILL = "P", Ko = Ct, zt = D, Of = Et.f, Tf = wt, Sf = Ue, Ef = xi, $f = cf, wf = Ko, ee = function(a, e) {
  var t = a.target, r = a.global, i = a.stat, n, o, s, u, l, h;
  if (r ? o = zt : i ? o = zt[t] || Ef(t, {}) : o = zt[t] && zt[t].prototype, o)
    for (s in e) {
      if (l = e[s], a.dontCallGetSet ? (h = Of(o, s), u = h && h.value) : u = o[s], n = wf(r ? s : t + (i ? "." : "#") + s, a.forced), !n && u !== void 0) {
...
}, Cf = D, Af = Be, At = Af(Cf.process) === "process", Pf = k, Rf = Oe, Nf = function(a, e, t) {
  try {
  ...
  return If(a) || a === null;
}, _f = Mf, Vf = String, Df = TypeError, Lf = function(a) {
  if (_f(a))
    return a;
  throw new Df("Can't set " + Vf(a) + " as a prototype");
}, kf = Nf, Bf = K, Ff = Lf, Zo = Object.setPrototypeOf || ("__proto__" in {} ? function() {
  var a = !1, e = {}, t;
  try {
...
}() : void 0), jf = Te.f, Uf = he, Gf = z, Mn = Gf("toStringTag"), $r = function(a, e, t) {
  a && !t && (a = a.prototype), a && !Uf(a, Mn) && jf(a, Mn, { configurable: !0, value: e });
}, _n = Yo, zf = Te, Hf = function(a, e, t) {
  return t.get && _n(t.get, e, { getter: !0 }), t.set && _n(t.set, e, { setter: !0 }), zf.f(a, e, t);
}, Yf = je, Xf = Hf, Wf = z, qf = le, Vn = Wf("species"), Qf = function(a) {
  var e = Yf(a);
  qf && e && !e[Vn] && Xf(e, Vn, {
    configurable: !0,
    get: function() {
...
}, Kf = yr, Zf = TypeError, Jf = function(a, e) {
  if (Kf(e, a))
    return a;
  throw new Zf("Incorrect invocation");
}, ec = z, tc = ec("toStringTag"), Jo = {};
Jo[tc] = "z";
var rc = String(Jo) === "[object z]", ac = rc, ic = B, nr = Be, nc = z, sc = nc("toStringTag"), oc = Object, uc = nr(/* @__PURE__ */ function() {
  return arguments;
  ...
  var e, t, r;
  return a === void 0 ? "Undefined" : a === null ? "Null" : typeof (t = lc(e = oc(a), sc)) == "string" ? t : uc ? nr(e) : (r = nr(e)) === "Object" && ic(e.callee) ? "Arguments" : r;
}, hc = k, vc = L, eu = B, fc = Ri, cc = je, gc = Ei, tu = function() {
}, ru = cc("Reflect", "construct"), Ni = /^\s*(?:class|function)\b/, dc = hc(Ni.exec), pc = !Ni.test(tu), ft = function(e) {
  if (!eu(e))
    return !1;
  try {
    return ru(tu, [], e), !0;
  ...
  try {
    return pc || !!dc(Ni, gc(e));
  } catch {
    return !0;
  }
};
au.sham = !0;
var yc = !ru || vc(function() {
  var a;
  return ft(ft.call) || !ft(Object) || !ft(function() {
    a = !0;
  }) || a;
}) ? au : ft, mc = yc, bc = br, xc = TypeError, Oc = function(a) {
  if (mc(a))
    return a;
  throw new xc(bc(a) + " is not a constructor");
}, Dn = K, Tc = Oc, Sc = Fe, Ec = z, $c = Ec("species"), iu = function(a, e) {
  var t = Dn(a).constructor, r;
  return t === void 0 || Sc(r = Dn(t)[$c]) ? e : Tc(r);
}, wc = pr, nu = Function.prototype, Ln = nu.apply, kn = nu.call, su = typeof Reflect == "object" && Reflect.apply || (wc ? kn.bind(Ln) : function() {
  return kn.apply(Ln, arguments);
}), Cc = Be, Ac = k, wr = function(a) {
  if (Cc(a) === "Function")
    return Ac(a);
}, Bn = wr, Pc = Oe, Rc = pr, Nc = Bn(Bn.bind), Ii = function(a, e) {
  return Pc(a), e === void 0 ? a : Rc ? Nc(a, e) : function() {
    return a.apply(e, arguments);
  };
}, Ic = je, ou = Ic("document", "documentElement"), Mc = k, _c = Mc([].slice), Vc = TypeError, Dc = function(a, e) {
  if (a < e)
    throw new Vc("Not enough arguments");
  return a;
}, Lc = mr, uu = /(?:ipad|iphone|ipod).*applewebkit/i.test(Lc), ae = D, kc = su, Bc = Ii, Fn = B, Fc = he, lu = L, jn = ou, jc = _c, Un = Or, Uc = Dc, Gc = uu, zc = At, Wa = ae.setImmediate, qa = ae.clearImmediate, Hc = ae.process, la = ae.Dispatch, Yc = ae.Function, Gn = ae.MessageChannel, Xc = ae.String, ha = 0, bt = {}, zn = "onreadystatechange", Tt, Ie, va, fa;
lu(function() {
  Tt = ae.location;
});
var Mi = function(a) {
...
(!Wa || !qa) && (Wa = function(e) {
  ...
  var t = Fn(e) ? e : Yc(e), r = jc(arguments, 1);
  ...
  la.now(ca(a));
} : Gn && !Gc ? (va = new Gn(), fa = va.port2, va.port1.onmessage = Hn, Ie = Bc(fa.postMessage, fa)) : ae.addEventListener && Fn(ae.postMessage) && !ae.importScripts && Tt && Tt.protocol !== "file:" && !lu(Yn) ? (Ie = Yn, ae.addEventListener("message", Hn, !1)) : zn in Un("script") ? Ie = function(a) {
  jn.appendChild(Un("script"))[zn] = function() {
    jn.removeChild(this), Mi(a);
  };
} : Ie = function(a) {
  setTimeout(ca(a), 0);
});
var hu = {
  set: Wa,
  clear: qa
}, Xn = D, Wc = le, qc = Object.getOwnPropertyDescriptor, Qc = function(a) {
  if (!Wc)
    return Xn[a];
  var e = qc(Xn, a);
  return e && e.value;
...
var fu = vu, Kc = mr, Zc = /ipad|iphone|ipod/i.test(Kc) && typeof Pebble < "u", Jc = mr, eg = /web0s(?!.*chrome)/i.test(Jc), it = D, tg = Qc, Wn = Ii, ga = hu.set, rg = fu, ag = uu, ig = Zc, ng = eg, da = At, qn = it.MutationObserver || it.WebKitMutationObserver, Qn = it.document, Kn = it.process, Ht = it.Promise, Qa = tg("queueMicrotask"), Xe, pa, ya, Yt, Zn;
if (!Qa) {
  var Xt = new rg(), Wt = function() {
    var a, e;
    for (da && (a = Kn.domain) && a.exit(); e = Xt.get(); )
      try {
        e();
      } catch (t) {
        throw Xt.head && Xe(), t;
  ...
  !ag && !da && !ng && qn && Qn ? (pa = !0, ya = Qn.createTextNode(""), new qn(Wt).observe(ya, { characterData: !0 }), Xe = function() {
    ya.data = pa = !pa;
  }) : !ig && Ht && Ht.resolve ? (Yt = Ht.resolve(void 0), Yt.constructor = Ht, Zn = Wn(Yt.then, Yt), Xe = function() {
    Zn(Wt);
  }) : da ? Xe = function() {
    Kn.nextTick(Wt);
  } : (ga = Wn(ga, it), Xe = function() {
    ga(Wt);
  }), Qa = function(a) {
    Xt.head || Xe(), Xt.add(a);
  };
}
var sg = Qa, og = function(a, e) {
  try {
...
}, ug = D, Cr = ug.Promise, cu = typeof Deno == "object" && Deno && typeof Deno.version == "object", lg = cu, hg = At, vg = !lg && !hg && typeof window == "object" && typeof document == "object", fg = D, xt = Cr, cg = B, gg = Ko, dg = Ei, pg = z, yg = vg, mg = cu, ma = bi;
xt && xt.prototype;
var bg = pg("species"), Ka = !1, gu = cg(fg.PromiseRejectionEvent), xg = gg("Promise", function() {
  var a = dg(xt), e = a !== String(xt);
  if (!e && ma === 66)
    return !0;
  ...
  REJECTION_EVENT: gu,
  SUBCLASSING: Ka
}, lt = {}, Jn = Oe, Og = TypeError, Tg = function(a) {
  var e, t;
  this.promise = new a(function(r, i) {
    if (e !== void 0 || t !== void 0)
      throw new Og("Bad Promise constructor");
    e = r, t = i;
  }), this.resolve = Jn(e), this.reject = Jn(t);
};
lt.f = function(a) {
  return new Tg(a);
};
var Sg = ee, cr = At, we = D, nt = Y, es = Ue, ts = Zo, Eg = $r, $g = Qf, wg = Oe, sr = B, Cg = de, Ag = Jf, Pg = iu, du = hu.set, Vi = sg, Rg = og, Ng = _i, Ig = fu, pu = Sr, gr = Cr, Di = Pt, yu = lt, Ar = "Promise", mu = Di.CONSTRUCTOR, Mg = Di.REJECTION_EVENT, _g = Di.SUBCLASSING, ba = pu.getterFor(Ar), Vg = pu.set, Qe = gr && gr.prototype, De = gr, qt = Qe, bu = we.TypeError, Za = we.document, Li = we.process, Ja = yu.f, Dg = Ja, Lg = !!(Za && Za.createEvent && we.dispatchEvent), xu = "unhandledrejection", kg = "rejectionhandled", rs = 0, Ou = 1, Bg = 2, ki = 1, Tu = 2, Qt, as, Fg, is, Su = function(a) {
  var e;
  return Cg(a) && sr(e = a.then) ? e : !1;
}, Eu = function(a, e) {
  var t = e.value, r = e.state === Ou, i = r ? a.ok : a.fail, n = a.resolve, o = a.reject, s = a.domain, u, l, h;
  try {
    i ? (r || (e.rejection === Tu && Ug(e), e.rejection = ki), i === !0 ? u = t : (s && s.enter(), u = i(t), s && (s.exit(), h = !0)), u === a.promise ? o(new bu("Promise-chain cycle")) : (l = Su(u)) ? nt(l, u, n, o) : n(u)) : o(t);
  } catch (f) {
    s && !h && s.exit(), o(f);
  }
}, $u = function(a, e) {
  ...
  var r, i;
  Lg ? (r = Za.createEvent("Event"), r.promise = e, r.reason = t, r.initEvent(a, !1, !0), we.dispatchEvent(r)) : r = { promise: e, reason: t }, !Mg && (i = we["on" + a]) ? i(r) : a === xu && Rg("Unhandled promise rejection", t);
}, jg = function(a) {
  nt(du, we, function() {
    var e = a.facade, t = a.value, r = ns(a), i;
    if (r && (i = Ng(function() {
      cr ? Li.emit("unhandledRejection", t, e) : wu(xu, e, t);
    }), a.rejection = cr || ns(a) ? Tu : ki, i.error))
      throw i.value;
  });
}, ns = function(a) {
  return a.rejection !== ki && !a.parent;
}, Ug = function(a) {
  nt(du, we, function() {
    var e = a.facade;
    cr ? Li.emit("rejectionHandled", e) : wu(kg, e, a.value);
  });
}, Je = function(a, e, t) {
  return function(r) {
    a(e, r, t);
  ...
  a.done || (a.done = !0, t && (a = t), a.value = e, a.state = Bg, $u(a, !0));
}, ei = function(a, e, t) {
  if (!a.done) {
    a.done = !0, t && (a = t);
    try {
      if (a.facade === e)
        throw new bu("Promise can't be resolved itself");
      var r = Su(e);
      r ? Vi(function() {
        var i = { done: !1 };
        try {
...
if (mu && (De = function(e) {
...
}, Qt.prototype = es(qt, "then", function(e, t) {
  var r = ba(this), i = Ja(Pg(this, De));
  return r.parent = !0, i.ok = sr(e) ? e : !0, i.fail = sr(t) && t, i.domain = cr ? Li.domain : void 0, r.state === rs ? r.reactions.add(i) : Vi(function() {
    Eu(i, r);
  }), i.promise;
}), as = function() {
  var a = new Qt(), e = ba(a);
  ...
  return a === De || a === Fg ? new as(a) : Dg(a);
}, sr(gr) && Qe !== Object.prototype)) {
  is = Qe.then, _g || es(Qe, "then", function(e, t) {
    var r = this;
...
Sg({ global: !0, constructor: !0, wrap: !0, forced: mu }, {
  Promise: De
});
Eg(De, Ar, !1);
$g(Ar);
var Rt = {}, Gg = z, zg = Rt, Hg = Gg("iterator"), Yg = Array.prototype, Xg = function(a) {
  return a !== void 0 && (zg.Array === a || Yg[Hg] === a);
}, Wg = Ri, ss = ot, qg = Fe, Qg = Rt, Kg = z, Zg = Kg("iterator"), Cu = function(a) {
  if (!qg(a))
    return ss(a, Zg) || ss(a, "@@iterator") || Qg[Wg(a)];
}, Jg = Y, ed = Oe, td = K, rd = br, ad = Cu, id = TypeError, nd = function(a, e) {
  var t = arguments.length < 2 ? ad(a) : e;
  if (ed(t))
    return td(Jg(t, a));
  throw new id(rd(a) + " is not iterable");
}, sd = Y, os = K, od = ot, ud = function(a, e, t) {
  var r, i;
  os(a);
  try {
    if (r = od(a, "return"), !r) {
  ...
  if (i)
    throw r;
  return os(r), t;
}, ld = Ii, hd = Y, vd = K, fd = br, cd = Xg, gd = Ai, us = yr, dd = nd, pd = Cu, ls = ud, yd = TypeError, or = function(a, e) {
  this.stopped = a, this.result = e;
}, hs = or.prototype, Au = function(a, e, t) {
  var r = t && t.that, i = !!(t && t.AS_ENTRIES), n = !!(t && t.IS_RECORD), o = !!(t && t.IS_ITERATOR), s = !!(t && t.INTERRUPTED), u = ld(e, r), l, h, f, c, v, d, g, p = function(x) {
    return l && ls(l, "normal", x), new or(!0, x);
  }, y = function(x) {
  ...
  if (n)
    ...
    if (h = pd(a), !h)
      throw new yd(fd(a) + " is not iterable");
    if (cd(h)) {
      for (f = 0, c = gd(a); c > f; f++)
        if (v = y(a[f]), v && us(hs, v))
          return v;
      return new or(!1);
    }
    l = dd(a, h);
  ...
  for (d = n ? a.next : l.next; !(g = hd(d, l)).done; ) {
    ...
    if (typeof v == "object" && v && us(hs, v))
      return v;
  }
  return new or(!1);
}, md = z, Pu = md("iterator"), Ru = !1;
try {
  var bd = 0, vs = {
    next: function() {
      return { done: !!bd++ };
...
var xd = function(a, e) {
  ...
  return t;
}, Od = Cr, Td = xd, Sd = Pt.CONSTRUCTOR, Nu = Sd || !Td(function(a) {
  Od.all(a).then(void 0, function() {
  });
}), Ed = ee, $d = Y, wd = Oe, Cd = lt, Ad = _i, Pd = Au, Rd = Nu;
Ed({ target: "Promise", stat: !0, forced: Rd }, {
  all: function(e) {
    var t = this, r = Cd.f(t), i = r.resolve, n = r.reject, o = Ad(function() {
      var s = wd(t.resolve), u = [], l = 0, h = 1;
      Pd(e, function(f) {
        var c = l++, v = !1;
        h++, $d(s, t, f).then(function(d) {
          v || (v = !0, u[c] = d, --h || i(u));
        }, n);
      }), --h || i(u);
    });
...
var Nd = ee, Id = Pt.CONSTRUCTOR, ti = Cr, Md = je, _d = B, Vd = Ue, fs = ti && ti.prototype;
Nd({ target: "Promise", proto: !0, forced: Id, real: !0 }, {
  catch: function(a) {
    return this.then(void 0, a);
  }
});
if (_d(ti)) {
  var cs = Md("Promise").prototype.catch;
  fs.catch !== cs && Vd(fs, "catch", cs, { unsafe: !0 });
}
var Dd = ee, Ld = Y, kd = Oe, Bd = lt, Fd = _i, jd = Au, Ud = Nu;
Dd({ target: "Promise", stat: !0, forced: Ud }, {
  race: function(e) {
    var t = this, r = Bd.f(t), i = r.reject, n = Fd(function() {
      var o = kd(t.resolve);
      jd(e, function(s) {
...
var Gd = ee, zd = lt, Hd = Pt.CONSTRUCTOR;
Gd({ target: "Promise", stat: !0, forced: Hd }, {
  reject: function(e) {
    var t = zd.f(this), r = t.reject;
    return r(e), t.promise;
  }
});
var Yd = K, Xd = de, Wd = lt, qd = function(a, e) {
  if (Yd(a), Xd(e) && e.constructor === a)
    return e;
  var t = Wd.f(a), r = t.resolve;
  return r(e), t.promise;
}, Qd = ee, Kd = je, Zd = Pt.CONSTRUCTOR, Jd = qd;
Kd("Promise");
...
function xe(a) {
  return function() {
    ...
    return new Promise(function(r, i) {
      ...
      function s(u) {
        gs(n, r, i, o, s, "throw", u);
      }
      o(void 0);
    });
  };
}
var ep = Ri, tp = String, pe = function(a) {
  if (ep(a) === "Symbol")
...
}, Bi = L, ap = D, Fi = ap.RegExp, ji = Bi(function() {
  var a = Fi("a", "y");
  ...
  MISSED_STICKY: ip,
  UNSUPPORTED_Y: ji
}, _u = {}, sp = qo, op = Pi, up = Object.keys || function(e) {
  return sp(e, op);
}, lp = le, hp = jo, vp = Te, fp = K, cp = $t, gp = up;
_u.f = lp && !hp ? Object.defineProperties : function(e, t) {
  fp(e);
  for (var r = cp(t), i = gp(t), n = i.length, o = 0, s; n > o; )
    vp.f(e, s = i[o++], r[s]);
  return e;
};
var dp = K, pp = _u, ds = Pi, yp = wi, mp = ou, bp = Or, xp = $i, ps = ">", ys = "<", ri = "prototype", ai = "script", Vu = xp("IE_PROTO"), xa = function() {
}, Du = function(a) {
  return ys + ai + ps + a + ys + "/" + ai + ps;
}, ms = function(a) {
  a.write(Du("")), a.close();
  ...
  return a.style.display = "none", mp.appendChild(a), a.src = String(e), t = a.contentWindow.document, t.open(), t.write(Du("document.F=Object")), t.close(), t.F;
}, Kt, ur = function() {
  try {
    Kt = new ActiveXObject("htmlfile");
  } catch {
  }
  ur = typeof document < "u" ? document.domain && Kt ? ms(Kt) : Op() : ms(Kt);
  for (var a = ds.length; a--; )
    delete ur[ri][ds[a]];
  return ur();
};
yp[Vu] = !0;
var Ui = Object.create || function(e, t) {
  var r;
  return e !== null ? (xa[ri] = dp(e), r = new xa(), xa[ri] = null, r[Vu] = e) : r = ur(), t === void 0 ? r : pp.f(r, t);
}, Tp = L, Sp = D, Ep = Sp.RegExp, $p = Tp(function() {
  var a = Ep(".", "s");
  return !(a.dotAll && a.test(`
`) && a.flags === "s");
}), wp = L, Cp = D, Ap = Cp.RegExp, Pp = wp(function() {
  var a = Ap("(?<a>b)", "g");
  return a.exec("b").groups.a !== "b" || "b".replace(a, "$<a>c") !== "bc";
}), et = Y, Pr = k, Rp = pe, Np = Iu, Ip = Mu, Mp = Ti, _p = Ui, Vp = Sr.get, Dp = $p, Lp = Pp, kp = Mp("native-string-replace", String.prototype.replace), dr = RegExp.prototype.exec, ii = dr, Bp = Pr("".charAt), Fp = Pr("".indexOf), jp = Pr("".replace), Oa = Pr("".slice), ni = function() {
  var a = /a/, e = /b*/g;
  return et(dr, a, "a"), et(dr, e, "a"), a.lastIndex !== 0 || e.lastIndex !== 0;
}(), Lu = Ip.BROKEN_CARET, si = /()??/.exec("")[1] !== void 0, Up = ni || si || Lu || Dp || Lp;
Up && (ii = function(e) {
  var t = this, r = Vp(t), i = Rp(e), n = r.raw, o, s, u, l, h, f, c;
  if (n)
    return n.lastIndex = t.lastIndex, o = et(ii, n, i), t.lastIndex = n.lastIndex, o;
  var v = r.groups, d = Lu && t.sticky, g = et(Np, t), p = t.source, y = 0, x = i;
  if (d && (g = jp(g, "y", ""), Fp(g, "g") === -1 && (g += "g"), x = Oa(i, t.lastIndex), t.lastIndex > 0 && (!t.multiline || t.multiline && Bp(i, t.lastIndex - 1) !== `
`) && (p = "(?: " + p + ")", x = " " + x, y++), s = new RegExp("^(?:" + p + ")", g)), si && (s = new RegExp("^" + p + "$(?!\\s)", g)), ni && (u = t.lastIndex), l = et(dr, d ? s : t, x), d ? l ? (l.input = Oa(l.input, y), l[0] = Oa(l[0], y), l.index = t.lastIndex, t.lastIndex += l[0].length) : t.lastIndex = 0 : ni && l && (t.lastIndex = t.global ? l.index + l[0].length : u), si && l && l.length > 1 && et(kp, l[0], s, function() {
...
var Gi = ii, Gp = ee, bs = Gi;
Gp({ target: "RegExp", proto: !0, forced: /./.exec !== bs }, {
  exec: bs
});
var xs = Y, Os = Ue, zp = Gi, Ts = L, ku = z, Hp = wt, Yp = ku("species"), Ta = RegExp.prototype, zi = function(a, e, t, r) {
  var i = ku(a), n = !Ts(function() {
    var l = {};
    return l[i] = function() {
      return 7;
    }, ""[a](l) !== 7;
  ...
  if (!n || !o || t) {
    var s = /./[i], u = e(i, ""[a], function(l, h, f, c, v) {
      var d = h.exec;
      return d === zp || d === Ta.exec ? n && !v ? { done: !0, value: xs(s, h, f, c) } : { done: !0, value: xs(l, f, h, c) } : { done: !1 };
    });
    Os(String.prototype, a, u[0]), Os(Ta, i, u[1]);
  }
  r && Hp(Ta[i], "sham", !0);
}, Hi = k, Xp = Er, Wp = pe, qp = ge, Qp = Hi("".charAt), Ss = Hi("".charCodeAt), Kp = Hi("".slice), Es = function(a) {
  return function(e, t) {
    var r = Wp(qp(e)), i = Xp(t), n = r.length, o, s;
    return i < 0 || i >= n ? a ? "" : void 0 : (o = Ss(r, i), o < 55296 || o > 56319 || i + 1 === n || (s = Ss(r, i + 1)) < 56320 || s > 57343 ? a ? Qp(r, i) : o : a ? Kp(r, i, i + 2) : (o - 55296 << 10) + (s - 56320) + 65536);
  };
}, Zp = {
  ...
  charAt: Es(!0)
}, Jp = Zp.charAt, Yi = function(a, e, t) {
  return e + (t ? Jp(a, e).length : 1);
}, $s = Y, ey = K, ty = B, ry = Be, ay = Gi, iy = TypeError, Xi = function(a, e) {
  var t = a.exec;
  if (ty(t)) {
    var r = $s(t, a, e);
...
}, ny = Y, sy = zi, oy = K, uy = Fe, ly = ut, Sa = pe, hy = ge, vy = ot, fy = Yi, ws = Xi;
sy("match", function(a, e, t) {
  return [
    // `String.prototype.match` method
    // https://tc39.es/ecma262/#sec-string.prototype.match
    function(i) {
      var n = hy(this), o = uy(i) ? void 0 : vy(i, a);
      return o ? ny(o, i, n) : new RegExp(i)[a](Sa(n));
    },
    // `RegExp.prototype[@@match]` method
    // https://tc39.es/ecma262/#sec-regexp.prototype-@@match
    function(r) {
      var i = oy(this), n = Sa(r), o = t(e, i, n);
      if (o.done)
        return o.value;
      if (!i.global)
        return ws(i, n);
...
var Wi = k, cy = xr, gy = Math.floor, Ea = Wi("".charAt), dy = Wi("".replace), $a = Wi("".slice), py = /\$([$&'`]|\d{1,2}|<[^>]*>)/g, yy = /\$([$&'`]|\d{1,2})/g, my = function(a, e, t, r, i, n) {
  var o = t + a.length, s = r.length, u = yy;
  return i !== void 0 && (i = cy(i), u = py), dy(n, u, function(l, h) {
    var f;
    switch (Ea(h, 0)) {
      case "$":
        return "$";
...
}, by = su, Cs = Y, Rr = k, xy = zi, Oy = L, Ty = K, Sy = B, Ey = Fe, $y = Er, wy = ut, We = pe, Cy = ge, Ay = Yi, Py = ot, Ry = my, Ny = Xi, Iy = z, oi = Iy("replace"), My = Math.max, _y = Math.min, Vy = Rr([].concat), wa = Rr([].push), As = Rr("".indexOf), Ps = Rr("".slice), Dy = function(a) {
...
xy("replace", function(a, e, t) {
  ...
  return [
    ...
    function(n, o) {
      var s = Cy(this), u = Ey(n) ? void 0 : Py(n, oi);
      return u ? Cs(u, n, s, o) : Cs(e, We(s), n, o);
    },
    // `RegExp.prototype[@@replace]` method
    // https://tc39.es/ecma262/#sec-regexp.prototype-@@replace
    function(i, n) {
      var o = Ty(this), s = We(i);
      if (typeof n == "string" && As(n, r) === -1 && As(n, "$<") === -1) {
        var u = t(e, o, s, n);
        if (u.done)
          return u.value;
      }
      ...
      for (var g = "", p = 0, y = 0; y < c.length; y++) {
        v = c[y];
        for (var x = We(v[0]), b = My(_y($y(v.index), s.length), 0), O = [], $, E = 1; E < v.length; E++)
          wa(O, Dy(v[E]));
        var T = v.groups;
        if (l) {
          var C = Vy([x], O, b, s);
          ...
          $ = Ry(x, s, b, O, T, n);
        b >= p && (g += Ps(s, p, b) + $, p = b + x.length);
      }
      return g + Ps(s, p);
    }
  ];
}, !ky || !Ly || Rs);
var By = de, Fy = Be, jy = z, Uy = jy("match"), Gy = function(a) {
  var e;
  return By(a) && ((e = a[Uy]) !== void 0 ? !!e : Fy(a) === "RegExp");
}, zy = Gy, Hy = TypeError, qi = function(a) {
  if (zy(a))
    throw new Hy("The method doesn't accept regular expressions");
  return a;
}, Yy = z, Xy = Yy("match"), Qi = function(a) {
  var e = /./;
  try {
    "/./"[a](e);
  } catch {
  ...
  return !1;
}, Wy = ee, qy = wr, Qy = Et.f, Ky = ut, Ns = pe, Zy = qi, Jy = ge, em = Qi, tm = qy("".slice), rm = Math.min, Bu = em("startsWith"), am = !Bu && !!function() {
  var a = Qy(String.prototype, "startsWith");
  return a && !a.writable;
}();
Wy({ target: "String", proto: !0, forced: !am && !Bu }, {
  startsWith: function(e) {
    var t = Ns(Jy(this));
    Zy(e);
    var r = Ky(rm(arguments.length > 1 ? arguments[1] : void 0, t.length)), i = Ns(e);
    return tm(t, r, r + i.length) === i;
  }
});
var im = z, nm = Ui, sm = Te.f, ui = im("unscopables"), li = Array.prototype;
li[ui] === void 0 && sm(li, ui, {
  configurable: !0,
  value: nm(null)
});
var om = function(a) {
...
}), hm = he, vm = B, fm = xr, cm = $i, gm = lm, Is = cm("IE_PROTO"), hi = Object, dm = hi.prototype, Fu = gm ? hi.getPrototypeOf : function(a) {
  var e = fm(a);
  if (hm(e, Is))
    return e[Is];
  var t = e.constructor;
  return vm(t) && e instanceof t ? t.prototype : e instanceof hi ? dm : null;
}, pm = L, ym = B, mm = de, Ms = Fu, bm = Ue, xm = z, vi = xm("iterator"), ju = !1, Le, Ca, Aa;
[].keys && (Aa = [].keys(), "next" in Aa ? (Ca = Ms(Ms(Aa)), Ca !== Object.prototype && (Le = Ca)) : ju = !0);
var Om = !mm(Le) || pm(function() {
  var a = {};
  return Le[vi].call(a) !== a;
});
Om && (Le = {});
ym(Le[vi]) || bm(Le, vi, function() {
  return this;
});
var Uu = {
  IteratorPrototype: Le,
  BUGGY_SAFARI_ITERATORS: ju
}, Tm = Uu.IteratorPrototype, Sm = Ui, Em = mi, $m = $r, wm = Rt, Cm = function() {
  return this;
}, Am = function(a, e, t, r) {
  var i = e + " Iterator";
  return a.prototype = Sm(Tm, { next: Em(+!r, t) }), $m(a, i, !1), wm[i] = Cm, a;
}, Pm = ee, Rm = Y, Gu = Tr, Nm = B, Im = Am, _s = Fu, Vs = Zo, Mm = $r, _m = wt, Pa = Ue, Vm = z, Dm = Rt, zu = Uu, Lm = Gu.PROPER, km = Gu.CONFIGURABLE, Ds = zu.IteratorPrototype, Zt = zu.BUGGY_SAFARI_ITERATORS, ct = Vm("iterator"), Ls = "keys", gt = "values", ks = "entries", Bm = function() {
  return this;
  ...
  if (v && (d = _s(v.call(new a())), d !== Object.prototype && d.next && (_s(d) !== Ds && (Vs ? Vs(d, Ds) : Nm(d[ct]) || Pa(d, ct, Bm)), Mm(d, u, !0))), Lm && i === gt && f && f.name !== gt && (km ? _m(h, "name", gt) : (l = !0, c = function() {
    return Rm(f, this);
  })), i)
    if (g = {
      values: s(gt),
      ...
      Pm({ target: e, proto: !0, forced: Zt || l }, g);
  return h[ct] !== c && Pa(h, ct, c, { name: i }), Dm[e] = c, g;
}, jm = function(a, e) {
  return { value: a, done: e };
}, Um = $t, Ki = om, Bs = Rt, Hu = Sr, Gm = Te.f, zm = Fm, Jt = jm, Hm = le, Yu = "Array Iterator", Ym = Hu.set, Xm = Hu.getterFor(Yu), Wm = zm(Array, "Array", function(a, e) {
  Ym(this, {
    type: Yu,
    target: Um(a),
    // target
  ...
  var a = Xm(this), e = a.target, t = a.index++;
  if (!e || t >= e.length)
  ...
  return Jt([t, e[t]], !1);
}, "values"), Fs = Bs.Arguments = Bs.Array;
Ki("keys");
Ki("values");
Ki("entries");
if (Hm && Fs.name !== "values")
  try {
    Gm(Fs, "name", { value: "values" });
  } catch {
  }
var qm = {
  CSSRuleList: 0,
  ...
  TextTrackList: 0,
  TouchList: 0
}, Qm = Or, Ra = Qm("span").classList, js = Ra && Ra.constructor && Ra.constructor.prototype, Km = js === Object.prototype ? void 0 : js, Us = D, Xu = qm, Zm = Km, pt = Wm, Gs = wt, Jm = $r, e0 = z, Na = e0("iterator"), Ia = pt.values, Wu = function(a, e) {
  if (a) {
    if (a[Na] !== Ia)
      try {
        Gs(a, Na, Ia);
...
for (var Ma in Xu)
  Wu(Us[Ma] && Us[Ma].prototype, Ma);
Wu(Zm, "DOMTokenList");
function Zi(a, e, t) {
  return e = pl(e), e in a ? Object.defineProperty(a, e, {
    value: t,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
var t0 = Oe, r0 = xr, a0 = Io, i0 = Ai, n0 = TypeError, zs = function(a) {
  return function(e, t, r, i) {
    var n = r0(e), o = a0(n), s = i0(n);
    t0(t);
    ...
    if (r < 2)
      for (; ; ) {
        ...
        if (u += l, a ? u < 0 : s <= u)
          throw new n0("Reduce of empty array with no initial value");
      }
    for (; a ? u >= 0 : s > u; u += l)
...
}, u0 = ee, l0 = s0.left, h0 = qu, Hs = bi, v0 = At, f0 = !v0 && Hs > 79 && Hs < 83, c0 = f0 || !h0("reduce");
u0({ target: "Array", proto: !0, forced: c0 }, {
  reduce: function(e) {
    var t = arguments.length;
    return l0(this, e, t, t > 1 ? arguments[1] : void 0);
  }
});
var g0 = ee, d0 = wr, p0 = Et.f, y0 = ut, Ys = pe, m0 = qi, b0 = ge, x0 = Qi, O0 = d0("".slice), T0 = Math.min, Qu = x0("endsWith"), S0 = !Qu && !!function() {
  var a = p0(String.prototype, "endsWith");
  return a && !a.writable;
}();
g0({ target: "String", proto: !0, forced: !S0 && !Qu }, {
  endsWith: function(e) {
    var t = Ys(b0(this));
    m0(e);
    var r = arguments.length > 1 ? arguments[1] : void 0, i = t.length, n = r === void 0 ? i : T0(y0(r), i), o = Ys(e);
    return O0(t, n - o.length, n) === o;
  }
});
var _a = Y, Ku = k, E0 = zi, $0 = K, w0 = Fe, C0 = ge, A0 = iu, P0 = Yi, R0 = ut, Xs = pe, N0 = ot, Ws = Xi, I0 = Mu, M0 = L, qe = I0.UNSUPPORTED_Y, _0 = 4294967295, V0 = Math.min, Va = Ku([].push), Da = Ku("".slice), D0 = !M0(function() {
  var a = /(?:)/, e = a.exec;
  a.exec = function() {
...
}), qs = "abbc".split(/(b)*/)[1] === "c" || // eslint-disable-next-line regexp/no-empty-group -- required for testing
"test".split(/(?:)/, -1).length !== 4 || "ab".split(/(?:ab)*/).length !== 2 || ".".split(/(.?)(.?)/).length !== 4 || // eslint-disable-next-line regexp/no-empty-capturing-group, regexp/no-empty-group -- required for testing
".".split(/()()/).length > 1 || "".split(/.?/).length;
E0("split", function(a, e, t) {
  ...
  return [
    ...
    function(n, o) {
      var s = C0(this), u = w0(n) ? void 0 : N0(n, a);
      return u ? _a(u, n, s, o) : _a(r, Xs(s), n, o);
    },
    ...
    function(i, n) {
      ...
      var l = A0(o, RegExp), h = o.unicode, f = (o.ignoreCase ? "i" : "") + (o.multiline ? "m" : "") + (o.unicode ? "u" : "") + (qe ? "g" : "y"), c = new l(qe ? "^(?:" + o.source + ")" : o, f), v = n === void 0 ? _0 : n >>> 0;
      if (v === 0)
        return [];
      if (s.length === 0)
        return Ws(c, s) === null ? [s] : [];
      for (var d = 0, g = 0, p = []; g < s.length; ) {
        c.lastIndex = qe ? 0 : g;
        var y = Ws(c, qe ? Da(s, g) : s), x;
        if (y === null || (x = V0(R0(c.lastIndex + (qe ? g : 0)), s.length)) === d)
          g = P0(s, g, h);
        else {
...
var L0 = yt.exports, k0 = L0, be = typeof window > "u" ? Ke : window, er = ["moz", "webkit"], rt = "AnimationFrame", st = be["request" + rt], St = be["cancel" + rt] || be["cancelRequest" + rt];
for (var dt = 0; !st && dt < er.length; dt++)
  st = be[er[dt] + "Request" + rt], St = be[er[dt] + "Cancel" + rt] || be[er[dt] + "CancelRequest" + rt];
if (!st || !St) {
  var La = 0, Qs = 0, Me = [], B0 = 1e3 / 60;
  st = function(a) {
    if (Me.length === 0) {
      var e = k0(), t = Math.max(0, B0 - (e - La));
...
var F0 = Nr.exports;
const ka = /* @__PURE__ */ $o(F0);
var Zu = `	
\v\f\r                　\u2028\u2029\uFEFF`, j0 = k, U0 = ge, G0 = pe, fi = Zu, Ks = j0("".replace), z0 = RegExp("^[" + fi + "]+"), H0 = RegExp("(^|[^" + fi + "])[" + fi + "]+$"), Ba = function(a) {
  return function(e) {
    var t = G0(U0(e));
    return a & 1 && (t = Ks(t, z0, "")), a & 2 && (t = Ks(t, H0, "$1")), t;
  };
}, Y0 = {
  ...
  trim: Ba(3)
}, X0 = Tr.PROPER, W0 = L, Zs = Zu, Js = "​᠎", q0 = function(a) {
  return W0(function() {
    return !!Zs[a]() || Js[a]() !== Js || X0 && Zs[a].name !== a;
  });
}, Q0 = ee, K0 = Y0.trim, Z0 = q0;
Q0({ target: "String", proto: !0, forced: Z0("trim") }, {
  trim: function() {
    return K0(this);
  }
});
...
const ci = /* @__PURE__ */ $o(J0);
var eb = ee, tb = wr, rb = Wo.indexOf, ab = qu, gi = tb([].indexOf), Ju = !!gi && 1 / gi([1], 1, -0) < 0, ib = Ju || !ab("indexOf");
eb({ target: "Array", proto: !0, forced: ib }, {
  indexOf: function(e) {
    var t = arguments.length > 1 ? arguments[1] : void 0;
    return Ju ? gi(this, e, t) || 0 : rb(this, e, t);
  }
});
var nb = ee, sb = k, ob = qi, ub = ge, eo = pe, lb = Qi, hb = sb("".indexOf);
nb({ target: "String", proto: !0, forced: !lb("includes") }, {
  includes: function(e) {
    return !!~hb(
      eo(ub(this)),
      eo(ob(e)),
...
var vb = Be, fb = Array.isArray || function(e) {
  return vb(e) === "Array";
}, cb = ee, gb = k, db = fb, pb = gb([].reverse), to = [1, 2];
cb({ target: "Array", proto: !0, forced: String(to) === String(to.reverse()) }, {
  reverse: function() {
    return db(this) && (this.length = this.length), pb(this);
  }
});
/*! *****************************************************************************
...
***************************************************************************** */
var el = function(a, e) {
  return (el = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t, r) {
    t.__proto__ = r;
  } || function(t, r) {
    for (var i in r)
...
function tl(a, e) {
  ...
  el(a, e), a.prototype = e === null ? Object.create(e) : (t.prototype = e.prototype, new t());
}
function yb(a) {
  var e = "";
  Array.isArray(a) || (a = [a]);
...
(function(a) {
  ...
  function n(s, u, l, h, f, c) {
    return oe(s, u, l, h, f, c), i(function(v, d, g, p) {
      var y = v.x1, x = v.x2, b = v.relative && !isNaN(p), O = v.x !== void 0 ? v.x : b ? 0 : d, $ = v.y !== void 0 ? v.y : b ? 0 : g;
      function E(ne) {
        return ne * ne;
      }
      v.type & m.HORIZ_LINE_TO && u !== 0 && (v.type = m.LINE_TO, v.y = v.relative ? 0 : g), v.type & m.VERT_LINE_TO && l !== 0 && (v.type = m.LINE_TO, v.x = v.relative ? 0 : d), v.x !== void 0 && (v.x = v.x * s + $ * l + (b ? 0 : f)), v.y !== void 0 && (v.y = O * u + v.y * h + (b ? 0 : c)), v.x1 !== void 0 && (v.x1 = v.x1 * s + v.y1 * l + (b ? 0 : f)), v.y1 !== void 0 && (v.y1 = y * u + v.y1 * h + (b ? 0 : c)), v.x2 !== void 0 && (v.x2 = v.x2 * s + v.y2 * l + (b ? 0 : f)), v.y2 !== void 0 && (v.y2 = x * u + v.y2 * h + (b ? 0 : c));
      var T = s * h - u * l;
      if (v.xRot !== void 0 && (s !== 1 || u !== 0 || l !== 0 || h !== 1))
        if (T === 0)
          ...
          var C = v.xRot * Math.PI / 180, I = Math.sin(C), _ = Math.cos(C), F = 1 / E(v.rX), P = 1 / E(v.rY), X = E(_) * F + E(I) * P, W = 2 * I * _ * (F - P), G = E(I) * F + E(_) * P, q = X * h * h - W * u * h + G * u * u, H = W * (s * h + u * l) - 2 * (X * l * h + G * s * u), Q = X * l * l - W * s * l + G * s * s, R = (Math.atan2(H, q - Q) + Math.PI) % Math.PI / 2, M = Math.sin(R), Z = Math.cos(R);
          v.rX = Math.abs(T) / Math.sqrt(q * E(Z) + H * M * Z + Q * E(M)), v.rY = Math.abs(T) / Math.sqrt(q * E(M) - H * M * Z + Q * E(Z)), v.xRot = 180 * R / Math.PI;
        }
  ...
  a.ROUND = function(s) {
    ...
    return i(function(c, v, d, g, p) {
      var y = Math.abs, x = !1, b = 0, O = 0;
      if (c.type & m.SMOOTH_CURVE_TO && (b = isNaN(u) ? 0 : v - u, O = isNaN(l) ? 0 : d - l), c.type & (m.CURVE_TO | m.SMOOTH_CURVE_TO) ? (u = c.relative ? v + c.x2 : c.x2, l = c.relative ? d + c.y2 : c.y2) : (u = NaN, l = NaN), c.type & m.SMOOTH_QUAD_TO ? (h = isNaN(h) ? v : 2 * v - h, f = isNaN(f) ? d : 2 * d - f) : c.type & m.QUAD_TO ? (h = c.relative ? v + c.x1 : c.x1, f = c.relative ? d + c.y1 : c.y2) : (h = NaN, f = NaN), c.type & m.LINE_COMMANDS || c.type & m.ARC && (c.rX === 0 || c.rY === 0 || !c.lArcFlag) || c.type & m.CURVE_TO || c.type & m.SMOOTH_CURVE_TO || c.type & m.QUAD_TO || c.type & m.SMOOTH_QUAD_TO) {
        var $ = c.x === void 0 ? 0 : c.relative ? c.x : c.x - v, E = c.y === void 0 ? 0 : c.relative ? c.y : c.y - d;
        b = isNaN(h) ? c.x1 === void 0 ? b : c.relative ? c.x : c.x1 - v : h - v, O = isNaN(f) ? c.y1 === void 0 ? O : c.relative ? c.y : c.y1 - d : f - d;
        var T = c.x2 === void 0 ? 0 : c.relative ? c.x : c.x2 - v, C = c.y2 === void 0 ? 0 : c.relative ? c.y : c.y2 - d;
    ...
    return i(function(s, u, l) {
      return m.ARC === s.type ? function(h, f, c) {
        var v, d, g, p;
        h.cX || Fa(h, f, c);
        for (var y = Math.min(h.phi1, h.phi2), x = Math.max(h.phi1, h.phi2) - y, b = Math.ceil(x / 90), O = new Array(b), $ = f, E = c, T = 0; T < b; T++) {
          var C = ao(h.phi1, h.phi2, T / b), I = ao(h.phi1, h.phi2, (T + 1) / b), _ = I - C, F = 4 / 3 * Math.tan(_ * ye / 4), P = [Math.cos(C * ye) - F * Math.sin(C * ye), Math.sin(C * ye) + F * Math.cos(C * ye)], X = P[0], W = P[1], G = [Math.cos(I * ye), Math.sin(I * ye)], q = G[0], H = G[1], Q = [q + F * Math.sin(I * ye), H - F * Math.cos(I * ye)], R = Q[0], M = Q[1];
          O[T] = { relative: h.relative, type: m.CURVE_TO };
          var Z = function(ne, fe) {
            var Se = di([ne * h.rX, fe * h.rY], h.xRot), ze = Se[0], It = Se[1];
            return [h.cX + ze, h.cY + It];
          };
          v = Z(X, W), O[T].x1 = v[0], O[T].y1 = v[1], d = Z(R, M), O[T].x2 = d[0], O[T].y2 = d[1], g = Z(q, H), O[T].x = g[0], O[T].y = g[1], h.relative && (O[T].x1 -= $, O[T].y1 -= E, O[T].x2 -= $, O[T].y2 -= E, O[T].x -= $, O[T].y -= E), $ = (p = [O[T].x, O[T].y])[0], E = p[1];
        }
        return O;
    ...
    var s = function(c) {
      ...
      if (g.type & m.DRAWING_COMMANDS && (p(v), y(d)), g.type & m.HORIZ_LINE_TO && p(g.x), g.type & m.VERT_LINE_TO && y(g.y), g.type & m.LINE_TO && (p(g.x), y(g.y)), g.type & m.CURVE_TO) {
        p(g.x), y(g.y);
        for (var x = 0, b = no(v, g.x1, g.x2, g.x); x < b.length; x++)
          0 < (R = b[x]) && 1 > R && p(so(v, g.x1, g.x2, g.x, R));
        for (var O = 0, $ = no(d, g.y1, g.y2, g.y); O < $.length; O++)
          0 < (R = $[O]) && 1 > R && y(so(d, g.y1, g.y2, g.y, R));
      }
      if (g.type & m.ARC) {
        p(g.x), y(g.y), Fa(g, v, d);
        for (var E = g.xRot / 180 * Math.PI, T = Math.cos(E) * g.rX, C = Math.sin(E) * g.rX, I = -Math.sin(E) * g.rY, _ = Math.cos(E) * g.rY, F = g.phi1 < g.phi2 ? [g.phi1, g.phi2] : -180 > g.phi2 ? [g.phi2 + 360, g.phi1 + 360] : [g.phi2, g.phi1], P = F[0], X = F[1], W = function(M) {
          var Z = M[0], ne = M[1], fe = 180 * Math.atan2(ne, Z) / Math.PI;
          return fe < P ? fe + 360 : fe;
        }, G = 0, q = ro(I, -T, 0).map(W); G < q.length; G++)
          (R = q[G]) > P && R < X && p(io(g.cX, T, I, R));
        for (var H = 0, Q = ro(_, -C, 0).map(W); H < Q.length; H++) {
          var R;
          (R = Q[H]) > P && R < X && y(io(g.cY, C, _, R));
        }
      }
      return c;
    });
...
`;
  ...
  return tl(e, a), e.prototype.finish = function(t) {
    ...
    for (var n = function(f) {
      ...
      var s = t[o], u = !(this.curCommandType !== m.ARC || this.curArgs.length !== 3 && this.curArgs.length !== 4 || this.curNumber.length !== 1 || this.curNumber !== "0" && this.curNumber !== "1"), l = oo(s) && (this.curNumber === "0" && s === "0" || u);
      if (!oo(s) || l)
        if (s !== "e" && s !== "E")
  ...
  return tl(e, a), e.prototype.encode = function() {
...
}(rl), xb = ((se = {})[m.MOVE_TO] = 2, se[m.LINE_TO] = 2, se[m.HORIZ_LINE_TO] = 1, se[m.VERT_LINE_TO] = 1, se[m.CLOSE_PATH] = 0, se[m.QUAD_TO] = 4, se[m.SMOOTH_QUAD_TO] = 2, se[m.CURVE_TO] = 6, se[m.SMOOTH_CURVE_TO] = 4, se[m.ARC] = 7, se), Ob = Y, Tb = he, Sb = yr, Eb = Iu, uo = RegExp.prototype, $b = function(a) {
  var e = a.flags;
  return e === void 0 && !("flags" in uo) && !Tb(a, "flags") && Sb(uo, a) ? Ob(Eb, a) : e;
}, wb = Tr.PROPER, Cb = Ue, Ab = K, lo = pe, Pb = L, Rb = $b, Ji = "toString", al = RegExp.prototype, il = al[Ji], Nb = Pb(function() {
  return il.call({ source: "a", flags: "b" }) !== "/a/b";
}), Ib = wb && il.name !== Ji;
(Nb || Ib) && Cb(al, Ji, function() {
  var e = Ab(this), t = lo(e.source), r = lo(Rb(e));
  return "/" + t + "/" + r;
}, { unsafe: !0 });
function lr(a) {
...
var _b = [512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437, 420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405, 394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298, 291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456, 446, 437, 428, 420, 412, 404, 396, 388, 381, 374, 367, 360, 354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292, 287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482, 475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405, 399, 394, 389, 383, 378, 373, 368, 364, 359, 354, 350, 345, 341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298, 294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259, 257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456, 451, 446, 442, 437, 433, 428, 424, 420, 416, 412, 408, 404, 400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360, 357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323, 320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292, 289, 287, 285, 282, 280, 278, 275, 273, 271, 269, 267, 265, 263, 261, 259], Vb = [9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24];
function Db(a, e, t, r, i) {
...
function Lb(a, e, t, r, i, n) {
  if (!(isNaN(n) || n < 1)) {
    n |= 0;
    var o = Db(a, e, t, r, i);
    o = kb(o, e, t, r, i, n), a.getContext("2d").putImageData(o, e, t);
  }
}
function kb(a, e, t, r, i, n) {
  for (var o = a.data, s = 2 * n + 1, u = r - 1, l = i - 1, h = n + 1, f = h * (h + 1) / 2, c = new ho(), v = c, d, g = 1; g < s; g++)
    v = v.next = new ho(), g === h && (d = v);
  v.next = c;
  for (var p = null, y = null, x = 0, b = 0, O = _b[n], $ = Vb[n], E = 0; E < i; E++) {
    v = c;
    for (var T = o[b], C = o[b + 1], I = o[b + 2], _ = o[b + 3], F = 0; F < h; F++)
      v.r = T, v.g = C, v.b = I, v.a = _, v = v.next;
    for (var P = 0, X = 0, W = 0, G = 0, q = h * T, H = h * C, Q = h * I, R = h * _, M = f * T, Z = f * C, ne = f * I, fe = f * _, Se = 1; Se < h; Se++) {
      var ze = b + ((u < Se ? u : Se) << 2), It = o[ze], rn = o[ze + 1], an = o[ze + 2], nn = o[ze + 3], Mt = h - Se;
      M += (v.r = It) * Mt, Z += (v.g = rn) * Mt, ne += (v.b = an) * Mt, fe += (v.a = nn) * Mt, P += It, X += rn, W += an, G += nn, v = v.next;
    }
    p = c, y = d;
    for (var Dr = 0; Dr < r; Dr++) {
      ...
      var Ae = Dr + n + 1;
      Ae = x + (Ae < u ? Ae : u) << 2, P += p.r = o[Ae], X += p.g = o[Ae + 1], W += p.b = o[Ae + 2], G += p.a = o[Ae + 3], M += P, Z += X, ne += W, fe += G, p = p.next;
  ...
  for (var He = 0; He < r; He++) {
    ...
    for (var vn = r, Gr = 0, zr = 0, Hr = 0, Yr = 0, Bt = 1; Bt <= n; Bt++) {
      b = vn + He << 2;
      var Ft = h - Bt;
      Vt += (v.r = Pe = o[b]) * Ft, Dt += (v.g = Re = o[b + 1]) * Ft, Lt += (v.b = Ne = o[b + 2]) * Ft, kt += (v.a = te = o[b + 3]) * Ft, Yr += Pe, Gr += Re, zr += Ne, Hr += te, v = v.next, Bt < l && (vn += r);
    }
    b = He, p = c, y = d;
    for (var Xr = 0; Xr < i; Xr++) {
      var re = b << 2;
      o[re + 3] = te = kt * O >> $, te > 0 ? (te = 255 / te, o[re] = (Vt * O >> $) * te, o[re + 1] = (Dt * O >> $) * te, o[re + 2] = (Lt * O >> $) * te) : o[re] = o[re + 1] = o[re + 2] = 0, Vt -= Br, Dt -= Fr, Lt -= jr, kt -= Ur, Br -= p.r, Fr -= p.g, jr -= p.b, Ur -= p.a, re = He + ((re = Xr + h) < l ? re : l) * r << 2, Vt += Yr += p.r = o[re], Dt += Gr += p.g = o[re + 1], Lt += zr += p.b = o[re + 2], kt += Hr += p.a = o[re + 3], p = p.next, Br += Pe = y.r, Fr += Re = y.g, jr += Ne = y.b, Ur += te = y.a, Yr -= Pe, Gr -= Re, zr -= Ne, Hr -= te, y = y.next, b += r;
    }
  }
  return a;
}
var ho = (
   ...
   */
  function a() {
    Mb(this, a), this.r = 0, this.g = 0, this.b = 0, this.a = 0, this.next = null;
  }
);
function Bb() {
  var {
...
var Gb = /^[A-Z-]+$/;
function zb(a) {
  return Gb.test(a) ? a.toLowerCase() : a;
}
function nl(a) {
  var e = /url\(('([^']+)'|"([^"]+)"|([^'")]+))\)/.exec(a) || [];
  return e[2] || e[3] || e[4];
...
var Yb = /(\[[^\]]+\])/g, Xb = /(#[^\s+>~.[:]+)/g, Wb = /(\.[^\s+>~.[:]+)/g, qb = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi, Qb = /(:[\w-]+\([^)]*\))/gi, Kb = /(:[^\s+>~.[:]+)/g, Zb = /([^\s+>~.[:]+)/g;
function _e(a, e) {
  var t = e.exec(a);
...
function Jb(a) {
  ...
  return [t, r] = _e(t, Yb), e[1] += r, [t, r] = _e(t, Xb), e[0] += r, [t, r] = _e(t, Wb), e[1] += r, [t, r] = _e(t, qb), e[2] += r, [t, r] = _e(t, Qb), e[1] += r, [t, r] = _e(t, Kb), e[1] += r, t = t.replace(/[*\s+>~]/g, " ").replace(/[#.]/g, " "), [t, r] = _e(t, Zb), e[2] += r, e.join("");
}
var at = 1e-8;
function vo(a) {
...
function pi(a, e) {
  return (a[0] * e[0] + a[1] * e[1]) / (vo(a) * vo(e));
}
function fo(a, e) {
...
class S {
  ...
  getColor(e) {
    ...
    return this.isNormalizedColor || (this.isNormalizedColor = !0, t = Hb(t), this.value = t), t;
  }
  getDpi() {
    return 96;
  }
...
class Ir {
  constructor(e) {
    ...
    this.ctx = e, this.FRAMERATE = 30, this.MAX_VIRTUAL_PIXELS = 3e4, this.CLIENT_WIDTH = 800, this.CLIENT_HEIGHT = 600, this.viewPort = new e1(), this.mouse = new t1(this), this.animations = [], this.waits = [], this.frameDuration = 0, this.isReadyLock = !1, this.isFirstRender = !0, this.intervalId = null, this.window = r, this.fetch = t;
  }
  wait(e) {
    this.waits.push(e);
  }
  ...
  setViewBox(e) {
    var {
      ...
      clipX: d = 0,
      clipY: g = 0
    } = e, p = ht(i).replace(/^defer\s/, ""), [y, x] = p.split(" "), b = y || "xMidYMid", O = x || "meet", $ = n / o, E = s / u, T = Math.min($, E), C = Math.max($, E), I = o, _ = u;
    ...
    if (!X) {
      var q = O === "meet" && T === E, H = O === "slice" && C === E, Q = O === "meet" && T === $, R = O === "slice" && C === $;
  ...
  render(e, t, r, i, n, o, s) {
    ...
    if (t && d.hasValue() && g.hasValue() && (p = d.getPixels("x"), y = g.getPixels("y")), h.setCurrent(p, y), typeof o == "number" && e.getAttribute("x", !0).setValue(o), typeof s == "number" && e.getAttribute("y", !0).setValue(s), typeof i == "number" || typeof n == "number") {
      var x = ie(e.getAttribute("viewBox").getString()), b = 0, O = 0;
      if (typeof i == "number") {
      ...
      T.setValue("".concat(T.getString(), " scale(").concat(1 / b, ", ").concat(1 / O, ")"));
    }
...
var {
  defaultFetch: r1
} = Ir, a1 = typeof DOMParser < "u" ? DOMParser : null;
class ja {
  constructor() {
    var {
      fetch: e = r1,
...
class ke {
  constructor(e, t, r) {
    ...
    i.forEach((n) => {
      if (n !== "none") {
        var [o, s] = h1(n), u = ke.transformTypes[o];
...
function c1(a) {
  return typeof process > "u" ? a : a.trim().split(",").map(f1).join(",");
}
function g1(a) {
  if (!a)
    return "";
  ...
  setContext(e) {
    ...
    if (!t) {
      ...
      if (g.hasValue() && (e.lineCap = g.getString()), p.hasValue() && (e.lineJoin = p.getString()), y.hasValue() && (e.miterLimit = y.getNumber()), x.hasValue() && x.getString() !== "none") {
        ...
        typeof e.setLineDash < "u" ? e.setLineDash(O) : typeof e.webkitLineDash < "u" ? e.webkitLineDash = O : typeof e.mozDash < "u" && !(O.length === 1 && O[0] === 0) && (e.mozDash = O);
        var $ = b.getPixels();
    ...
    if (this.modifiedEmSizeStack = !1, typeof e.font < "u") {
      var E = this.getStyle("font"), T = this.getStyle("font-style"), C = this.getStyle("font-variant"), I = this.getStyle("font-weight"), _ = this.getStyle("font-size"), F = this.getStyle("font-family"), P = new J(T.getString(), C.getString(), I.getString(), _.hasValue() ? "".concat(_.getPixels(!0), "px") : "", F.getString(), J.parse(E.getString(), e.font));
      T.setValue(P.fontStyle), C.setValue(P.fontVariant), I.setValue(P.fontWeight), _.setValue(P.fontSize), F.setValue(P.fontFamily), e.font = P.toString(), _.isPixels() && (this.document.emSize = _.getPixels(), this.modifiedEmSizeStack = !0);
    }
...
class A extends Ge {
  ...
  static pathA(e) {
    ...
    isNaN(v) && (v = 0);
    var d = new V(v * i * f.y / n, v * -n * f.x / i), g = new V((t.x + h.x) / 2 + Math.cos(l) * d.x - Math.sin(l) * d.y, (t.y + h.y) / 2 + Math.sin(l) * d.x + Math.cos(l) * d.y), p = fo([1, 0], [(f.x - d.x) / i, (f.y - d.y) / n]), y = [(f.x - d.x) / i, (f.y - d.y) / n], x = [(-f.x - d.x) / i, (-f.y - d.y) / n], b = fo(y, x);
...
class Ce extends Ge {
  ...
  getTextFromNode(e) {
    ...
    return i === 0 && (o = jb(o)), i === n && (o = Ub(o)), o;
  }
  renderChildren(e) {
    if (this.type !== "text") {
...
class m1 extends A {
  ...
  path(e) {
    ...
    return e && r > 0 && i > 0 && (e.beginPath(), e.moveTo(n + r, o), e.bezierCurveTo(n + r, o + t * i, n + t * r, o + i, n, o + i), e.bezierCurveTo(n - t * r, o + i, n - r, o + t * i, n - r, o), e.bezierCurveTo(n - r, o - t * i, n - t * r, o - i, n, o - i), e.bezierCurveTo(n + t * r, o - i, n + r, o - t * i, n + r, o), e.closePath()), new ve(n - r, o - i, n + r, o + i);
  }
  getMarkers() {
    return null;
  }
  ...
  createGradient(e, t, r) {
    ...
    if (n.forEach((p) => {
      ...
      var {
        ...
        viewPort: l
      } = s.screen, [h] = l.viewPorts, f = new vl(s, null);
...
function tr(a) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? Oo(Object(t), !0).forEach(function(r) {
      Zi(a, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(t)) : Oo(Object(t)).forEach(function(r) {
...
class _1 extends Ce {
  ...
  setTextData(e) {
    if (!this.glyphInfo) {
      var t = this.getText(), r = t.split(""), i = t.split(" ").length - 1, n = this.parent.getAttribute("dx").split().map((O) => O.getPixels("x")), o = this.parent.getAttribute("dy").getPixels("y"), s = this.parent.getStyle("text-anchor").getString("start"), u = this.getStyle("letter-spacing"), l = this.parent.getStyle("letter-spacing"), h = 0;
      ...
      var d = f.reduce((O, $, E) => E === 0 ? 0 : O + $ || 0, 0), g = this.measureText(e), p = Math.max(g + d, 0);
      ...
      (s === "middle" || s === "center") && (b = -p / 2), (s === "end" || s === "right") && (b = -p), b += x, r.forEach((O, $) => {
        var {
          offset: E,
          segment: T,
          rotation: C
        } = this.findSegmentToFitChar(e, s, p, y, i, b, o, O, $);
  ...
  getPointOnCubicBezier(e, t, r, i, n, o, s, u, l) {
    var h = u * co(e) + o * go(e) + i * po(e) + t * yo(e), f = l * co(e) + s * go(e) + n * po(e) + r * yo(e);
    return {
      x: h,
      y: f
    };
  ...
  getPointOnQuadraticBezier(e, t, r, i, n, o, s) {
    var u = o * mo(e) + i * bo(e) + t * xo(e), l = s * mo(e) + n * bo(e) + r * xo(e);
    return {
      x: u,
      y: l
    };
        ...
        l.forEach((f) => {
          ...
          if (c) {
            ...
            if (h.forEach((p) => {
              ...
              x && b && (v[x] = new S(e, x, b));
            }), e.styles[c] = v, e.stylesSpecificity[c] = Jb(c), c === "@font-face") {
...
class _r extends N {
  ...
  apply(e, t) {
    ...
    r.screen.setDefaults(f), this.renderChildren(f), new dl(r, {
      nodeType: 1,
      childNodes: [],
      attributes: [{
        nodeName: "type",
...
class F1 extends N {
  ...
  apply(e) {
    ...
    r && (r.beginPath = To, r.closePath = To), Reflect.apply(i, e, []), this.children.forEach((o) => {
      if (!(typeof o.path > "u")) {
...
class z1 extends N {
  ...
  apply(e, t, r, i, n) {
    ...
    l.id = o.getUniqueId(), u && (l.style.display = "none", u.appendChild(l)), Lb(l, t, r, i, n, s), u && u.removeChild(l);
  }
}
class H1 extends N {
  constructor() {
...
function W1(a) {
  for (var e = 1; e < arguments.length; e++) {
    var t = arguments[e] != null ? arguments[e] : {};
    e % 2 ? So(Object(t), !0).forEach(function(r) {
      Zi(a, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(t)) : So(Object(t)).forEach(function(r) {
      Object.defineProperty(a, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return a;
...
class $e {
  ...
  createElement(e) {
    ...
    return typeof r < "u" ? new r(this, e) : new v1(this, e);
  }
  createTextNode(e) {
    return new p1(this, e);
  }
  setViewBox(e) {
    this.screen.setViewBox(W1({
      document: this
    }, e));
  }
}
...
export {
  M1 as AElement,
  C1 as AnimateColorElement,
  tn as AnimateElement,
  A1 as AnimateTransformElement,
  ve as BoundingBox,
  co as CB1,
  go as CB2,
  po as CB3,
  ...
  mt as Canvg,
  y1 as CircleElement,
  F1 as ClipPathElement,
  S1 as DefsElement,
  Y1 as DescElement,
  $e as Document,
  N as Element,
  m1 as EllipseElement,
  dl as FeColorMatrixElement,
  G1 as FeCompositeElement,
  j1 as FeDropShadowElement,
  z1 as FeGaussianBlurElement,
  U1 as FeMorphologyElement,
  Vr as FilterElement,
  J as Font,
  P1 as FontElement,
  R1 as FontFaceElement,
  en as GElement,
  hl as GlyphElement,
  cl as GradientElement,
  D1 as ImageElement,
  b1 as LineElement,
  E1 as LinearGradientElement,
  T1 as MarkerElement,
  _r as MaskElement,
  ul as Matrix,
  N1 as MissingGlyphElement,
  t1 as Mouse,
  at as PSEUDO_ZERO,
  ja as Parser,
  A as PathElement,
  ...
  V as Point,
  x1 as PolygonElement,
  fl as PolylineElement,
  S as Property,
  mo as QB1,
  bo as QB2,
  xo as QB3,
  $1 as RadialGradientElement,
  vl as RectElement,
  ...
  Mr as TSpanElement,
  Ce as TextElement,
  _1 as TextPathElement,
  H1 as TitleElement,
  ke as Transform,
  i1 as Translate,
  v1 as UnknownElement,
  B1 as UseElement,
  e1 as ViewPort,
  ht as compressSpaces,
  mt as default,
  Jb as getSelectorSpecificity,
  zb as normalizeAttributeName,
  Hb as normalizeColor,
  nl as parseExternalUrl,
  Z1 as presets,
  ie as toNumbers,
  jb as trimLeft,
  Ub as trimRight,
  vo as vectorMagnitude,
  fo as vectorsAngle,
  pi as vectorsRatio
};
//# sourceMappingURL=index.es--qhJ9SGs.js.map
