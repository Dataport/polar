...
}`);var Q=se(`plugins/pointerPosition`,()=>{let e=x(),t=g(0),n=g([]),r=y(()=>e.configuration.pointerPosition?.projections?e.configuration.pointerPosition.projections.map(e=>({...e,decimals:e.decimals??4})):e.configuration.namedProjections.map(([e])=>({code:e,decimals:4}))),i=y(()=>r.value[t.value]),a=y(()=>n.value.length?S(r.value[t.value]?.decimals??4)(b(n.value,e.map.getView().getProjection().getCode(),i.value?.code)):`X, Y`),o=({coordinate:e})=>n.value=e,s=e=>{t.value=Number(Array.isArray(e)?e[0]:e)};function c(){s(t.value),e.map.on(`pointermove`,o)}function l(){e.map.un(`pointermove`,o)}return{setupPlugin:c,teardownPlugin:l,formattedPointerPosition:a,availableProjections:r,selectedProjection:t,currentEpsgSystem:i,setSelectedProjection:s}}),$=`pointerPosition`,Le=[`title`,`aria-label`],Re={key:1},ze=s(ae({__name:`PointerPosition.ce`,setup(e){let t=Q(),{formattedPointerPosition:n,availableProjections:r,selectedProjection:i,currentEpsgSystem:a}=ce(t),{setSelectedProjection:o}=t;return(e,t)=>(v(),_(`div`,{class:`polar-plugin-pointer-position`,title:e.$t(e=>e.label,{ns:p($)}),"aria-label":e.$t(e=>e.label,{ns:p($)})},[t[0]||=h(`span`,{class:`kern-icon kern-icon--point-scan`,"aria-hidden":`true`},null,-1),p(r).length>1?(v(),oe(f,{key:0,value:String(p(i)),options:p(r).map((e,t)=>({value:t,label:e.code,ariaLabel:e.code})),"aria-label":e.$t(e=>e.projectionSelect.label,{ns:p($)}),small:``,"onUpdate:value":p(o)},null,8,[`value`,`options`,`aria-label`,`onUpdate:value`])):(v(),_(`small`,Re,m(p(a)?.code),1)),h(`span`,null,m(p(n)),1)],8,Le))}}),[[`styles`,[`.polar-plugin-pointer-position[data-v-6c8ab50b]{align-items:center;gap:var(--kern-metric-space-small);margin:var(--kern-metric-space-2x-small);padding:var(--kern-metric-space-2x-small) var(--kern-metric-space-small);border-radius:var(--kern-metric-border-radius-large);color:var(--kern-color-layout-text-default);background-color:var(--kern-color-form-input-background-inverted);box-shadow:var(--polar-shadow);flex-flow:wrap;display:flex}`]],[`__scopeId`,`data-v-6c8ab50b`]]),Be=[{type:`de`,resources:{label:`Zeigerposition`,projectionSelect:{label:`Koordinatenreferenzsystem`}}},{type:`en`,resources:{label:`Pointer position`,projectionSelect:{label:`Coordinate reference system`}}}];function Ve(e){return{id:$,component:ze,locales:Be,options:e,storeModule:Q}}var He=(e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n};export{we as a,Oe as c,Pe as i,Ve as n,me as o,Z as r,Ae as s,He as t};