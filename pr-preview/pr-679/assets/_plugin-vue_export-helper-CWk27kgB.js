import{B as e,G as t,H as n,J as r,K as i,L as a,R as o,U as s,V as c,W as l,X as u,Y as d,c as ee,lt as te,n as ne,q as re,wt as ie,z as f}from"./runtime-core.esm-bundler-DmL19dRe.js";import{$ as p,B as m,K as h,Q as ae,W as g,it as _,n as oe,p as v,u as y}from"./vue.runtime.esm-bundler-DetiCiOa-C-xdL2bx.js";import{o as se,r as ce}from"./pinia-BUEtD7BZ-CEEMCNHl.js";import{At as b,pn as x,q as S}from"./stores-CsDExrpr-Ds7qAdTY.js";var C=void 0,w=typeof window<`u`&&window.trustedTypes;if(w)try{C=w.createPolicy(`vue`,{createHTML:e=>e})}catch{}var T=C?e=>C.createHTML(e):e=>e,le=`http://www.w3.org/2000/svg`,ue=`http://www.w3.org/1998/Math/MathML`,E=typeof document<`u`?document:null,D=E&&E.createElement(`template`),de={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{let t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,r)=>{let i=t===`svg`?E.createElementNS(le,e):t===`mathml`?E.createElementNS(ue,e):n?E.createElement(e,{is:n}):E.createElement(e);return e===`select`&&r&&r.multiple!=null&&i.setAttribute(`multiple`,r.multiple),i},createText:e=>E.createTextNode(e),createComment:e=>E.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>E.querySelector(e),setScopeId(e,t){e.setAttribute(t,``)},insertStaticContent(e,t,n,r,i,a){let o=n?n.previousSibling:t.lastChild;if(i&&(i===a||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),n),!(i===a||!(i=i.nextSibling)););else{D.innerHTML=T(r===`svg`?`<svg>${e}</svg>`:r===`mathml`?`<math>${e}</math>`:e);let i=D.content;if(r===`svg`||r===`mathml`){let e=i.firstChild;for(;e.firstChild;)i.appendChild(e.firstChild);i.removeChild(e)}t.insertBefore(i,n)}return[o?o.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},fe=Symbol(`_vtc`);function pe(e,t,n){let r=e[fe];r&&(t=(t?[t,...r]:[...r]).join(` `)),t==null?e.removeAttribute(`class`):n?e.setAttribute(`class`,t):e.className=t}var O=Symbol(`_vod`),k=Symbol(`_vsh`),me={name:`show`,beforeMount(e,{value:t},{transition:n}){e[O]=e.style.display===`none`?``:e.style.display,n&&t?n.beforeEnter(e):A(e,t)},mounted(e,{value:t},{transition:n}){n&&t&&n.enter(e)},updated(e,{value:t,oldValue:n},{transition:r}){!t!=!n&&(r?t?(r.beforeEnter(e),A(e,!0),r.enter(e)):r.leave(e,()=>{A(e,!1)}):A(e,t))},beforeUnmount(e,{value:t}){A(e,t)}};function A(e,t){e.style.display=t?e[O]:`none`,e[k]=!t}var j=Symbol(``),M=/(?:^|;)\s*display\s*:/;function N(e,t,n){let i=e.style,a=r(n),o=!1;if(n&&!a){if(t)if(r(t))for(let e of t.split(`;`)){let t=e.slice(0,e.indexOf(`:`)).trim();n[t]??F(i,t,``)}else for(let e in t)n[e]??F(i,e,``);for(let a in n){a===`display`&&(o=!0);let s=n[a];s==null?F(i,a,``):z(e,a,!r(t)&&t?t[a]:void 0,s)||F(i,a,s)}}else if(a){if(t!==n){let e=i[j];e&&(n+=`;`+e),i.cssText=n,o=M.test(n)}}else t&&e.removeAttribute(`style`);O in e&&(e[O]=o?i.display:``,e[k]&&(i.display=`none`))}var P=/\s*!important$/;function F(t,n,r){if(s(r))r.forEach(e=>F(t,n,e));else if(r??=``,n.startsWith(`--`))t.setProperty(n,r);else{let i=R(t,n);P.test(r)?t.setProperty(e(i),r.replace(P,``),`important`):t[i]=r}}var I=[`Webkit`,`Moz`,`ms`],L={};function R(e,t){let n=L[t];if(n)return n;let r=a(t);if(r!==`filter`&&r in e)return L[t]=r;r=o(r);for(let n=0;n<I.length;n++){let i=I[n]+r;if(i in e)return L[t]=i}return t}function z(e,t,n,i){return e.tagName===`TEXTAREA`&&(t===`width`||t===`height`)&&r(i)&&n===i}var B=`http://www.w3.org/1999/xlink`;function V(e,t,n,r,i,a=re(t)){r&&t.startsWith(`xlink:`)?n==null?e.removeAttributeNS(B,t.slice(6,t.length)):e.setAttributeNS(B,t,n):n==null||a&&!c(n)?e.removeAttribute(t):e.setAttribute(t,a?``:d(n)?String(n):n)}function H(e,t,n,r,i){if(t===`innerHTML`||t===`textContent`){n!=null&&(e[t]=t===`innerHTML`?T(n):n);return}let a=e.tagName;if(t===`value`&&a!==`PROGRESS`&&!a.includes(`-`)){let r=a===`OPTION`?e.getAttribute(`value`)||``:e.value,i=n==null?e.type===`checkbox`?`on`:``:String(n);(r!==i||!(`_value`in e))&&(e.value=i),n??e.removeAttribute(t),e._value=n;return}let o=!1;if(n===``||n==null){let r=typeof e[t];r===`boolean`?n=c(n):n==null&&r===`string`?(n=``,o=!0):r===`number`&&(n=0,o=!0)}try{e[t]=n}catch{}o&&e.removeAttribute(i||t)}function U(e,t,n,r){e.addEventListener(t,n,r)}function he(e,t,n,r){e.removeEventListener(t,n,r)}var W=Symbol(`_vei`);function ge(e,t,n,r,i=null){let a=e[W]||(e[W]={}),o=a[t];if(r&&o)o.value=r;else{let[n,s]=K(t);r?U(e,n,a[t]=ye(r,i),s):o&&(he(e,n,o,s),a[t]=void 0)}}var G=/(?:Once|Passive|Capture)$/;function K(t){let n;if(G.test(t)){n={};let e;for(;e=t.match(G);)t=t.slice(0,t.length-e[0].length),n[e[0].toLowerCase()]=!0}return[t[2]===`:`?t.slice(3):e(t.slice(2)),n]}var q=0,_e=Promise.resolve(),ve=()=>q||=(_e.then(()=>q=0),Date.now());function ye(e,t){let n=e=>{if(!e._vts)e._vts=Date.now();else if(e._vts<=n.attached)return;ne(be(e,n.value),t,5,[e])};return n.value=e,n.attached=ve(),n}function be(e,t){if(s(t)){let n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},t.map(e=>t=>!t._stopped&&e&&e(t))}else return t}var J=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,xe=(e,n,o,s,c,l)=>{let u=c===`svg`;n===`class`?pe(e,s,u):n===`style`?N(e,o,s):i(n)?t(n)||ge(e,n,o,s,l):(n[0]===`.`?(n=n.slice(1),!0):n[0]===`^`?(n=n.slice(1),!1):Se(e,n,s,u))?(H(e,n,s),!e.tagName.includes(`-`)&&(n===`value`||n===`checked`||n===`selected`)&&V(e,n,s,u,l,n!==`value`)):e._isVueCE&&(Ce(e,n)||e._def.__asyncLoader&&(/[A-Z]/.test(n)||!r(s)))?H(e,a(n),s,l,n):(n===`true-value`?e._trueValue=s:n===`false-value`&&(e._falseValue=s),V(e,n,s,u))};function Se(e,t,n,i){if(i)return!!(t===`innerHTML`||t===`textContent`||t in e&&J(t)&&l(n));if(t===`spellcheck`||t===`draggable`||t===`translate`||t===`autocorrect`||t===`sandbox`&&e.tagName===`IFRAME`||t===`form`||t===`list`&&e.tagName===`INPUT`||t===`type`&&e.tagName===`TEXTAREA`)return!1;if(t===`width`||t===`height`){let t=e.tagName;if(t===`IMG`||t===`VIDEO`||t===`CANVAS`||t===`SOURCE`)return!1}return J(t)&&r(n)?!1:t in e}function Ce(e,t){let n=e._def.props;if(!n)return!1;let r=a(t);return Array.isArray(n)?n.some(e=>a(e)===r):Object.keys(n).some(e=>a(e)===r)}var Y=e=>{let t=e.props[`onUpdate:modelValue`]||!1;return s(t)?e=>n(t,e):t},X=Symbol(`_assign`),we={created(e,{value:t},n){e.checked=u(t,n.props.value),e[X]=Y(n),U(e,`change`,()=>{e[X](Te(e))})},beforeUpdate(e,{value:t,oldValue:n},r){e[X]=Y(r),t!==n&&(e.checked=u(t,r.props.value))}};function Te(e){return`_value`in e?e._value:e.value}var Ee=[`ctrl`,`shift`,`alt`,`meta`],De={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>`button`in e&&e.button!==0,middle:e=>`button`in e&&e.button!==1,right:e=>`button`in e&&e.button!==2,exact:(e,t)=>Ee.some(n=>e[`${n}Key`]&&!t.includes(n))},Oe=(e,t)=>{if(!e)return e;let n=e._withMods||={},r=t.join(`.`);return n[r]||(n[r]=((n,...r)=>{for(let e=0;e<t.length;e++){let r=De[t[e]];if(r&&r(n,t))return}return e(n,...r)}))},ke={esc:`escape`,space:` `,up:`arrow-up`,left:`arrow-left`,right:`arrow-right`,down:`arrow-down`,delete:`backspace`},Ae=(t,n)=>{let r=t._withKeys||={},i=n.join(`.`);return r[i]||(r[i]=(r=>{if(!(`key`in r))return;let i=e(r.key);if(n.some(e=>e===i||ke[e]===i))return t(r)}))},je=f({patchProp:xe},de),Me;function Ne(){return Me||=ee(je)}var Pe=((...e)=>{let t=Ne().createApp(...e),{mount:n}=t;return t.mount=e=>{let r=Ie(e);if(!r)return;let i=t._component;!l(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.nodeType===1&&(r.textContent=``);let a=n(r,!1,Fe(r));return r instanceof Element&&(r.removeAttribute(`v-cloak`),r.setAttribute(`data-v-app`,``)),a},t});function Fe(e){if(e instanceof SVGElement)return`svg`;if(typeof MathMLElement==`function`&&e instanceof MathMLElement)return`mathml`}function Ie(e){return r(e)?document.querySelector(e):e}var Z=new CSSStyleSheet;Z.replaceSync(`@layer kern-ux-icons {
...
}`);var Q=se(`plugins/pointerPosition`,()=>{let e=b(),t=g(0),n=g([]),r=y(()=>e.configuration.pointerPosition?.projections?e.configuration.pointerPosition.projections.map(e=>({...e,decimals:e.decimals??4})):e.configuration.namedProjections.map(([e])=>({code:e,decimals:4}))),i=y(()=>r.value[t.value]),a=y({get:()=>i.value?.code,set:e=>{let n=r.value.findIndex(({code:t})=>t===e);if(n!==-1){t.value=n;return}console.error(`@polar/polar(plugins/pointerPosition/store:55:5)
`,`EPSG code ${e} not found in available projections.`)}}),o=y(()=>n.value.length?S(i.value?.decimals??4)(x(n.value,e.map.getView().getProjection().getCode(),a.value)):`X, Y`),s=({coordinate:e})=>n.value=e;function c(){e.map.on(`pointermove`,s)}function l(){e.map.un(`pointermove`,s)}return{setupPlugin:c,teardownPlugin:l,formattedPointerPosition:o,availableProjections:r,selectedProjection:a}}),$=`pointerPosition`,Le=[`title`,`aria-label`],Re={key:1},ze=ie(ae({__name:`PointerPosition.ce`,setup(e){let{formattedPointerPosition:t,availableProjections:n,selectedProjection:r}=ce(Q());return(e,i)=>(v(),_(`div`,{class:`polar-plugin-pointer-position`,title:e.$t(e=>e.label,{ns:p($)}),"aria-label":e.$t(e=>e.label,{ns:p($)})},[i[1]||=h(`span`,{class:`kern-icon kern-icon--point-scan`,"aria-hidden":`true`},null,-1),p(n).length>1?(v(),oe(te,{key:0,value:String(p(r)),options:p(n).map(e=>({value:e.code,label:e.code,ariaLabel:e.code})),"aria-label":e.$t(e=>e.projectionSelect.label,{ns:p($)}),small:``,"onUpdate:value":i[0]||=e=>r.value=Array.isArray(e)?e[0]:e},null,8,[`value`,`options`,`aria-label`])):(v(),_(`small`,Re,m(p(r)),1)),h(`span`,null,m(p(t)),1)],8,Le))}}),[[`styles`,[`.polar-plugin-pointer-position[data-v-af8311c8]{align-items:center;gap:var(--kern-metric-space-small);margin:var(--kern-metric-space-2x-small);padding:var(--kern-metric-space-2x-small) var(--kern-metric-space-small);border-radius:var(--kern-metric-border-radius-large);color:var(--kern-color-layout-text-default);background-color:var(--kern-color-form-input-background-inverted);box-shadow:var(--polar-shadow);flex-flow:wrap;display:flex}`]],[`__scopeId`,`data-v-af8311c8`]]),Be=[{type:`de`,resources:{label:`Zeigerposition`,projectionSelect:{label:`Koordinatenreferenzsystem`}}},{type:`en`,resources:{label:`Pointer position`,projectionSelect:{label:`Coordinate reference system`}}}];function Ve(e){return{id:$,component:ze,locales:Be,options:e,storeModule:Q}}var He=(e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n};export{we as a,Oe as c,Pe as i,Ve as n,me as o,Z as r,Ae as s,He as t};