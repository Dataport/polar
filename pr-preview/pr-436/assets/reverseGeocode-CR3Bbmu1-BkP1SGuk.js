...
</wps:Execute>`,l=new a.Parser({tagNameProcessors:[a.processors.stripPrefix]});async function m(s,p){const r=await fetch(s,{method:"POST",body:w(p)}),n=await l.parseStringPromise(await r.text()),e=Object.fromEntries(Object.entries(n.ExecuteResponse.ProcessOutputs[0].Output[0].Data[0].ComplexData[0].ReverseGeocoder[0].Ergebnis[0].Adresse[0]).map(([o,i])=>[o,i[0]])),t={Distanz:parseFloat(e.Distanz),Hausnr:parseInt(e.Hausnr,10),Plz:parseInt(e.Plz,10),Strasse:e.Strasse,XKoordinate:parseFloat(e.XKoordinate),YKoordinate:parseFloat(e.YKoordinate),Zusatz:e.Zusatz};return{type:"reverse_geocoded",title:`${t.Strasse} ${t.Hausnr}${t.Zusatz}`,properties:t,geometry:{coordinates:p,type:"Point"},addressGeometry:{coordinates:[t.XKoordinate,t.YKoordinate],type:"Point"}}}if(import.meta.vitest){const{expect:s,test:p,vi:r}=import.meta.vitest,n="https://wps.example",e=[565192.2974622496,5933428820743558e-9],t=`<?xml version='1.0' encoding='UTF-8'?>
