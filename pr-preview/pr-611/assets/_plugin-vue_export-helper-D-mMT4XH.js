import{B as e,G as t,H as n,J as r,K as i,L as a,R as o,U as s,V as c,W as l,X as u,Y as ee,c as te,n as d,q as f,z as p}from"./runtime-core.esm-bundler-DzWZoNXU.js";var m=void 0,h=typeof window<`u`&&window.trustedTypes;if(h)try{m=h.createPolicy(`vue`,{createHTML:e=>e})}catch{}var g=m?e=>m.createHTML(e):e=>e,_=`http://www.w3.org/2000/svg`,v=`http://www.w3.org/1998/Math/MathML`,y=typeof document<`u`?document:null,b=y&&y.createElement(`template`),x={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{let t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,r)=>{let i=t===`svg`?y.createElementNS(_,e):t===`mathml`?y.createElementNS(v,e):n?y.createElement(e,{is:n}):y.createElement(e);return e===`select`&&r&&r.multiple!=null&&i.setAttribute(`multiple`,r.multiple),i},createText:e=>y.createTextNode(e),createComment:e=>y.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>y.querySelector(e),setScopeId(e,t){e.setAttribute(t,``)},insertStaticContent(e,t,n,r,i,a){let o=n?n.previousSibling:t.lastChild;if(i&&(i===a||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),n),!(i===a||!(i=i.nextSibling)););else{b.innerHTML=g(r===`svg`?`<svg>${e}</svg>`:r===`mathml`?`<math>${e}</math>`:e);let i=b.content;if(r===`svg`||r===`mathml`){let e=i.firstChild;for(;e.firstChild;)i.appendChild(e.firstChild);i.removeChild(e)}t.insertBefore(i,n)}return[o?o.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},S=Symbol(`_vtc`);function C(e,t,n){let r=e[S];r&&(t=(t?[t,...r]:[...r]).join(` `)),t==null?e.removeAttribute(`class`):n?e.setAttribute(`class`,t):e.className=t}var w=Symbol(`_vod`),T=Symbol(`_vsh`),E=Symbol(``),D=/(?:^|;)\s*display\s*:/;function O(e,t,n){let i=e.style,a=r(n),o=!1;if(n&&!a){if(t)if(r(t))for(let e of t.split(`;`)){let t=e.slice(0,e.indexOf(`:`)).trim();n[t]??A(i,t,``)}else for(let e in t)n[e]??A(i,e,``);for(let e in n)e===`display`&&(o=!0),A(i,e,n[e])}else if(a){if(t!==n){let e=i[E];e&&(n+=`;`+e),i.cssText=n,o=D.test(n)}}else t&&e.removeAttribute(`style`);w in e&&(e[w]=o?i.display:``,e[T]&&(i.display=`none`))}var k=/\s*!important$/;function A(t,n,r){if(s(r))r.forEach(e=>A(t,n,e));else if(r??=``,n.startsWith(`--`))t.setProperty(n,r);else{let i=N(t,n);k.test(r)?t.setProperty(e(i),r.replace(k,``),`important`):t[i]=r}}var j=[`Webkit`,`Moz`,`ms`],M={};function N(e,t){let n=M[t];if(n)return n;let r=a(t);if(r!==`filter`&&r in e)return M[t]=r;r=o(r);for(let n=0;n<j.length;n++){let i=j[n]+r;if(i in e)return M[t]=i}return t}var P=`http://www.w3.org/1999/xlink`;function F(e,t,n,r,i,a=f(t)){r&&t.startsWith(`xlink:`)?n==null?e.removeAttributeNS(P,t.slice(6,t.length)):e.setAttributeNS(P,t,n):n==null||a&&!c(n)?e.removeAttribute(t):e.setAttribute(t,a?``:ee(n)?String(n):n)}function I(e,t,n,r,i){if(t===`innerHTML`||t===`textContent`){n!=null&&(e[t]=t===`innerHTML`?g(n):n);return}let a=e.tagName;if(t===`value`&&a!==`PROGRESS`&&!a.includes(`-`)){let r=a===`OPTION`?e.getAttribute(`value`)||``:e.value,i=n==null?e.type===`checkbox`?`on`:``:String(n);(r!==i||!(`_value`in e))&&(e.value=i),n??e.removeAttribute(t),e._value=n;return}let o=!1;if(n===``||n==null){let r=typeof e[t];r===`boolean`?n=c(n):n==null&&r===`string`?(n=``,o=!0):r===`number`&&(n=0,o=!0)}try{e[t]=n}catch{}o&&e.removeAttribute(i||t)}function L(e,t,n,r){e.addEventListener(t,n,r)}function R(e,t,n,r){e.removeEventListener(t,n,r)}var z=Symbol(`_vei`);function B(e,t,n,r,i=null){let a=e[z]||(e[z]={}),o=a[t];if(r&&o)o.value=r;else{let[n,s]=H(t);r?L(e,n,a[t]=K(r,i),s):o&&(R(e,n,o,s),a[t]=void 0)}}var V=/(?:Once|Passive|Capture)$/;function H(t){let n;if(V.test(t)){n={};let e;for(;e=t.match(V);)t=t.slice(0,t.length-e[0].length),n[e[0].toLowerCase()]=!0}return[t[2]===`:`?t.slice(3):e(t.slice(2)),n]}var U=0,W=Promise.resolve(),G=()=>U||=(W.then(()=>U=0),Date.now());function K(e,t){let n=e=>{if(!e._vts)e._vts=Date.now();else if(e._vts<=n.attached)return;d(ne(e,n.value),t,5,[e])};return n.value=e,n.attached=G(),n}function ne(e,t){if(s(t)){let n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},t.map(e=>t=>!t._stopped&&e&&e(t))}else return t}var q=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,J=(e,n,o,s,c,l)=>{let u=c===`svg`;n===`class`?C(e,s,u):n===`style`?O(e,o,s):i(n)?t(n)||B(e,n,o,s,l):(n[0]===`.`?(n=n.slice(1),!0):n[0]===`^`?(n=n.slice(1),!1):Y(e,n,s,u))?(I(e,n,s),!e.tagName.includes(`-`)&&(n===`value`||n===`checked`||n===`selected`)&&F(e,n,s,u,l,n!==`value`)):e._isVueCE&&(X(e,n)||e._def.__asyncLoader&&(/[A-Z]/.test(n)||!r(s)))?I(e,a(n),s,l,n):(n===`true-value`?e._trueValue=s:n===`false-value`&&(e._falseValue=s),F(e,n,s,u))};function Y(e,t,n,i){if(i)return!!(t===`innerHTML`||t===`textContent`||t in e&&q(t)&&l(n));if(t===`spellcheck`||t===`draggable`||t===`translate`||t===`autocorrect`||t===`sandbox`&&e.tagName===`IFRAME`||t===`form`||t===`list`&&e.tagName===`INPUT`||t===`type`&&e.tagName===`TEXTAREA`)return!1;if(t===`width`||t===`height`){let t=e.tagName;if(t===`IMG`||t===`VIDEO`||t===`CANVAS`||t===`SOURCE`)return!1}return q(t)&&r(n)?!1:t in e}function X(e,t){let n=e._def.props;if(!n)return!1;let r=a(t);return Array.isArray(n)?n.some(e=>a(e)===r):Object.keys(n).some(e=>a(e)===r)}var Z=e=>{let t=e.props[`onUpdate:modelValue`]||!1;return s(t)?e=>n(t,e):t},Q=Symbol(`_assign`),re={created(e,{value:t},n){e.checked=u(t,n.props.value),e[Q]=Z(n),L(e,`change`,()=>{e[Q](ie(e))})},beforeUpdate(e,{value:t,oldValue:n},r){e[Q]=Z(r),t!==n&&(e.checked=u(t,r.props.value))}};function ie(e){return`_value`in e?e._value:e.value}var ae=[`ctrl`,`shift`,`alt`,`meta`],oe={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>`button`in e&&e.button!==0,middle:e=>`button`in e&&e.button!==1,right:e=>`button`in e&&e.button!==2,exact:(e,t)=>ae.some(n=>e[`${n}Key`]&&!t.includes(n))},se=(e,t)=>{if(!e)return e;let n=e._withMods||={},r=t.join(`.`);return n[r]||(n[r]=((n,...r)=>{for(let e=0;e<t.length;e++){let r=oe[t[e]];if(r&&r(n,t))return}return e(n,...r)}))},ce=p({patchProp:J},x),le;function ue(){return le||=te(ce)}var de=((...e)=>{let t=ue().createApp(...e),{mount:n}=t;return t.mount=e=>{let r=pe(e);if(!r)return;let i=t._component;!l(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.nodeType===1&&(r.textContent=``);let a=n(r,!1,fe(r));return r instanceof Element&&(r.removeAttribute(`v-cloak`),r.setAttribute(`data-v-app`,``)),a},t});function fe(e){if(e instanceof SVGElement)return`svg`;if(typeof MathMLElement==`function`&&e instanceof MathMLElement)return`mathml`}function pe(e){return r(e)?document.querySelector(e):e}var $=new CSSStyleSheet;$.replaceSync(`@layer kern-ux-icons {
...
}`);var me=(e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n};export{se as a,re as i,$ as n,de as r,me as t};