import{t as e}from"./chunk-BPfpcrXh-D_AdIBxW.js";import{t}from"./xml2js-3iL_Ugdq-eT5JAqMo.js";var n=e(t(),1),r=([e,t])=>`<wps:Execute
...
</wps:Execute>`,i=new n.Parser({tagNameProcessors:[n.processors.stripPrefix]});async function a(e,t,n,a){let o=await fetch(e,{method:`POST`,body:r(t),signal:a}),s=await i.parseStringPromise(await o.text()),c=Object.fromEntries(Object.entries(s.ExecuteResponse.ProcessOutputs[0].Output[0].Data[0].ComplexData[0].ReverseGeocoder[0].Ergebnis[0].Adresse[0]).map(([e,t])=>[e,t[0]])),l={Distanz:parseFloat(c.Distanz),Hausnr:parseInt(c.Hausnr,10),Plz:parseInt(c.Plz,10),Strasse:c.Strasse,XKoordinate:parseFloat(c.XKoordinate),YKoordinate:parseFloat(c.YKoordinate),Zusatz:c.Zusatz};return{type:`reverse_geocoded`,title:`${l.Strasse} ${l.Hausnr}${l.Zusatz}`,properties:l,geometry:{coordinates:t,type:`Point`},addressGeometry:{coordinates:[l.XKoordinate,l.YKoordinate],type:`Point`}}}if(import.meta.vitest){let{expect:e,test:t,vi:n}=import.meta.vitest,i=`https://wps.example`,o=[565192.2974622496,5933428.820743558],s=`<?xml version='1.0' encoding='UTF-8'?>
