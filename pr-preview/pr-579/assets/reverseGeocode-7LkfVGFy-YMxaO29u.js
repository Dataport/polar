import{U as w}from"./xml2js-BbVVFNWz-CKTwSDEB.js";const l=([s,p])=>`<wps:Execute
...
</wps:Execute>`,m=new w.Parser({tagNameProcessors:[w.processors.stripPrefix]});let n=null;async function c(s,p){n&&(n.abort(),n=null),n=new AbortController;const i=await fetch(s,{method:"POST",body:l(p),signal:n.signal}),o=await m.parseStringPromise(await i.text()),e=Object.fromEntries(Object.entries(o.ExecuteResponse.ProcessOutputs[0].Output[0].Data[0].ComplexData[0].ReverseGeocoder[0].Ergebnis[0].Adresse[0]).map(([r,a])=>[r,a[0]])),t={Distanz:parseFloat(e.Distanz),Hausnr:parseInt(e.Hausnr,10),Plz:parseInt(e.Plz,10),Strasse:e.Strasse,XKoordinate:parseFloat(e.XKoordinate),YKoordinate:parseFloat(e.YKoordinate),Zusatz:e.Zusatz};return{type:"reverse_geocoded",title:`${t.Strasse} ${t.Hausnr}${t.Zusatz}`,properties:t,geometry:{coordinates:p,type:"Point"},addressGeometry:{coordinates:[t.XKoordinate,t.YKoordinate],type:"Point"}}}if(import.meta.vitest){const{expect:s,test:p,vi:i}=import.meta.vitest,o="https://wps.example",e=[565192.2974622496,5933428820743558e-9],t=`<?xml version='1.0' encoding='UTF-8'?>
...
</wps:ExecuteResponse>`;p("reverseGeocode works with Hamburg-WPS-style",async()=>{const r=i.spyOn(global,"fetch").mockResolvedValueOnce({text:()=>Promise.resolve(t)}),a=await c(o,e);s(r).toHaveBeenCalledOnce(),s(r).toHaveBeenCalledWith(o,{method:"POST",body:l(e),signal:n?.signal}),s(a).toEqual({type:"reverse_geocoded",title:"Herrlichkeit 1",addressGeometry:{coordinates:[565200.347,5933442881e-3],type:"Point"},geometry:{coordinates:e,type:"Point"},properties:{Distanz:16.20141565450446,Hausnr:1,Plz:20459,Strasse:"Herrlichkeit",XKoordinate:565200.347,YKoordinate:5933442881e-3,Zusatz:""}})})}export{c as reverseGeocode};
