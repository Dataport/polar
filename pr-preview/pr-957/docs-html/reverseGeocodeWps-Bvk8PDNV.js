const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./crs-C14E0GlR.js","./crs-Bl2B54rk.js","./proj-CXbDQeoX.js","./defaults-DZtjWIE4.js","./defaults-DQauJHIq.js"])))=>i.map(i=>d[i]);
...
</wps:Execute>`;function r(e,t){return e.getElementsByTagNameNS(`*`,t)[0]?.textContent??``}async function i({url:e,coordinate:i,epsg:a,serviceEpsg:o,signal:s}){let c=await fetch(e,{method:`POST`,body:n(t(i,a,o)),signal:s}),l=new DOMParser().parseFromString(await c.text(),`text/xml`),u=l.querySelector(`parsererror`);if(u)throw Error(`Failed to parse XML response: ${u.textContent}.`);let d=l.getElementsByTagNameNS(`*`,`Adresse`)[0];if(!d)throw Error(`Response does not contain an "Adresse" element.`);let f={Distanz:parseFloat(r(d,`Distanz`)),Hausnr:parseInt(r(d,`Hausnr`),10),Plz:parseInt(r(d,`Plz`),10),Strasse:r(d,`Strasse`),XKoordinate:parseFloat(r(d,`XKoordinate`)),YKoordinate:parseFloat(r(d,`YKoordinate`)),Zusatz:r(d,`Zusatz`)};return{type:`reverse_geocoded`,title:`${f.Strasse} ${f.Hausnr}${f.Zusatz}`,properties:f,geometry:{coordinates:i,type:`Point`},addressGeometry:{coordinates:[f.XKoordinate,f.YKoordinate],type:`Point`}}}if(import.meta.vitest){let{beforeEach:t,expect:r,test:a,vi:o}=import.meta.vitest,{default:{registerProjections:s}}=await e(async()=>{let{default:{registerProjections:e}}=await import(`./crs-C14E0GlR.js`);return{default:{registerProjections:e}}},__vite__mapDeps([0,1,2]),import.meta.url),{default:{namedProjections:c}}=await e(async()=>{let{default:{namedProjections:e}}=await import(`./defaults-DZtjWIE4.js`);return{default:{namedProjections:e}}},__vite__mapDeps([3,4]),import.meta.url);t(()=>{o.restoreAllMocks(),s(c)});let l=`https://wps.example`,u=[565192.2974622496,5933428.820743558],d=`<?xml version='1.0' encoding='UTF-8'?>
