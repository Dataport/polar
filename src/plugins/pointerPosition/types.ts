...
export interface PointerPositionProjection {
	 ...
	 * {@link @polar/polar!MasterportalApiConfiguration.namedProjections | `mapConfiguration.namedProjections`} or its default value.
	 */
	code: `EPSG:${string}`
...
export interface PointerPositionPluginOptions extends PluginOptions {
	/**
	 * List of which projections from the {@link @polar/polar!MasterportalApiConfiguration.namedProjections | `mapConfiguration.namedProjections`} to
	 * use, i.e., only a subset can be chosen here. If not given, all EPSG
	 * systems configured in {@link @polar/polar!MasterportalApiConfiguration.namedProjections | `mapConfiguration.namedProjections`} will be chosen.
