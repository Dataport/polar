...
export interface AttributionsPluginOptions extends PluginOptions {
	 ...
	 * Only usable when {@link renderType} is set to `'independent'` and {@link @polar/polar!MapConfiguration.layout | `layout`}
	 * is set to `'nineRegions'` OR {@link @polar/polar!MapConfiguration.layout | `layout`} is set to `'standard'`.
	...
	/**
	 * If {@link renderType} is set to `'independent'` and {@link @polar/polar!MapConfiguration.layout | `layout`}
	 * is set to `'nineRegions'` OR {@link @polar/polar!MapConfiguration.layout | `layout`} is set to `'standard'`,
