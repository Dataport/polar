...
Schaltflächen wie IconMenu: Aktiv bei Klick, inaktiv bei zweitem Klick, maximal 1 aktiv

"Select-Button": Klickbar mit Ausklappmenü zur auswahl der spezifischen Funktion

* (implizit) None (Alle Schaltflächen inaktiv)
* Zeichnen
  * Optionen: Punkt, Multipunkt, Linie, Multilinie, Polygon, Multipolygon, Kreis, Text, Freihand(optional)
* Editieren:
  * Optionen: Modifizieren, Bewegen, Duplizieren, Polygon schneiden, Multipolygon schneiden, Linie schneiden, Multilinie schneiden
* Eigenschaften:
  * Optionen: Attribute, Aussehen, Länge/Fläche
* Löschen
...
ALSO MIND THAT THE STORE HAS VARIOUS DERIVED FIELDS OFFERED (should partially prolly become computeds)
