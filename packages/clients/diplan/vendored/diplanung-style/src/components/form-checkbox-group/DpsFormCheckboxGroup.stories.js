...
export default {
  title: "Vue/FormCheckboxGroup",
  component: DpsFormCheckboxGroup,
  render: (args) => ({
    components: { DpsFormCheckboxGroup },
    setup() {
      return { args };
    },
    data() {
    ...
    template: `
      <DpsFormCheckboxGroup v-model="selected" v-bind="args"></DpsFormCheckboxGroup>
      <div class="mt-4">
        Selected: {{ selected }}
      </div>
    `,
...
export const TruncatedLabels = {
  ...
  args: {
    ...
    options: [
      ...
      {
        label:
          "Enim eos, esse inventore iste minus molestias necessitatibus obcaecati " +
          "officia officiis quibusdam rerum soluta tempora voluptatem.",
        value: "opt-3",
      },
    ],
    truncate: true,
