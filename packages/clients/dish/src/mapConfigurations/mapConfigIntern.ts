...
export const mapConfigIntern = (urlParams: DishUrlParams): DishMapConfig => ({
  ...
  attributions: {
    ...
    staticAttributions: [
      `<span>Geobasisdaten: © GeoBasis-DE / <a href="https://www.bkg.bund.de/">BKG</a> <YEAR> <a href="http://sg.geodatenzentrum.de/web_public/nutzungsbedingungen.pdf">Nutzungsbedingungen</a></span>`,
  ...
  dishExportMap: {
    ...
    printImageUrlProd: `${urlParams.printHost}/Content/MapsTmp`,
    exportMapAsPdfUrl: `${urlParams.printHost}/Content/Objekt/Kartenausgabe.aspx`,
  },
})
