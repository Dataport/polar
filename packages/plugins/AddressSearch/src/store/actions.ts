...
import getSearchMethod, {
  registerSearchMethods,
} from '../utils/searchMethods/getSearchMethod'
import {
...
const actions: PolarActionTree<AddressSearchState, AddressSearchGetters> = {
  setupModule({ getters }): void {
    ...
    if (customSearchMethods) registerSearchMethods(customSearchMethods)
  },
  setSelectedGroupId(
