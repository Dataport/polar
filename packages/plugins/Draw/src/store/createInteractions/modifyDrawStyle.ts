...
import { DrawGetters, DrawState, RgbaObject } from '../../types'
...
export default function (
  ...
  let strokeColor: Color | ColorLike | RgbaObject
  if (featureStyle && 'getImage' in featureStyle && featureStyle.getImage()) {
    ...
    strokeColor = featureStyle.getStroke()?.getColor() || [0, 0, 0, 1]
  }
  if (Array.isArray(strokeColor)) strokeColor = castArrayToRgba(strokeColor)
