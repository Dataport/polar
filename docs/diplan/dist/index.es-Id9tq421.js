import { c as Ke, _ as Ga, g as Po } from "./polar-client-CjElMn42.js";
var ft = function(a) {
  return a && a.Math === Math && a;
}, V = (
  // eslint-disable-next-line es/no-global-this -- safe
  ft(typeof globalThis == "object" && globalThis) || ft(typeof window == "object" && window) || // eslint-disable-next-line no-restricted-globals -- safe
  ft(typeof self == "object" && self) || ft(typeof Ke == "object" && Ke) || ft(typeof Ke == "object" && Ke) || // eslint-disable-next-line no-new-func -- fallback
  /* @__PURE__ */ function() {
    return this;
...
}, Bl = L, br = Bl({}.isPrototypeOf), jl = V, vn = jl.navigator, cn = vn && vn.userAgent, Ct = cn ? String(cn) : "", ko = V, Jr = Ct, gn = ko.process, dn = ko.Deno, pn = gn && gn.versions || dn && dn.version, yn = pn && pn.v8, ue, vr;
yn && (ue = yn.split("."), vr = ue[0] > 0 && ue[0] < 4 ? 1 : +(ue[0] + ue[1]));
!vr && Jr && (ue = Jr.match(/Edge\/(\d+)/), (!ue || ue[1] >= 74) && (ue = Jr.match(/Chrome\/(\d+)/), ue && (vr = +ue[1])));
...
}, ea = Y, ta = B, ra = fe, rh = TypeError, ah = function(a, e) {
  var t, r;
...
var Oi = Fo.exports, On = Oi, Si = function(a, e) {
  ...
  return uh(oh(a));
}, lh = L, hh = Tr, fh = lh({}.hasOwnProperty), ve = Object.hasOwn || function(e, t) {
  return fh(hh(e), t);
}, vh = L, ch = 0, gh = Math.random(), dh = vh(1 .toString), Uo = function(a) {
  return "Symbol(" + (a === void 0 ? "" : a) + ")_" + dh(++ch + gh, 36);
}, ph = V, yh = Si, Sn = ve, mh = Uo, bh = Lo, xh = Bo, Ze = ph.Symbol, aa = yh("wks"), Th = xh ? Ze.for || Ze : Ze && Ze.withoutSetter || mh, z = function(a) {
  return Sn(aa, a) || (aa[a] = bh && Sn(Ze, a) ? Ze[a] : Th("Symbol." + a)), aa[a];
}, Oh = Y, En = fe, $n = jo, Sh = ot, Eh = ah, $h = z, wh = TypeError, Ch = $h("toPrimitive"), Ah = function(a, e) {
  ...
  var e = Ph(a, "string");
  return Rh(e) ? e : e + "";
}, Nh = V, wn = fe, Ha = Nh.document, Ih = wn(Ha) && wn(Ha.createElement), Or = function(a) {
...
}), Dh = le, kh = Y, Lh = Ro, Bh = bi, jh = wt, Fh = Go, Uh = ve, Gh = zo, Cn = Object.getOwnPropertyDescriptor;
...
}), Yh = fe, Xh = String, Wh = TypeError, J = function(a) {
  if (Yh(a)) return a;
...
var ef = le, tf = Oe, rf = bi, At = ef ? function(a, e, t) {
  return tf.f(a, e, rf(1, t));
} : function(a, e, t) {
  return a[e] = t, a;
}, Yo = { exports: {} }, Ya = le, af = ve, Xo = Function.prototype, nf = Ya && Object.getOwnPropertyDescriptor, Wo = af(Xo, "name"), sf = Wo && (function() {
}).name === "something", of = Wo && (!Ya || Ya && nf(Xo, "name").configurable), Sr = {
  PROPER: sf,
  CONFIGURABLE: of
}, uf = L, lf = B, Xa = Oi, hf = uf(Function.toString);
lf(Xa.inspectSource) || (Xa.inspectSource = function(a) {
  return hf(a);
});
var Ei = Xa.inspectSource, ff = V, vf = B, Pn = ff.WeakMap, cf = vf(Pn) && /native code/.test(String(Pn)), gf = Si, df = Uo, Rn = gf("keys"), $i = function(a) {
  return Rn[a] || (Rn[a] = df(a));
}, wi = {}, pf = cf, qo = V, yf = fe, mf = At, ua = ve, la = Oi, bf = $i, xf = wi, Nn = "Object already initialized", Wa = qo.TypeError, Tf = qo.WeakMap, cr, Ot, gr, Of = function(a) {
  return gr(a) ? Ot(a) : cr(a, {});
}, Sf = function(a) {
  return function(e) {
    var t;
    if (!yf(e) || (t = Ot(e)).type !== a)
      throw new Wa("Incompatible receiver, " + a + " required");
    return t;
  };
};
if (pf || la.state) {
  var de = la.state || (la.state = new Tf());
  ...
  var Ye = bf("state");
  xf[Ye] = !0, cr = function(a, e) {
    if (ua(a, Ye)) throw new Wa(Nn);
    return e.facade = a, mf(a, Ye, e), e;
  }, Ot = function(a) {
    return ua(a, Ye) ? a[Ye] : {};
  }, gr = function(a) {
    return ua(a, Ye);
...
var Er = {
  ...
  enforce: Of,
  getterFor: Sf
}, Ci = L, Ef = k, $f = B, zt = ve, qa = le, wf = Sr.CONFIGURABLE, Cf = Ei, Qo = Er, Af = Qo.enforce, Pf = Qo.get, In = String, sr = Object.defineProperty, Rf = Ci("".slice), Nf = Ci("".replace), If = Ci([].join), Mf = qa && !Ef(function() {
  return sr(function() {
  }, "length", { value: 8 }).length !== 8;
}), _f = String(String).split("String"), Vf = Yo.exports = function(a, e, t) {
  Rf(In(e), 0, 7) === "Symbol(" && (e = "[" + Nf(In(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), t && t.getter && (e = "get " + e), t && t.setter && (e = "set " + e), (!zt(a, "name") || wf && a.name !== e) && (qa ? sr(a, "name", { value: e, configurable: !0 }) : a.name = e), Mf && t && zt(t, "arity") && a.length !== t.arity && sr(a, "length", { value: t.arity });
  try {
    t && zt(t, "constructor") && t.constructor ? qa && sr(a, "prototype", { writable: !1 }) : a.prototype && (a.prototype = void 0);
  } catch {
  }
  var r = Af(a);
  return zt(r, "source") || (r.source = If(_f, typeof e == "string" ? e : "")), a;
};
Function.prototype.toString = Vf(function() {
  return $f(this) && Pf(this).source || Cf(this);
}, "toString");
var Ko = Yo.exports, Df = B, kf = Oe, Lf = Ko, Bf = Ti, Ue = function(a, e, t, r) {
  r || (r = {});
  var i = r.enumerable, n = r.name !== void 0 ? r.name : e;
  if (Df(t) && Lf(t, n, r), r.global)
    i ? a[e] = t : Bf(e, t);
  else {
    try {
  ...
  return a;
}, Zo = {}, jf = Math.ceil, Ff = Math.floor, Uf = Math.trunc || function(e) {
  var t = +e;
  return (t > 0 ? Ff : jf)(t);
}, Gf = Uf, $r = function(a) {
  var e = +a;
  return e !== e || e === 0 ? 0 : Gf(e);
}, zf = $r, Hf = Math.max, Yf = Math.min, Xf = function(a, e) {
  var t = zf(a);
  return t < 0 ? Hf(t + e, 0) : Yf(t, e);
}, Wf = $r, qf = Math.min, ut = function(a) {
  var e = Wf(a);
  return e > 0 ? qf(e, 9007199254740991) : 0;
}, Qf = ut, Ai = function(a) {
  return Qf(a.length);
}, Kf = wt, Zf = Xf, Jf = Ai, ev = function(a) {
  ...
  indexOf: ev(!1)
}, tv = L, ha = ve, rv = wt, av = Jo.indexOf, iv = wi, Mn = tv([].push), eu = function(a, e) {
  var t = rv(a), r = 0, i = [], n;
  for (n in t) !ha(iv, n) && ha(t, n) && Mn(i, n);
  for (; e.length > r; ) ha(t, n = e[r++]) && (~av(i, n) || Mn(i, n));
  return i;
}, Pi = [
  "constructor",
  "hasOwnProperty",
  ...
  "toString",
  "valueOf"
], nv = eu, sv = Pi, ov = sv.concat("length", "prototype");
Zo.f = Object.getOwnPropertyNames || function(e) {
  return nv(e, ov);
};
var tu = {};
tu.f = Object.getOwnPropertySymbols;
var uv = Fe, lv = L, hv = Zo, fv = tu, vv = J, cv = lv([].concat), gv = uv("Reflect", "ownKeys") || function(e) {
  var t = hv.f(vv(e)), r = fv.f;
  return r ? cv(t, r(e)) : t;
}, _n = ve, dv = gv, pv = $t, yv = Oe, mv = function(a, e, t) {
  for (var r = dv(e), i = yv.f, n = pv.f, o = 0; o < r.length; o++) {
    var s = r[o];
    !_n(a, s) && !(t && _n(t, s)) && i(a, s, n(e, s));
  }
}, bv = k, xv = B, Tv = /#|\.prototype\./, Pt = function(a, e) {
  var t = Sv[Ov(a)];
  return t === $v ? !0 : t === Ev ? !1 : xv(e) ? bv(e) : !!e;
}, Ov = Pt.normalize = function(a) {
  return String(a).replace(Tv, ".").toLowerCase();
}, Sv = Pt.data = {}, Ev = Pt.NATIVE = "N", $v = Pt.POLYFILL = "P", ru = Pt, Ht = V, wv = $t.f, Cv = At, Av = Ue, Pv = Ti, Rv = mv, Nv = ru, ee = function(a, e) {
  var t = a.target, r = a.global, i = a.stat, n, o, s, u, l, h;
  if (r ? o = Ht : i ? o = Ht[t] || Pv(t, {}) : o = Ht[t] && Ht[t].prototype, o) for (s in e) {
    if (l = e[s], a.dontCallGetSet ? (h = wv(o, s), u = h && h.value) : u = o[s], n = Nv(r ? s : t + (i ? "." : "#") + s, a.forced), !n && u !== void 0) {
      if (typeof l == typeof u) continue;
      Rv(l, u);
    }
    (a.sham || u && u.sham) && Cv(l, "sham", !0), Av(o, s, l, a);
  }
}, vt = V, Iv = Ct, Mv = Be, Yt = function(a) {
  return Iv.slice(0, a.length) === a;
}, au = function() {
  return Yt("Bun/") ? "BUN" : Yt("Cloudflare-Workers") ? "CLOUDFLARE" : Yt("Deno/") ? "DENO" : Yt("Node.js/") ? "NODE" : vt.Bun && typeof Bun.version == "string" ? "BUN" : vt.Deno && typeof Deno.version == "object" ? "DENO" : Mv(vt.process) === "process" ? "NODE" : vt.window && vt.document ? "BROWSER" : "REST";
}(), _v = au, wr = _v === "NODE", Vv = L, Dv = Te, kv = function(a, e, t) {
  try {
    return Vv(Dv(Object.getOwnPropertyDescriptor(a, e)[t]));
  } catch {
  }
}, Lv = fe, Bv = function(a) {
  return Lv(a) || a === null;
}, jv = Bv, Fv = String, Uv = TypeError, Gv = function(a) {
  if (jv(a)) return a;
  throw new Uv("Can't set " + Fv(a) + " as a prototype");
}, zv = kv, Hv = fe, Yv = he, Xv = Gv, iu = Object.setPrototypeOf || ("__proto__" in {} ? function() {
  var a = !1, e = {}, t;
  try {
    t = zv(Object.prototype, "__proto__", "set"), t(e, []), a = e instanceof Array;
  } catch {
  }
  return function(i, n) {
    return Yv(i), Xv(n), Hv(i) && (a ? t(i, n) : i.__proto__ = n), i;
  };
}() : void 0), Wv = Oe.f, qv = ve, Qv = z, Vn = Qv("toStringTag"), Cr = function(a, e, t) {
  a && !t && (a = a.prototype), a && !qv(a, Vn) && Wv(a, Vn, { configurable: !0, value: e });
}, Dn = Ko, Kv = Oe, Zv = function(a, e, t) {
  return t.get && Dn(t.get, e, { getter: !0 }), t.set && Dn(t.set, e, { setter: !0 }), Kv.f(a, e, t);
}, Jv = Fe, ec = Zv, tc = z, rc = le, kn = tc("species"), ac = function(a) {
  var e = Jv(a);
  rc && e && !e[kn] && ec(e, kn, {
    configurable: !0,
    get: function() {
...
nu[uc] = "z";
var lc = String(nu) === "[object z]", hc = lc, fc = B, or = Be, vc = z, cc = vc("toStringTag"), gc = Object, dc = or(/* @__PURE__ */ function() {
  return arguments;
  ...
  var e, t, r;
  return a === void 0 ? "Undefined" : a === null ? "Null" : typeof (t = pc(e = gc(a), cc)) == "string" ? t : dc ? or(e) : (r = or(e)) === "Object" && fc(e.callee) ? "Arguments" : r;
...
var Ec = !uu || mc(function() {
...
}, Mc = mr, fu = Function.prototype, Bn = fu.apply, jn = fu.call, vu = typeof Reflect == "object" && Reflect.apply || (Mc ? jn.bind(Bn) : function() {
  ...
  return a;
}, zc = Ct, gu = /(?:ipad|iphone|ipod).*applewebkit/i.test(zc), ae = V, Hc = vu, Yc = Ii, Un = B, Xc = ve, du = k, Gn = cu, Wc = Fc, zn = Or, qc = Gc, Qc = gu, Kc = wr, Qa = ae.setImmediate, Hn = ae.clearImmediate, Zc = ae.process, fa = ae.Dispatch, Jc = ae.Function, Yn = ae.MessageChannel, eg = ae.String, va = 0, xt = {}, Xn = "onreadystatechange", St, Ie, ca, ga;
du(function() {
  St = ae.location;
});
var Mi = function(a) {
...
var mu = yu, ig = Ct, ng = /ipad|iphone|ipod/i.test(ig) && typeof Pebble < "u", sg = Ct, og = /web0s(?!.*chrome)/i.test(sg), it = V, ug = ag, Kn = Ii, pa = pu.set, lg = mu, hg = gu, fg = ng, vg = og, ya = wr, Zn = it.MutationObserver || it.WebKitMutationObserver, Jn = it.document, es = it.process, Xt = it.Promise, Ka = ug("queueMicrotask"), Xe, ma, ba, Wt, ts;
if (!Ka) {
  ...
  !hg && !ya && !vg && Zn && Jn ? (ma = !0, ba = Jn.createTextNode(""), new Zn(Qt).observe(ba, { characterData: !0 }), Xe = function() {
    ba.data = ma = !ma;
  }) : !fg && Xt && Xt.resolve ? (Wt = Xt.resolve(void 0), Wt.constructor = Xt, ts = Kn(Wt.then, Wt), Xe = function() {
    ts(Qt);
  }) : ya ? Xe = function() {
    es.nextTick(Qt);
...
var $g = ee, dr = wr, we = V, nt = Y, is = Ue, ns = iu, wg = Cr, Cg = ac, Ag = Te, ur = B, Pg = fe, Rg = sc, Ng = hu, xu = pu.set, Vi = cg, Ig = gg, Mg = _i, _g = mu, Tu = Er, pr = Pr, Di = Rt, Ou = lt, Rr = "Promise", Su = Di.CONSTRUCTOR, Vg = Di.REJECTION_EVENT, Dg = Di.SUBCLASSING, Ta = Tu.getterFor(Rr), kg = Tu.set, Qe = pr && pr.prototype, De = pr, Kt = Qe, Eu = we.TypeError, Ja = we.document, ki = we.process, ei = Ou.f, Lg = ei, Bg = !!(Ja && Ja.createEvent && we.dispatchEvent), $u = "unhandledrejection", jg = "rejectionhandled", ss = 0, wu = 1, Fg = 2, Li = 1, Cu = 2, Zt, os, Ug, us, Au = function(a) {
  var e;
...
var Nt = {}, Hg = z, Yg = Nt, Xg = Hg("iterator"), Wg = Array.prototype, qg = function(a) {
...
}, ud = Y, fs = J, ld = ot, hd = function(a, e, t) {
  var r, i;
  fs(a);
  try {
    if (r = ld(a, "return"), !r) {
  ...
  if (i) throw r;
  return fs(r), t;
}, fd = Ii, vd = Y, cd = J, gd = xr, dd = qg, pd = Ai, vs = br, yd = od, md = Iu, cs = hd, bd = TypeError, lr = function(a, e) {
  this.stopped = a, this.result = e;
}, gs = lr.prototype, Mu = function(a, e, t) {
  var r = t && t.that, i = !!(t && t.AS_ENTRIES), n = !!(t && t.IS_RECORD), o = !!(t && t.IS_ITERATOR), s = !!(t && t.INTERRUPTED), u = fd(e, r), l, h, v, c, f, d, g, p = function(x) {
  ...
  if (n)
    ...
    if (dd(h)) {
      for (v = 0, c = pd(a); c > v; v++)
        if (f = y(a[v]), f && vs(gs, f)) return f;
      return new lr(!1);
    }
    l = yd(a, h);
  }
  for (d = n ? a.next : l.next; !(g = vd(d, l)).done; ) {
    ...
    if (typeof f == "object" && f && vs(gs, f)) return f;
  }
  return new lr(!1);
...
var Wd = J, qd = fe, Qd = lt, Kd = function(a, e) {
...
var sp = Fi || Bi(function() {
  ...
  return op(e, up);
}, hp = le, fp = Ho, vp = Oe, cp = J, gp = wt, dp = lp;
Bu.f = hp && !fp ? Object.defineProperties : function(e, t) {
  cp(e);
  for (var r = gp(t), i = dp(t), n = i.length, o = 0, s; n > o; ) vp.f(e, s = i[o++], r[s]);
  return e;
};
...
Gp && (ni = function(e) {
  var t = this, r = Dp(t), i = Np(e), n = r.raw, o, s, u, l, h, v, c;
  if (n)
    return n.lastIndex = t.lastIndex, o = et(ni, n, i), t.lastIndex = n.lastIndex, o;
  var f = r.groups, d = Uu && t.sticky, g = et(Ip, t), p = t.source, y = 0, x = i;
...
`) && (p = "(?: " + p + ")", x = " " + x, y++), s = new RegExp("^(?:" + p + ")", g)), oi && (s = new RegExp("^" + p + "$(?!\\s)", g)), si && (u = t.lastIndex), l = et(yr, d ? s : t, x), d ? l ? (l.input = Sa(l.input, y), l[0] = Sa(l[0], y), l.index = t.lastIndex, t.lastIndex += l[0].length) : t.lastIndex = 0 : si && l && (t.lastIndex = t.global ? l.index + l[0].length : u), oi && l && l.length > 1 && et(Bp, l[0], s, function() {
    ...
    for (l.groups = v = Vp(null), h = 0; h < f.length; h++)
      c = f[h], v[c[0]] = l[c[1]];
  return l;
});
...
var Es = Y, $s = Ue, Hp = Gi, ws = k, Gu = z, Yp = At, Xp = Gu("species"), Ea = RegExp.prototype, zi = function(a, e, t, r) {
  ...
  if (!n || !o || t) {
    var s = /./[i], u = e(i, ""[a], function(l, h, v, c, f) {
      var d = h.exec;
      return d === Hp || d === Ea.exec ? n && !f ? { done: !0, value: Es(s, h, v, c) } : { done: !0, value: Es(l, v, h, c) } : { done: !1 };
    });
...
}, oy = Y, uy = zi, ly = J, hy = je, fy = ut, $a = pe, vy = he, cy = ot, gy = Yi, Ps = Xi;
uy("match", function(a, e, t) {
  return [
    // `String.prototype.match` method
    // https://tc39.es/ecma262/#sec-string.prototype.match
    function(i) {
      var n = vy(this), o = hy(i) ? void 0 : cy(i, a);
    ...
    function(r) {
      ...
      for (var u = [], l = 0, h; (h = Ps(i, n)) !== null; ) {
        var v = $a(h[0]);
        u[l] = v, v === "" && (i.lastIndex = gy(n, fy(i.lastIndex), s)), l++;
      }
      return l === 0 ? null : u;
    }
  ];
  ...
  return i !== void 0 && (i = dy(i), u = my), yy(n, u, function(l, h) {
    ...
    switch (wa(h, 0)) {
      ...
      default:
        ...
        if (c > s) {
          var f = py(c / 10);
          return f === 0 ? l : f <= s ? r[f - 1] === void 0 ? wa(h, 1) : r[f - 1] + wa(h, 1) : l;
        }
        v = r[c - 1];
    }
    return v === void 0 ? "" : v;
  });
}, Ty = vu, Rs = Y, Ir = L, Oy = zi, Sy = k, Ey = J, $y = B, wy = je, Cy = $r, Ay = ut, We = pe, Py = he, Ry = Yi, Ny = ot, Iy = xy, My = Xi, _y = z, ui = _y("replace"), Vy = Math.max, Dy = Math.min, ky = Ir([].concat), Aa = Ir([].push), Ns = Ir("".indexOf), Is = Ir("".slice), Ly = function(a) {
...
Oy("replace", function(a, e, t) {
  ...
  return [
    ...
    function(i, n) {
      ...
      for (var c = [], f; f = My(o, s), !(f === null || (Aa(c, f), !h)); ) {
        var d = We(f[0]);
        d === "" && (o.lastIndex = Ry(s, Ay(o.lastIndex), v));
      }
      for (var g = "", p = 0, y = 0; y < c.length; y++) {
        f = c[y];
        for (var x = We(f[0]), b = Vy(Dy(Cy(f.index), s.length), 0), T = [], $, E = 1; E < f.length; E++) Aa(T, Ly(f[E]));
        var O = f.groups;
        if (l) {
          var C = ky([x], T, b, s);
...
var Fy = fe, Uy = Be, Gy = z, zy = Gy("match"), Hy = function(a) {
  var e;
...
}), vm = ve, cm = B, gm = Tr, dm = $i, pm = fm, Vs = dm("IE_PROTO"), fi = Object, ym = fi.prototype, Hu = pm ? fi.getPrototypeOf : function(a) {
  var e = gm(a);
  if (vm(e, Vs)) return e[Vs];
  var t = e.constructor;
  return cm(t) && e instanceof t ? t.prototype : e instanceof fi ? ym : null;
}, mm = k, bm = B, xm = fe, Ds = Hu, Tm = Ue, Om = z, vi = Om("iterator"), Yu = !1, ke, Pa, Ra;
...
var Xu = {
  ...
  }, u = e + " Iterator", l = !1, h = a.prototype, v = h[gt] || h["@@iterator"] || i && h[i], c = !er && v || s(i), f = e === "Array" && h.entries || v, d, g, p;
  if (f && (d = ks(f.call(new a())), d !== Object.prototype && d.next && (ks(d) !== Bs && (Ls ? Ls(d, Bs) : Mm(d[gt]) || Na(d, gt, Fm)), Vm(d, u, !0))), Bm && i === dt && v && v.name !== dt && (jm ? Dm(h, "name", dt) : (l = !0, c = function() {
    return Im(v, this);
  })), i)
    if (g = {
      values: s(dt),
...
var n0 = Te, s0 = Tr, o0 = Do, u0 = Ai, Xs = TypeError, Ws = "Reduce of empty array with no initial value", l0 = function(a) {
  ...
  left: l0(!1)
}, f0 = k, el = function(a, e) {
  var t = [][a];
  return !!t && f0(function() {
    t.call(null, e || function() {
      return 1;
    }, 1);
  });
}, v0 = ee, c0 = h0.left, g0 = el, qs = xi, d0 = wr, p0 = !d0 && qs > 79 && qs < 83, y0 = p0 || !g0("reduce");
v0({ target: "Array", proto: !0, forced: y0 }, {
  reduce: function(e) {
...
A0("split", function(a, e, t) {
  ...
  return [
    ...
    function(i, n) {
      ...
      var l = I0(o, RegExp), h = o.unicode, v = (o.ignoreCase ? "i" : "") + (o.multiline ? "m" : "") + (o.unicode ? "u" : "") + (qe ? "g" : "y"), c = new l(qe ? "^(?:" + o.source + ")" : o, v), f = n === void 0 ? L0 : n >>> 0;
      if (f === 0) return [];
      ...
      for (var d = 0, g = 0, p = []; g < s.length; ) {
        ...
        if (y === null || (x = B0(_0(c.lastIndex + (qe ? g : 0)), s.length)) === d)
          ...
          if (ka(p, La(s, d, g)), p.length === f) return p;
          for (var b = 1; b <= y.length - 1; b++)
            if (ka(p, y[b]), p.length === f) return p;
          g = d = x;
        }
      }
  ...
  this.r = this.r < 0 || isNaN(this.r) ? 0 : this.r > 255 ? 255 : this.r, this.g = this.g < 0 || isNaN(this.g) ? 0 : this.g > 255 ? 255 : this.g, this.b = this.b < 0 || isNaN(this.b) ? 0 : this.b > 255 ? 255 : this.b, this.alpha = this.alpha < 0 ? 0 : this.alpha > 1 || isNaN(this.alpha) ? 1 : this.alpha, this.toRGB = function() {
    ...
    for (var l = 0; l < u.length; l++)
      try {
        ...
        d.appendChild(p), d.appendChild(y), f.appendChild(d);
      } catch {
      }
    return f;
  };
...
var hb = ee, fb = L, vb = qi, cb = he, io = pe, gb = Qi, db = fb("".indexOf);
...
function Fa(a, e, t) {
  ...
  var v = Math.pow(r, 2) * Math.pow(l, 2) + Math.pow(i, 2) * Math.pow(u, 2), c = (a.lArcFlag !== a.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(r, 2) * Math.pow(i, 2) - v) / v)), f = r * l / i * c, d = -i * u / r * c, g = pi([f, d], a.xRot / 180 * Ee);
  a.cX = g[0] + (e + n) / 2, a.cY = g[1] + (t + o) / 2, a.phi1 = Math.atan2((l - d) / i, (u - f) / r), a.phi2 = Math.atan2((-l - d) / i, (-u - f) / r), a.sweepFlag === 0 && a.phi2 > a.phi1 && (a.phi2 -= 2 * Ee), a.sweepFlag === 1 && a.phi2 < a.phi1 && (a.phi2 += 2 * Ee), a.phi1 *= 180 / Ee, a.phi2 *= 180 / Ee;
}
function so(a, e, t) {
  oe(a, e, t);
  var r = a * a + e * e - t * t;
...
function lo(a, e, t, r) {
  ...
  return Math.abs(s) < i ? [-l / u] : function(h, v, c) {
    var f = h * h / 4 - v;
    if (f < -1e-6) return [];
    if (f <= c) return [-h / 2];
    var d = Math.sqrt(f);
...
(function(a) {
  ...
  function t() {
    ...
    return i(function(v, c, f) {
      return v.type & m.SMOOTH_CURVE_TO && (v.type = m.CURVE_TO, s = isNaN(s) ? c : s, u = isNaN(u) ? f : u, v.x1 = v.relative ? c - s : 2 * c - s, v.y1 = v.relative ? f - u : 2 * f - u), v.type & m.CURVE_TO ? (s = v.relative ? c + v.x2 : v.x2, u = v.relative ? f + v.y2 : v.y2) : (s = NaN, u = NaN), v.type & m.SMOOTH_QUAD_TO && (v.type = m.QUAD_TO, l = isNaN(l) ? c : l, h = isNaN(h) ? f : h, v.x1 = v.relative ? c - l : 2 * c - l, v.y1 = v.relative ? f - h : 2 * f - h), v.type & m.QUAD_TO ? (l = v.relative ? c + v.x1 : v.x1, h = v.relative ? f + v.y1 : v.y1) : (l = NaN, h = NaN), v;
    });
  }
  function r() {
    var s = NaN, u = NaN;
    return i(function(l, h, v) {
      if (l.type & m.SMOOTH_QUAD_TO && (l.type = m.QUAD_TO, s = isNaN(s) ? h : s, u = isNaN(u) ? v : u, l.x1 = l.relative ? h - s : 2 * h - s, l.y1 = l.relative ? v - u : 2 * v - u), l.type & m.QUAD_TO) {
        s = l.relative ? h + l.x1 : l.x1, u = l.relative ? v + l.y1 : l.y1;
        var c = l.x1, f = l.y1;
        l.type = m.CURVE_TO, l.x1 = ((l.relative ? 0 : h) + 2 * c) / 3, l.y1 = ((l.relative ? 0 : v) + 2 * f) / 3, l.x2 = (l.x + 2 * c) / 3, l.y2 = (l.y + 2 * f) / 3;
      } else s = NaN, u = NaN;
      return l;
    });
  }
  function i(s) {
    ...
    return function(c) {
      ...
      var f = s(c, u, l, h, v);
      return c.type & m.CLOSE_PATH && (u = h, l = v), c.x !== void 0 && (u = c.relative ? u + c.x : c.x), c.y !== void 0 && (l = c.relative ? l + c.y : c.y), c.type & m.MOVE_TO && (h = u, v = l), f;
    };
  }
  function n(s, u, l, h, v, c) {
    return oe(s, u, l, h, v, c), i(function(f, d, g, p) {
      var y = f.x1, x = f.x2, b = f.relative && !isNaN(p), T = f.x !== void 0 ? f.x : b ? 0 : d, $ = f.y !== void 0 ? f.y : b ? 0 : g;
      function E(ne) {
        return ne * ne;
      }
      f.type & m.HORIZ_LINE_TO && u !== 0 && (f.type = m.LINE_TO, f.y = f.relative ? 0 : g), f.type & m.VERT_LINE_TO && l !== 0 && (f.type = m.LINE_TO, f.x = f.relative ? 0 : d), f.x !== void 0 && (f.x = f.x * s + $ * l + (b ? 0 : v)), f.y !== void 0 && (f.y = T * u + f.y * h + (b ? 0 : c)), f.x1 !== void 0 && (f.x1 = f.x1 * s + f.y1 * l + (b ? 0 : v)), f.y1 !== void 0 && (f.y1 = y * u + f.y1 * h + (b ? 0 : c)), f.x2 !== void 0 && (f.x2 = f.x2 * s + f.y2 * l + (b ? 0 : v)), f.y2 !== void 0 && (f.y2 = x * u + f.y2 * h + (b ? 0 : c));
      var O = s * h - u * l;
      if (f.xRot !== void 0 && (s !== 1 || u !== 0 || l !== 0 || h !== 1)) if (O === 0) delete f.rX, delete f.rY, delete f.xRot, delete f.lArcFlag, delete f.sweepFlag, f.type = m.LINE_TO;
      else {
        var C = f.xRot * Math.PI / 180, I = Math.sin(C), _ = Math.cos(C), j = 1 / E(f.rX), P = 1 / E(f.rY), X = E(_) * j + E(I) * P, W = 2 * I * _ * (j - P), G = E(I) * j + E(_) * P, q = X * h * h - W * u * h + G * u * u, H = W * (s * h + u * l) - 2 * (X * l * h + G * s * u), Q = X * l * l - W * s * l + G * s * s, R = (Math.atan2(H, q - Q) + Math.PI) % Math.PI / 2, M = Math.sin(R), K = Math.cos(R);
        f.rX = Math.abs(O) / Math.sqrt(q * E(K) + H * M * K + Q * E(M)), f.rY = Math.abs(O) / Math.sqrt(q * E(M) - H * M * K + Q * E(K)), f.xRot = 180 * R / Math.PI;
      }
  ...
  a.ROUND = function(s) {
    ...
    return s === void 0 && (s = !0), u === void 0 && (u = !0), l === void 0 && (l = !0), i(function(h, v, c, f, d) {
      if (isNaN(f) && !(h.type & m.MOVE_TO)) throw new Error("path must start with moveto");
      return u && h.type & m.HORIZ_LINE_TO && (h.type = m.LINE_TO, h.y = h.relative ? 0 : c), l && h.type & m.VERT_LINE_TO && (h.type = m.LINE_TO, h.x = h.relative ? 0 : v), s && h.type & m.CLOSE_PATH && (h.type = m.LINE_TO, h.x = h.relative ? f - v : f, h.y = h.relative ? d - c : d), h.type & m.ARC && (h.rX === 0 || h.rY === 0) && (h.type = m.LINE_TO, delete h.rX, delete h.rY, delete h.xRot, delete h.lArcFlag, delete h.sweepFlag), h;
    });
  }, a.NORMALIZE_ST = t, a.QT_TO_C = r, a.INFO = i, a.SANITIZE = function(s) {
    s === void 0 && (s = 0), oe(s);
    var u = NaN, l = NaN, h = NaN, v = NaN;
    return i(function(c, f, d, g, p) {
      var y = Math.abs, x = !1, b = 0, T = 0;
      if (c.type & m.SMOOTH_CURVE_TO && (b = isNaN(u) ? 0 : f - u, T = isNaN(l) ? 0 : d - l), c.type & (m.CURVE_TO | m.SMOOTH_CURVE_TO) ? (u = c.relative ? f + c.x2 : c.x2, l = c.relative ? d + c.y2 : c.y2) : (u = NaN, l = NaN), c.type & m.SMOOTH_QUAD_TO ? (h = isNaN(h) ? f : 2 * f - h, v = isNaN(v) ? d : 2 * d - v) : c.type & m.QUAD_TO ? (h = c.relative ? f + c.x1 : c.x1, v = c.relative ? d + c.y1 : c.y2) : (h = NaN, v = NaN), c.type & m.LINE_COMMANDS || c.type & m.ARC && (c.rX === 0 || c.rY === 0 || !c.lArcFlag) || c.type & m.CURVE_TO || c.type & m.SMOOTH_CURVE_TO || c.type & m.QUAD_TO || c.type & m.SMOOTH_QUAD_TO) {
        var $ = c.x === void 0 ? 0 : c.relative ? c.x : c.x - f, E = c.y === void 0 ? 0 : c.relative ? c.y : c.y - d;
        b = isNaN(h) ? c.x1 === void 0 ? b : c.relative ? c.x : c.x1 - f : h - f, T = isNaN(v) ? c.y1 === void 0 ? T : c.relative ? c.y : c.y1 - d : v - d;
        var O = c.x2 === void 0 ? 0 : c.relative ? c.x : c.x2 - f, C = c.y2 === void 0 ? 0 : c.relative ? c.y : c.y2 - d;
        y($) <= s && y(E) <= s && y(b) <= s && y(T) <= s && y(O) <= s && y(C) <= s && (x = !0);
      }
      return c.type & m.CLOSE_PATH && y(f - g) <= s && y(d - p) <= s && (x = !0), x ? [] : c;
    });
    ...
    return i(function(s, u, l) {
      return m.ARC === s.type ? function(h, v, c) {
        var f, d, g, p;
        h.cX || Fa(h, v, c);
        for (var y = Math.min(h.phi1, h.phi2), x = Math.max(h.phi1, h.phi2) - y, b = Math.ceil(x / 90), T = new Array(b), $ = v, E = c, O = 0; O < b; O++) {
          ...
          f = K(X, W), T[O].x1 = f[0], T[O].y1 = f[1], d = K(R, M), T[O].x2 = d[0], T[O].y2 = d[1], g = K(q, H), T[O].x = g[0], T[O].y = g[1], h.relative && (T[O].x1 -= $, T[O].y1 -= E, T[O].x2 -= $, T[O].y2 -= E, T[O].x -= $, T[O].y -= E), $ = (p = [T[O].x, T[O].y])[0], E = p[1];
        }
        return T;
    ...
    var s = function(c) {
      ...
      return f;
    }, u = e(), l = r(), h = t(), v = i(function(c, f, d) {
      var g = h(l(u(s(c))));
      function p(M) {
        M > v.maxX && (v.maxX = M), M < v.minX && (v.minX = M);
      }
      function y(M) {
        M > v.maxY && (v.maxY = M), M < v.minY && (v.minY = M);
      }
      if (g.type & m.DRAWING_COMMANDS && (p(f), y(d)), g.type & m.HORIZ_LINE_TO && p(g.x), g.type & m.VERT_LINE_TO && y(g.y), g.type & m.LINE_TO && (p(g.x), y(g.y)), g.type & m.CURVE_TO) {
        p(g.x), y(g.y);
        for (var x = 0, b = lo(f, g.x1, g.x2, g.x); x < b.length; x++)
          0 < (R = b[x]) && 1 > R && p(ho(f, g.x1, g.x2, g.x, R));
        for (var T = 0, $ = lo(d, g.y1, g.y2, g.y); T < $.length; T++)
          0 < (R = $[T]) && 1 > R && y(ho(d, g.y1, g.y2, g.y, R));
      }
      if (g.type & m.ARC) {
        p(g.x), y(g.y), Fa(g, f, d);
...
`;
  ...
  return sl(e, a), e.prototype.finish = function(t) {
    ...
    for (var n = function(v) {
      r.push(v), i.curArgs.length = 0, i.canParseCommandOrComma = !0;
    }, o = 0; o < t.length; o++) {
      var s = t[o], u = !(this.curCommandType !== m.ARC || this.curArgs.length !== 3 && this.curArgs.length !== 4 || this.curNumber.length !== 1 || this.curNumber !== "0" && this.curNumber !== "1"), l = fo(s) && (this.curNumber === "0" && s === "0" || u);
      if (!fo(s) || l) if (s !== "e" && s !== "E") if (s !== "-" && s !== "+" || !this.curNumberHasExp || this.curNumberHasExpDigits) if (s !== "." || this.curNumberHasExp || this.curNumberHasDecimal || u) {
...
}(ol), $b = ((se = {})[m.MOVE_TO] = 2, se[m.LINE_TO] = 2, se[m.HORIZ_LINE_TO] = 1, se[m.VERT_LINE_TO] = 1, se[m.CLOSE_PATH] = 0, se[m.QUAD_TO] = 4, se[m.SMOOTH_QUAD_TO] = 2, se[m.CURVE_TO] = 6, se[m.SMOOTH_CURVE_TO] = 4, se[m.ARC] = 7, se), wb = Y, Cb = ve, Ab = br, Pb = ku, vo = RegExp.prototype, Rb = function(a) {
  var e = a.flags;
  return e === void 0 && !("flags" in vo) && !Cb(a, "flags") && Ab(vo, a) ? wb(Pb, a) : e;
...
function Gb(a, e, t, r, i, n) {
  for (var o = a.data, s = 2 * n + 1, u = r - 1, l = i - 1, h = n + 1, v = h * (h + 1) / 2, c = new go(), f = c, d, g = 1; g < s; g++)
    f = f.next = new go(), g === h && (d = f);
  f.next = c;
  for (var p = null, y = null, x = 0, b = 0, T = Bb[n], $ = jb[n], E = 0; E < i; E++) {
    f = c;
    for (var O = o[b], C = o[b + 1], I = o[b + 2], _ = o[b + 3], j = 0; j < h; j++)
      f.r = O, f.g = C, f.b = I, f.a = _, f = f.next;
    for (var P = 0, X = 0, W = 0, G = 0, q = h * O, H = h * C, Q = h * I, R = h * _, M = v * O, K = v * C, ne = v * I, ge = v * _, Se = 1; Se < h; Se++) {
      var ze = b + ((u < Se ? u : Se) << 2), Mt = o[ze], rn = o[ze + 1], an = o[ze + 2], nn = o[ze + 3], _t = h - Se;
      M += (f.r = Mt) * _t, K += (f.g = rn) * _t, ne += (f.b = an) * _t, ge += (f.a = nn) * _t, P += Mt, X += rn, W += an, G += nn, f = f.next;
    }
    p = c, y = d;
  ...
  for (var He = 0; He < r; He++) {
    b = He << 2;
    var Pe = o[b], Re = o[b + 1], Ne = o[b + 2], te = o[b + 3], Fr = h * Pe, Ur = h * Re, Gr = h * Ne, zr = h * te, Dt = v * Pe, kt = v * Re, Lt = v * Ne, Bt = v * te;
    f = c;
    for (var hn = 0; hn < h; hn++)
      f.r = Pe, f.g = Re, f.b = Ne, f.a = te, f = f.next;
    for (var fn = r, Hr = 0, Yr = 0, Xr = 0, Wr = 0, jt = 1; jt <= n; jt++) {
      b = fn + He << 2;
      var Ft = h - jt;
      Dt += (f.r = Pe = o[b]) * Ft, kt += (f.g = Re = o[b + 1]) * Ft, Lt += (f.b = Ne = o[b + 2]) * Ft, Bt += (f.a = te = o[b + 3]) * Ft, Wr += Pe, Hr += Re, Yr += Ne, Xr += te, f = f.next, jt < l && (fn += r);
    }
    b = He, p = c, y = d;
...
var fl = typeof window < "u" ? window : null, vl = typeof fetch < "u" ? fetch.bind(void 0) : null;
class _r {
  constructor(e) {
    var {
      fetch: t = vl,
  ...
  setViewBox(e) {
    ...
    var j = new S(t, "refX", v), P = new S(t, "refY", c), X = j.hasValue() && P.hasValue();
    if (X && r.translate(-O * j.getPixels("x"), -O * P.getPixels("y")), f) {
      var W = O * d, G = O * g;
  ...
  start(e) {
    ...
    if (this.frameDuration = d, this.readyPromise = new Promise((b) => {
      ...
      var g = Date.now(), p = g, y = 0, x = () => {
        g = Date.now(), y = g - p, y >= d && (p = g - y % d, this.shouldUpdate(i, s) && (this.render(e, n, o, u, l, h, v), f.runEvents())), this.intervalId = ja(x);
      };
      r || f.start(), this.intervalId = ja(x);
    }
  }
  stop() {
  ...
  render(e, t, r, i, n, o, s) {
    ...
    !t && (c || typeof i != "number" && typeof n != "number") && (d.hasValue() && (f.width = d.getPixels("x"), f.style && (f.style.width = "".concat(f.width, "px"))), g.hasValue() && (f.height = g.getPixels("y"), f.style && (f.style.height = "".concat(f.height, "px"))));
    ...
    r || v.clearRect(0, 0, p, y), e.render(v), c && (this.isFirstRender = !1);
  }
}
_r.defaultWindow = fl;
_r.defaultFetch = vl;
...
class cl {
  ...
  unapply(e) {
    var {
      ...
      originY: r,
      matrix: i
    } = this, n = i[0], o = i[2], s = i[4], u = i[1], l = i[3], h = i[5], v = 0, c = 0, f = 1, d = 1 / (n * (l * f - h * c) - o * (u * f - h * v) + s * (u * c - l * v)), g = t.getPixels("x"), p = r.getPixels("y");
    e.translate(g, p), e.transform(d * (l * f - h * c), d * (h * v - u * f), d * (s * c - o * f), d * (n * f - s * v), d * (o * h - s * l), d * (s * u - n * h)), e.translate(-g, -p);
  }
  applyToPoint(e) {
...
class A extends Ge {
  ...
  renderChildren(e) {
    ...
    if (r) {
      ...
      if (o.isUrlDefinition())
        for (var v = o.getDefinition(), c = 1; c < i; c++) {
          var [f, d] = r[c];
          v.render(e, f, d);
        }
  ...
  static pathA(e) {
    var {
      ...
      lArcFlag: s,
      sweepFlag: u
    } = r, l = o * (Math.PI / 180), h = e.getAsCurrentPoint(), v = new D(Math.cos(l) * (t.x - h.x) / 2 + Math.sin(l) * (t.y - h.y) / 2, -Math.sin(l) * (t.x - h.x) / 2 + Math.cos(l) * (t.y - h.y) / 2), c = Math.pow(v.x, 2) / Math.pow(i, 2) + Math.pow(v.y, 2) / Math.pow(n, 2);
    c > 1 && (i *= Math.sqrt(c), n *= Math.sqrt(c));
    var f = (s === u ? -1 : 1) * Math.sqrt((Math.pow(i, 2) * Math.pow(n, 2) - Math.pow(i, 2) * Math.pow(v.y, 2) - Math.pow(n, 2) * Math.pow(v.x, 2)) / (Math.pow(i, 2) * Math.pow(v.y, 2) + Math.pow(n, 2) * Math.pow(v.x, 2)));
    isNaN(f) && (f = 0);
    var d = new D(f * i * v.y / n, f * -n * v.x / i), g = new D((t.x + h.x) / 2 + Math.cos(l) * d.x - Math.sin(l) * d.y, (t.y + h.y) / 2 + Math.sin(l) * d.x + Math.cos(l) * d.y), p = yo([1, 0], [(v.x - d.x) / i, (v.y - d.y) / n]), y = [(v.x - d.x) / i, (v.y - d.y) / n], x = [(-v.x - d.x) / i, (-v.y - d.y) / n], b = yo(y, x);
  ...
  pathA(e, t) {
    var {
      ...
      a1: h,
      ad: v
    } = A.pathA(r), c = 1 - s ? 1 : -1, f = h + c * (v / 2), d = new D(l.x + n * Math.cos(f), l.y + o * Math.sin(f));
    if (r.addMarkerAngle(d, f - c * Math.PI / 2), r.addMarkerAngle(i, f - c * Math.PI), t.addPoint(i.x, i.y), e && !isNaN(h) && !isNaN(v)) {
      var g = n > o ? n : o, p = n > o ? 1 : n / o, y = n > o ? o / n : 1;
      e.translate(l.x, l.y), e.rotate(u), e.scale(p, y), e.arc(0, 0, g, h, h + v, !!(1 - s)), e.scale(1 / p, 1 / y), e.rotate(-u), e.translate(-l.x, -l.y);
    }
  }
  static pathZ(e) {
    e.current = e.start;
...
class Ce extends Ge {
  ...
  renderTElementChildren(e) {
    ...
    if (n) {
      for (var {
        unitsPerEm: o
      } = n.fontFace, s = Z.parse(t.ctx.font), u = r.getStyle("font-size").getNumber(s.fontSize), l = r.getStyle("font-style").getString(s.fontStyle), h = u / o, v = n.isRTL ? i.split("").reverse().join("") : i, c = ie(r.getAttribute("dx").getString()), f = v.length, d = 0; d < f; d++) {
        var g = this.getGlyph(n, v, d);
...
class It extends Ge {
  ...
  setContext(e) {
    ...
    var h = this.getAttribute("refX"), v = this.getAttribute("refY"), c = this.getAttribute("viewBox"), f = c.hasValue() ? ie(c.getString()) : null, d = !this.root && this.getStyle("overflow").getValue("hidden") !== "visible", g = 0, p = 0, y = 0, x = 0;
    f && (g = f[0], p = f[1]), this.root || (u = this.getStyle("width").getPixels("x"), l = this.getStyle("height").getPixels("y"), this.type === "marker" && (y = g, x = p, g = 0, p = 0)), i.viewPort.setCurrent(u, l), this.node && (!this.parent || ((t = this.node.parentNode) === null || t === void 0 ? void 0 : t.nodeName) === "foreignObject") && this.getStyle("transform", !1, !0).hasValue() && !this.getStyle("transform-origin", !1, !0).hasValue() && this.getStyle("transform-origin", !0, !0).setValue("50% 50%"), super.setContext(e), e.translate(this.getAttribute("x").getPixels("x"), this.getAttribute("y").getPixels("y")), f && (u = f[2], l = f[3]), r.setViewBox({
      ctx: e,
  ...
  resize(e) {
    ...
    if (i.setValue(e), n.setValue(t), o.hasValue() || o.setValue("0 0 ".concat(u || e, " ").concat(l || t)), s.hasValue()) {
      var v = this.getStyle("width"), c = this.getStyle("height");
      v.hasValue() && v.setValue("".concat(e, "px")), c.hasValue() && c.setValue("".concat(t, "px"));
    }
  }
}
class pl extends A {
...
class w1 extends N {
  ...
  createPattern(e, t, r) {
    ...
    for (var v = -1; v <= 1; v++)
      for (var c = -1; c <= 1; c++)
        u.save(), o.attributes.x = new S(this.document, "x", v * s.width), o.attributes.y = new S(this.document, "y", c * s.height), o.render(u), u.restore();
    var f = e.createPattern(s, "repeat");
    return f;
  }
}
class C1 extends N {
  ...
  createGradient(e, t, r) {
    ...
    if (n.forEach((p) => {
      ...
      var {
        ...
        viewPort: l
      } = s.screen, [h] = l.viewPorts, v = new pl(s, null);
      v.attributes.x = new S(s, "x", -u / 3), v.attributes.y = new S(s, "y", -u / 3), v.attributes.width = new S(s, "width", u), v.attributes.height = new S(s, "height", u);
      var c = new en(s, null);
      c.attributes.transform = new S(s, "transform", this.getAttribute("gradientTransform").getValue()), c.children = [v];
      var f = new It(s, null);
      f.attributes.x = new S(s, "x", 0), f.attributes.y = new S(s, "y", 0), f.attributes.width = new S(s, "width", h.width), f.attributes.height = new S(s, "height", h.height), f.children = [c];
      var d = s.createCanvas(h.width, h.height), g = d.getContext("2d");
      return g.fillStyle = o, f.render(g), g.createPattern(d, "no-repeat");
    }
    return o;
  }
...
class B1 extends Ce {
    ...
    e && e.beginPath(), t.forEach((r) => {
      ...
      switch (i) {
        ...
        case w.QUAD_TO:
          ...
          break;
        case w.ARC: {
          var [o, s, u, l, h, v, c, f] = n, d = u > l ? u : l, g = u > l ? 1 : u / l, p = u > l ? l / u : 1;
          e && (e.translate(o, s), e.rotate(c), e.scale(g, p), e.arc(0, 0, d, h, h + v, !!(1 - f)), e.scale(1 / g, 1 / p), e.rotate(-c), e.translate(-o, -s));
          break;
        }
        case w.CLOSE_PATH:
          e && e.closePath();
  ...
  findSegmentToFitChar(e, t, r, i, n, o, s, u, l) {
    ...
    var c = this.textHeight / 20, f = this.getEquidistantPointOnPath(h, c, 0), d = this.getEquidistantPointOnPath(h + v, c, 0), g = {
      p0: f,
      p1: d
    }, p = f && d ? Math.atan2(d.y - f.y, d.x - f.x) : 0;
    if (s) {
  ...
  setTextData(e) {
    if (!this.glyphInfo) {
      ...
      for (var f = 0; f < c; f++)
        v.push(typeof n[f] < "u" ? n[f] : h);
      var d = v.reduce((T, $, E) => E === 0 ? 0 : T + $ || 0, 0), g = this.measureText(e), p = Math.max(g + d, 0);
  ...
  calcLength(e, t, r, i) {
    ...
    switch (r) {
      ...
      case w.ARC: {
        n = 0;
        var l = i[4], h = i[5], v = i[4] + h, c = Math.PI / 180;
        if (Math.abs(l - v) < c && (c = Math.abs(l - v)), o = this.getPointOnEllipticalArc(i[0], i[1], i[2], i[3], l, 0), h < 0)
          for (u = l - c; u > v; u -= c)
            s = this.getPointOnEllipticalArc(i[0], i[1], i[2], i[3], u, 0), n += this.getLineLength(o.x, o.y, s.x, s.y), o = s;
        else
          for (u = l + c; u < v; u += c)
            s = this.getPointOnEllipticalArc(i[0], i[1], i[2], i[3], u, 0), n += this.getLineLength(o.x, o.y, s.x, s.y), o = s;
        return s = this.getPointOnEllipticalArc(i[0], i[1], i[2], i[3], v, 0), n += this.getLineLength(o.x, o.y, s.x, s.y), n;
      }
    }
    return 0;
  }
  getPointOnLine(e, t, r, i, n) {
    ...
    if (i === t)
      ...
      var c = 0, f = 0, d = this.getLineLength(t, r, i, n);
      if (d < at)
        return null;
      var g = (o - t) * (i - t) + (s - r) * (n - r);
      g /= d * d, c = t + g * (i - t), f = r + g * (n - r);
      var p = this.getLineLength(o, s, c, f), y = Math.sqrt(e * e - p * p);
      l = Math.sqrt(y * y / (1 + u * u)), i < t && (l *= -1), h = u * l, v = {
        x: c + l,
        y: f + h
      };
    }
  ...
  getPointOnCubicBezier(e, t, r, i, n, o, s, u, l) {
    var h = u * mo(e) + o * bo(e) + i * xo(e) + t * To(e), v = l * mo(e) + s * bo(e) + n * xo(e) + r * To(e);
    return {
      x: h,
      y: v
    };
        ...
        l.forEach((v) => {
          ...
          if (c) {
            ...
            if (h.forEach((p) => {
              ...
              x && b && (f[x] = new S(e, x, b));
            }), e.styles[c] = f, e.stylesSpecificity[c] = i1(c), c === "@font-face") {
              var d = f["font-family"].getString().replace(/"|'/g, ""), g = f.src.getString().split(",");
              g.forEach((p) => {
...
class xl extends N {
  ...
  apply(e, t, r, i, n) {
    for (var {
      ...
      for (var h = 0; h < i; h++) {
        var v = ir(u.data, h, l, i, n, 0), c = ir(u.data, h, l, i, n, 1), f = ir(u.data, h, l, i, n, 2), d = ir(u.data, h, l, i, n, 3), g = F(s, 0, v) + F(s, 1, c) + F(s, 2, f) + F(s, 3, d) + F(s, 4, 1), p = F(s, 5, v) + F(s, 6, c) + F(s, 7, f) + F(s, 8, d) + F(s, 9, 1), y = F(s, 10, v) + F(s, 11, c) + F(s, 12, f) + F(s, 13, d) + F(s, 14, 1), x = F(s, 15, v) + F(s, 16, c) + F(s, 17, f) + F(s, 18, d) + F(s, 19, 1);
...
class Dr extends N {
  ...
  apply(e, t) {
    ...
    var l = this.removeStyles(t, Dr.ignoreStyles), h = r.createCanvas(i + o, n + s), v = h.getContext("2d");
    r.screen.setDefaults(v), this.renderChildren(v), new xl(r, {
      nodeType: 1,
      childNodes: [],
      attributes: [{
        nodeName: "type",
    ...
    var c = r.createCanvas(i + o, n + s), f = c.getContext("2d");
    r.screen.setDefaults(f), t.render(f), f.globalCompositeOperation = "destination-in", f.fillStyle = v.createPattern(h, "no-repeat"), f.fillRect(0, 0, i + o, n + s), e.fillStyle = f.createPattern(c, "no-repeat"), e.fillRect(0, 0, i + o, n + s), this.restoreStyles(t, l);
  }
  render(e) {
  }
}
...
class kr extends N {
  ...
  apply(e, t) {
    ...
    if (n) {
      ...
      if (!(h < 1 || v < 1)) {
        var c = Math.floor(n.x), f = Math.floor(n.y), d = this.removeStyles(t, kr.ignoreStyles), g = r.createCanvas(h, v), p = g.getContext("2d");
        r.screen.setDefaults(p), p.translate(-c + o, -f + s), t.render(p), i.forEach((y) => {
          typeof y.apply == "function" && y.apply(p, 0, 0, h, v);
        }), e.drawImage(g, 0, 0, h, v, c - o, f - s, h, v), this.restoreStyles(t, d);
      }
    }
  }
  render(e) {
...
//# sourceMappingURL=index.es-Id9tq421.js.map
