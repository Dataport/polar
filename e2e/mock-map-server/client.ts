	...
	return JSON.parse(
		JSON.stringify(matcher, (_key, value) => {
			if (value instanceof RegExp) {
				// eslint-disable-next-line @typescript-eslint/naming-convention -- Server protocol marker keys.
...
export class MockMapClient {
	 ...
	 * @param matcher - The request matcher to inspect for an existing client UUID.
